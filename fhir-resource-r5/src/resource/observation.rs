...
pub struct Observation {
    ...
    #[fhir(name="instantiates", min="0", max="1", summary="true", modifier="false")]
    pub instantiates: Option<Reference>,
    /// Fulfills plan, proposal or order
    #[fhir(name="basedOn", min="0", max="*", summary="true", modifier="false")]
    pub based_on: Option<Vec<Reference>>,
    /// Triggering observation(s)
    #[fhir(name="triggeredBy", min="0", max="*", summary="false", modifier="false")]
    ...
    #[fhir(name="dataAbsentReason", min="0", max="1", summary="false", modifier="false")]
    pub data_absent_reason: Option<CodeableConcept>,
    /// High, low, normal, etc
    #[fhir(name="interpretation", min="0", max="*", summary="false", modifier="false")]
...
pub struct ObservationTriggeredByBackboneElement {
    ...
    #[fhir(name="observation", min="1", max="1", summary="true", modifier="false")]
...
pub struct ObservationReferenceRangeBackboneElement {
    ...
    #[fhir(name="low", min="0", max="1", summary="false", modifier="false")]
    pub low: Option<Quantity>,
    /// High Range, if relevant
    #[fhir(name="high", min="0", max="1", summary="false", modifier="false")]
    pub high: Option<Quantity>,
    /// Normal value, if relevant
    #[fhir(name="normalValue", min="0", max="1", summary="false", modifier="false")]
