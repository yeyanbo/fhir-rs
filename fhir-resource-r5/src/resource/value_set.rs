...
pub struct ValueSet {
    ...
    #[fhir(name="immutable", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="compose", min="0", max="1", summary=false, modifier=false)]
...
pub struct ValueSetScopeBackboneElement {
    ...
    #[fhir(name="inclusionCriteria", min="0", max="1", summary=false, modifier=false)]
    pub inclusion_criteria: Option<StringDt>,
    /// Criteria describing which concepts or codes should be excluded and why
    #[fhir(name="exclusionCriteria", min="0", max="1", summary=false, modifier=false)]
...
pub struct ValueSetExpansionBackboneElement {
    ...
    #[fhir(name="next", min="0", max="1", summary=false, modifier=false)]
    pub next: Option<UriDt>,
    /// Time ValueSet expansion happened
    #[fhir(name="timestamp", min="1", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="contains", min="0", max="*", summary=false, modifier=false)]
...
pub struct ValueSetExpansionContainsBackboneElement {
    ...
    #[fhir(name="system", min="0", max="1", summary=false, modifier=false)]
    pub system: Option<UriDt>,
    /// If user cannot select this entry
    #[fhir(name="abstract", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="designation", min="0", max="*", summary=false, modifier=false)]
...
pub struct ValueSetExpansionContainsPropertyBackboneElement {
    ...
    #[fhir(name="subProperty", min="0", max="*", summary=false, modifier=false)]
...
pub struct ValueSetComposeBackboneElement {
    ...
    #[fhir(name="inactive", min="0", max="1", summary=true, modifier=false)]
    pub inactive: Option<BooleanDt>,
    /// Include one or more codes from a code system or other value set(s)
    #[fhir(name="include", min="1", max="*", summary=true, modifier=false)]
    pub include: Option<Vec<ValueSetComposeIncludeBackboneElement>>,
    /// Explicitly exclude codes from a code system or other value sets
    #[fhir(name="exclude", min="0", max="*", summary=false, modifier=false)]
...
pub struct ValueSetComposeIncludeBackboneElement {
    ...
    #[fhir(name="concept", min="0", max="*", summary=false, modifier=false)]
    pub concept: Option<Vec<ValueSetComposeIncludeConceptBackboneElement>>,
    /// Select codes/concepts by their properties (including relationships)
    #[fhir(name="filter", min="0", max="*", summary=true, modifier=false)]
    pub filter: Option<Vec<ValueSetComposeIncludeFilterBackboneElement>>,
    /// Select the contents included in this value set
    #[fhir(name="valueSet", min="0", max="*", summary=true, modifier=false)]
...
pub struct ValueSetComposeIncludeConceptDesignationBackboneElement {
    ...
    #[fhir(name="use", min="0", max="1", summary=false, modifier=false)]
    pub use_: Option<Coding>,
    /// Additional ways how this designation would be used
    #[fhir(name="additionalUse", min="0", max="*", summary=false, modifier=false)]
