...
pub struct SubscriptionStatus {
    ...
    #[fhir(name="eventsSinceSubscriptionStart", min="0", max="1", summary="true", modifier="false")]
    pub events_since_subscription_start: Option<Integer64Dt>,
    /// Detailed information about any events relevant to this notification
    #[fhir(name="notificationEvent", min="0", max="*", summary="false", modifier="false")]
    ...
    #[fhir(name="subscription", min="1", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="error", min="0", max="*", summary="true", modifier="false")]
...
pub struct SubscriptionStatusNotificationEventBackboneElement {
    ...
    #[fhir(name="eventNumber", min="1", max="1", summary="false", modifier="false")]
    pub event_number: Option<Integer64Dt>,
    /// The instant this event occurred
    #[fhir(name="timestamp", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="additionalContext", min="0", max="*", summary="false", modifier="false")]
