...
pub struct Goal {
    ...
    #[fhir(name="achievementStatus", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="continuous", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="outcome", min="0", max="*", summary="false", modifier="false")]
...
pub struct GoalTargetBackboneElement {
    ...
    #[fhir(name="detail", min="0", max="1", summary="true", modifier="false")]
    pub detail: Option<Ratio>,
    /// Reach goal on or before
    #[fhir(name="due", min="0", max="1", summary="true", modifier="false")]
