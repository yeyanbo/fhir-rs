...
pub struct Immunization {
    ...
    #[fhir(name="vaccineCode", min="1", max="1", summary="true", modifier="false")]
    pub vaccine_code: Option<CodeableConcept>,
    /// Product that was administered
    #[fhir(name="administeredProduct", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="occurrence", min="1", max="1", summary="true", modifier="false")]
    pub occurrence: Option<StringDt>,
    /// Indicates context the data was captured in
    #[fhir(name="primarySource", min="0", max="1", summary="true", modifier="false")]
    pub primary_source: Option<BooleanDt>,
    /// Indicates the source of a  reported record
    #[fhir(name="informationSource", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="doseQuantity", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="programEligibility", min="0", max="*", summary="false", modifier="false")]
    pub program_eligibility: Option<Vec<ImmunizationProgramEligibilityBackboneElement>>,
    /// Funding source for the vaccine
    #[fhir(name="fundingSource", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="protocolApplied", min="0", max="*", summary="false", modifier="false")]
...
pub struct ImmunizationProtocolAppliedBackboneElement {
    ...
    #[fhir(name="targetDisease", min="0", max="*", summary="false", modifier="false")]
    pub target_disease: Option<Vec<CodeableConcept>>,
    /// Dose number within series
    #[fhir(name="doseNumber", min="1", max="1", summary="false", modifier="false")]
...
pub struct ImmunizationReactionBackboneElement {
    ...
    #[fhir(name="manifestation", min="0", max="1", summary="false", modifier="false")]
...
pub struct ImmunizationProgramEligibilityBackboneElement {
    ...
    #[fhir(name="program", min="1", max="1", summary="false", modifier="false")]
    pub program: Option<CodeableConcept>,
    /// The patient's eligibility status for the program
    #[fhir(name="programStatus", min="1", max="1", summary="false", modifier="false")]
