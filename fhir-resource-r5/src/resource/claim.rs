...
pub struct Claim {
    ...
    /// Total claim cost
    #[fhir(name="total", min="0", max="1", summary="false", modifier="false")]
...
pub struct ClaimAccidentBackboneElement {
    ...
    #[fhir(name="date", min="1", max="1", summary="false", modifier="false")]
...
pub struct ClaimInsuranceBackboneElement {
    ...
    #[fhir(name="sequence", min="1", max="1", summary="true", modifier="false")]
    pub sequence: Option<PositiveIntDt>,
