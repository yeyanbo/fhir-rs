...
pub struct Transport {
    ...
    #[fhir(name="completionTime", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="requestedLocation", min="1", max="1", summary="true", modifier="false")]
    pub requested_location: Option<Reference>,
    /// The entity current location
    #[fhir(name="currentLocation", min="1", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="history", min="0", max="1", summary="false", modifier="false")]
