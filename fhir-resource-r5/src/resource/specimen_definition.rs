...
pub struct SpecimenDefinition {
    ...
    #[fhir(name="derivedFromCanonical", min="0", max="*", summary="true", modifier="false")]
    ...
    #[fhir(name="typeCollected", min="0", max="1", summary="true", modifier="false")]
    pub type_collected: Option<CodeableConcept>,
    /// Patient preparation for collection
    #[fhir(name="patientPreparation", min="0", max="*", summary="true", modifier="false")]
    pub patient_preparation: Option<Vec<CodeableConcept>>,
    /// Time aspect for collection
    #[fhir(name="timeAspect", min="0", max="1", summary="true", modifier="false")]
    pub time_aspect: Option<StringDt>,
    /// Specimen collection procedure
    #[fhir(name="collection", min="0", max="*", summary="true", modifier="false")]
    pub collection: Option<Vec<CodeableConcept>>,
    /// Specimen in container intended for testing by lab
    #[fhir(name="typeTested", min="0", max="*", summary="false", modifier="false")]
...
pub struct SpecimenDefinitionTypeTestedBackboneElement {
    ...
    #[fhir(name="isDerived", min="0", max="1", summary="false", modifier="false")]
    pub is_derived: Option<BooleanDt>,
    /// Type of intended specimen
    #[fhir(name="type", min="0", max="1", summary="false", modifier="false")]
    pub type_: Option<CodeableConcept>,
    /// preferred | alternate
    #[fhir(name="preference", min="1", max="1", summary="false", modifier="false")]
    pub preference: Option<CodeDt>,
    /// The specimen's container
    #[fhir(name="container", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="retentionTime", min="0", max="1", summary="false", modifier="false")]
    pub retention_time: Option<Duration>,
    /// Specimen for single use only
    #[fhir(name="singleUse", min="0", max="1", summary="false", modifier="false")]
    pub single_use: Option<BooleanDt>,
    /// Criterion specified for specimen rejection
    #[fhir(name="rejectionCriterion", min="0", max="*", summary="false", modifier="false")]
    pub rejection_criterion: Option<Vec<CodeableConcept>>,
    /// Specimen handling before testing
    #[fhir(name="handling", min="0", max="*", summary="false", modifier="false")]
    pub handling: Option<Vec<SpecimenDefinitionTypeTestedHandlingBackboneElement>>,
    /// Where the specimen will be tested
    #[fhir(name="testingDestination", min="0", max="*", summary="false", modifier="false")]
...
pub struct SpecimenDefinitionTypeTestedContainerBackboneElement {
    ...
    #[fhir(name="material", min="0", max="1", summary="false", modifier="false")]
    pub material: Option<CodeableConcept>,
    /// Kind of container associated with the kind of specimen
    #[fhir(name="type", min="0", max="1", summary="false", modifier="false")]
    pub type_: Option<CodeableConcept>,
    /// Color of container cap
    #[fhir(name="cap", min="0", max="1", summary="false", modifier="false")]
    pub cap: Option<CodeableConcept>,
    /// The description of the kind of container
    #[fhir(name="description", min="0", max="1", summary="false", modifier="false")]
    pub description: Option<MarkdownDt>,
    /// The capacity of this kind of container
    #[fhir(name="capacity", min="0", max="1", summary="false", modifier="false")]
    pub capacity: Option<Quantity>,
    /// Minimum volume
    #[fhir(name="minimumVolume", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="preparation", min="0", max="1", summary="false", modifier="false")]
...
pub struct SpecimenDefinitionTypeTestedContainerAdditiveBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Additive associated with container
    #[fhir(name="additive", min="1", max="1", summary="false", modifier="false")]
...
pub struct SpecimenDefinitionTypeTestedHandlingBackboneElement {
    ...
    #[fhir(name="temperatureQualifier", min="0", max="1", summary="false", modifier="false")]
    pub temperature_qualifier: Option<CodeableConcept>,
    /// Temperature range for these handling instructions
    #[fhir(name="temperatureRange", min="0", max="1", summary="false", modifier="false")]
    pub temperature_range: Option<Range>,
    /// Maximum preservation time
    #[fhir(name="maxDuration", min="0", max="1", summary="false", modifier="false")]
    pub max_duration: Option<Duration>,
    /// Preservation instruction
    #[fhir(name="instruction", min="0", max="1", summary="false", modifier="false")]
