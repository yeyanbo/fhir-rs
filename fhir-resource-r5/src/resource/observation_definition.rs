...
pub struct ObservationDefinition {
    ...
    #[fhir(name="permittedDataType", min="0", max="*", summary=false, modifier=false)]
    pub permitted_data_type: Option<Vec<CodeDt>>,
    /// Multiple results allowed for conforming observations
    #[fhir(name="multipleResultsAllowed", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="preferredReportName", min="0", max="1", summary=false, modifier=false)]
    pub preferred_report_name: Option<StringDt>,
    /// Unit for quantitative results
    #[fhir(name="permittedUnit", min="0", max="*", summary=false, modifier=false)]
    pub permitted_unit: Option<Vec<Coding>>,
    /// Set of qualified values for observation results
    #[fhir(name="qualifiedValue", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="hasMember", min="0", max="*", summary=false, modifier=false)]
...
pub struct ObservationDefinitionQualifiedValueBackboneElement {
    ...
    #[fhir(name="appliesTo", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="age", min="0", max="1", summary=false, modifier=false)]
    pub age: Option<Range>,
    /// Applicable gestational age range for the set of qualified values
    #[fhir(name="gestationalAge", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="rangeCategory", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="criticalCodedValueSet", min="0", max="1", summary=false, modifier=false)]
