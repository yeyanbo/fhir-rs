...
pub struct NutritionOrder {
    ...
    #[fhir(name="instantiates", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="dateTime", min="1", max="1", summary=true, modifier=false)]
    pub date_time: Option<DateTimeDt>,
    /// Who ordered the diet, formula or nutritional supplement
    #[fhir(name="orderer", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="allergyIntolerance", min="0", max="*", summary=false, modifier=false)]
    pub allergy_intolerance: Option<Vec<Reference>>,
    /// Order-specific modifier about the type of food that should be given
    #[fhir(name="foodPreferenceModifier", min="0", max="*", summary=false, modifier=false)]
    pub food_preference_modifier: Option<Vec<CodeableConcept>>,
    /// Order-specific modifier about the type of food that should not be given
    #[fhir(name="excludeFoodModifier", min="0", max="*", summary=false, modifier=false)]
    pub exclude_food_modifier: Option<Vec<CodeableConcept>>,
    /// Capture when a food item is brought in by the patient and/or family
    #[fhir(name="outsideFoodAllowed", min="0", max="1", summary=false, modifier=false)]
    pub outside_food_allowed: Option<BooleanDt>,
    /// Oral diet components
    #[fhir(name="oralDiet", min="0", max="1", summary=false, modifier=false)]
    pub oral_diet: Option<NutritionOrderOralDietBackboneElement>,
    /// Supplement components
    #[fhir(name="supplement", min="0", max="*", summary=false, modifier=false)]
    pub supplement: Option<Vec<NutritionOrderSupplementBackboneElement>>,
    /// Enteral formula components
    #[fhir(name="enteralFormula", min="0", max="1", summary=false, modifier=false)]
...
pub struct NutritionOrderSupplementBackboneElement {
    ...
    #[fhir(name="productName", min="0", max="1", summary=false, modifier=false)]
...
pub struct NutritionOrderSupplementScheduleBackboneElement {
    ...
    #[fhir(name="timing", min="0", max="*", summary=false, modifier=false)]
    pub timing: Option<Vec<Timing>>,
    /// Take 'as needed'
    #[fhir(name="asNeeded", min="0", max="1", summary=false, modifier=false)]
    pub as_needed: Option<BooleanDt>,
    /// Take 'as needed' for x
    #[fhir(name="asNeededFor", min="0", max="1", summary=false, modifier=false)]
...
pub struct NutritionOrderEnteralFormulaBackboneElement {
    ...
    #[fhir(name="baseFormulaType", min="0", max="1", summary=true, modifier=false)]
    pub base_formula_type: Option<CodeableReference>,
    /// Product or brand name of the enteral or infant formula
    #[fhir(name="baseFormulaProductName", min="0", max="1", summary=false, modifier=false)]
    pub base_formula_product_name: Option<StringDt>,
    /// Intended type of device for the administration
    #[fhir(name="deliveryDevice", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="caloricDensity", min="0", max="1", summary=false, modifier=false)]
    pub caloric_density: Option<Quantity>,
    /// How the formula should enter the patient's gastrointestinal tract
    #[fhir(name="routeOfAdministration", min="0", max="1", summary=false, modifier=false)]
    pub route_of_administration: Option<CodeableConcept>,
    /// Formula feeding instruction as structured data
    #[fhir(name="administration", min="0", max="*", summary=false, modifier=false)]
    pub administration: Option<Vec<NutritionOrderEnteralFormulaAdministrationBackboneElement>>,
    /// Upper limit on formula volume per unit of time
    #[fhir(name="maxVolumeToDeliver", min="0", max="1", summary=false, modifier=false)]
    pub max_volume_to_deliver: Option<Quantity>,
    /// Formula feeding instructions expressed as text
    #[fhir(name="administrationInstruction", min="0", max="1", summary=true, modifier=false)]
...
pub struct NutritionOrderOralDietBackboneElement {
    ...
    #[fhir(name="nutrient", min="0", max="*", summary=false, modifier=false)]
    pub nutrient: Option<Vec<NutritionOrderOralDietNutrientBackboneElement>>,
    /// Required  texture modifications
    #[fhir(name="texture", min="0", max="*", summary=false, modifier=false)]
    pub texture: Option<Vec<NutritionOrderOralDietTextureBackboneElement>>,
    /// The required consistency of fluids and liquids provided to the patient
    #[fhir(name="fluidConsistencyType", min="0", max="*", summary=false, modifier=false)]
...
pub struct NutritionOrderOralDietNutrientBackboneElement {
    ...
    #[fhir(name="modifier", min="0", max="1", summary=false, modifier=false)]
...
pub struct NutritionOrderOralDietTextureBackboneElement {
    ...
    #[fhir(name="foodType", min="0", max="1", summary=false, modifier=false)]
