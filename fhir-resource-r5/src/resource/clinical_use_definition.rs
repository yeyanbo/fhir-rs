...
pub struct ClinicalUseDefinition {
    ...
    #[fhir(name="contraindication", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="population", min="0", max="*", summary="true", modifier="false")]
    pub population: Option<Vec<Reference>>,
    /// Logic used by the clinical use definition
    #[fhir(name="library", min="0", max="*", summary="true", modifier="false")]
    pub library: Option<Vec<CanonicalDt>>,
    /// A possible negative outcome from the use of this treatment
    #[fhir(name="undesirableEffect", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="warning", min="0", max="1", summary="true", modifier="false")]
...
pub struct ClinicalUseDefinitionInteractionBackboneElement {
    ...
    #[fhir(name="interactant", min="0", max="*", summary="true", modifier="false")]
    ...
    #[fhir(name="effect", min="0", max="1", summary="true", modifier="false")]
    pub effect: Option<CodeableReference>,
    /// The incidence of the interaction, e.g. theoretical, observed
    #[fhir(name="incidence", min="0", max="1", summary="true", modifier="false")]
    pub incidence: Option<CodeableConcept>,
    /// Actions for managing the interaction
    #[fhir(name="management", min="0", max="*", summary="true", modifier="false")]
...
pub struct ClinicalUseDefinitionContraindicationBackboneElement {
    ...
    #[fhir(name="diseaseSymptomProcedure", min="0", max="1", summary="true", modifier="false")]
    pub disease_symptom_procedure: Option<CodeableReference>,
    /// The status of the disease or symptom for the contraindication
    #[fhir(name="diseaseStatus", min="0", max="1", summary="true", modifier="false")]
    pub disease_status: Option<CodeableReference>,
    /// A comorbidity (concurrent condition) or coinfection
    #[fhir(name="comorbidity", min="0", max="*", summary="true", modifier="false")]
    ...
    #[fhir(name="otherTherapy", min="0", max="*", summary="true", modifier="false")]
...
pub struct ClinicalUseDefinitionContraindicationOtherTherapyBackboneElement {
    ...
    #[fhir(name="relationshipType", min="1", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="treatment", min="1", max="1", summary="true", modifier="false")]
...
pub struct ClinicalUseDefinitionUndesirableEffectBackboneElement {
    ...
    #[fhir(name="symptomConditionEffect", min="0", max="1", summary="true", modifier="false")]
    pub symptom_condition_effect: Option<CodeableReference>,
    /// High level classification of the effect
    #[fhir(name="classification", min="0", max="1", summary="true", modifier="false")]
    pub classification: Option<CodeableConcept>,
    /// How often the effect is seen
    #[fhir(name="frequencyOfOccurrence", min="0", max="1", summary="true", modifier="false")]
...
pub struct ClinicalUseDefinitionIndicationBackboneElement {
    ...
    #[fhir(name="intendedEffect", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="undesirableEffect", min="0", max="*", summary="true", modifier="false")]
