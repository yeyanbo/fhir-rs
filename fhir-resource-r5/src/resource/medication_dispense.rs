...
pub struct MedicationDispense {
    ...
    #[fhir(name="notPerformedReason", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="authorizingPrescription", min="0", max="*", summary="false", modifier="false")]
    ...
    #[fhir(name="daysSupply", min="0", max="1", summary="false", modifier="false")]
    pub days_supply: Option<Quantity>,
    /// When the recording of the dispense started
    #[fhir(name="recorded", min="0", max="1", summary="false", modifier="false")]
    pub recorded: Option<DateTimeDt>,
    /// When product was packaged and reviewed
    #[fhir(name="whenPrepared", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="receiver", min="0", max="*", summary="false", modifier="false")]
...
pub struct MedicationDispenseSubstitutionBackboneElement {
    ...
    #[fhir(name="wasSubstituted", min="1", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="responsibleParty", min="0", max="1", summary="false", modifier="false")]
