...
pub struct BiologicallyDerivedProduct {
    ...
    #[fhir(name="productCategory", min="0", max="1", summary=false, modifier=false)]
    pub product_category: Option<Coding>,
    /// A code that identifies the kind of this biologically derived product
    #[fhir(name="productCode", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="biologicalSourceEvent", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="processingFacility", min="0", max="*", summary=false, modifier=false)]
    pub processing_facility: Option<Vec<Reference>>,
    /// A unique identifier for an aliquot of a product
    #[fhir(name="division", min="0", max="1", summary=false, modifier=false)]
    pub division: Option<StringDt>,
    /// available | unavailable
    #[fhir(name="productStatus", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="storageTempRequirements", min="0", max="1", summary=false, modifier=false)]
...
pub struct BiologicallyDerivedProductCollectionBackboneElement {
    ...
    #[fhir(name="collector", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="collected", min="0", max="1", summary=false, modifier=false)]
