...
pub struct PaymentNotice {
    ...
    /// Payment reference
    #[fhir(name="payment", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="recipient", min="1", max="1", summary="true", modifier="false")]
    pub recipient: Option<Reference>,
    /// Monetary amount of the payment
    #[fhir(name="amount", min="1", max="1", summary="true", modifier="false")]
    pub amount: Option<Money>,
    /// Issued or cleared Status of the payment
    #[fhir(name="paymentStatus", min="0", max="1", summary="false", modifier="false")]
