...
pub struct Measure {
    ...
    #[fhir(name="disclaimer", min="0", max="1", summary="true", modifier="false")]
    pub disclaimer: Option<MarkdownDt>,
    /// proportion | ratio | continuous-variable | cohort
    #[fhir(name="scoring", min="0", max="1", summary="true", modifier="false")]
    pub scoring: Option<CodeableConcept>,
    /// What units?
    #[fhir(name="scoringUnit", min="0", max="1", summary="true", modifier="false")]
    pub scoring_unit: Option<CodeableConcept>,
    /// opportunity | all-or-nothing | linear | weighted
    #[fhir(name="compositeScoring", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="riskAdjustment", min="0", max="1", summary="true", modifier="false")]
    pub risk_adjustment: Option<MarkdownDt>,
    /// How is rate aggregation performed for this measure
    #[fhir(name="rateAggregation", min="0", max="1", summary="true", modifier="false")]
    pub rate_aggregation: Option<MarkdownDt>,
    /// Detailed description of why the measure exists
    #[fhir(name="rationale", min="0", max="1", summary="true", modifier="false")]
    pub rationale: Option<MarkdownDt>,
    /// Summary of clinical guidelines
    #[fhir(name="clinicalRecommendationStatement", min="0", max="1", summary="true", modifier="false")]
    pub clinical_recommendation_statement: Option<MarkdownDt>,
    /// increase | decrease
    #[fhir(name="improvementNotation", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="guidance", min="0", max="1", summary="true", modifier="false")]
...
pub struct MeasureGroupPopulationBackboneElement {
    ...
    #[fhir(name="criteria", min="0", max="1", summary="false", modifier="false")]
    pub criteria: Option<Expression>,
    /// A group resource that defines this population
    #[fhir(name="groupDefinition", min="0", max="1", summary="false", modifier="false")]
    pub group_definition: Option<Reference>,
    /// Which population
    #[fhir(name="inputPopulationId", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="aggregateMethod", min="0", max="1", summary="false", modifier="false")]
...
pub struct MeasureSupplementalDataBackboneElement {
    ...
    #[fhir(name="usage", min="0", max="*", summary="false", modifier="false")]
    pub usage: Option<Vec<CodeableConcept>>,
    /// The human readable description of this supplemental data
    #[fhir(name="description", min="0", max="1", summary="false", modifier="false")]
    pub description: Option<MarkdownDt>,
    /// Expression describing additional data to be reported
    #[fhir(name="criteria", min="1", max="1", summary="false", modifier="false")]
    pub criteria: Option<Expression>,
}
