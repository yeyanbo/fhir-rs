...
pub struct PlanDefinitionActorBackboneElement {
    ...
    #[fhir(name="option", min="1", max="*", summary="false", modifier="false")]
...
pub struct PlanDefinitionActionBackboneElement {
    ...
    #[fhir(name="textEquivalent", min="0", max="1", summary="false", modifier="false")]
    ...
    #[fhir(name="goalId", min="0", max="*", summary="false", modifier="false")]
    pub goal_id: Option<Vec<IdDt>>,
    /// Type of individual the action is focused on
    #[fhir(name="subject", min="0", max="1", summary="false", modifier="false")]
    pub subject: Option<CanonicalDt>,
    /// When the action should be triggered
    #[fhir(name="trigger", min="0", max="*", summary="false", modifier="false")]
...
pub struct PlanDefinitionActionParticipantBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// What actor
    #[fhir(name="actorId", min="0", max="1", summary="false", modifier="false")]
...
pub struct PlanDefinitionGoalBackboneElement {
    ...
    #[fhir(name="addresses", min="0", max="*", summary="false", modifier="false")]
