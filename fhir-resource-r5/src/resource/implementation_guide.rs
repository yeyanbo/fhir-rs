...
pub struct ImplementationGuide {
    ...
    #[fhir(name="packageId", min="1", max="1", summary=true, modifier=false)]
    pub package_id: Option<IdDt>,
    /// SPDX license code for this IG (or not-open-source)
    #[fhir(name="license", min="0", max="1", summary=true, modifier=false)]
    pub license: Option<CodeDt>,
    /// FHIR Version(s) this Implementation Guide targets
    #[fhir(name="fhirVersion", min="1", max="*", summary=true, modifier=false)]
    pub fhir_version: Option<Vec<CodeDt>>,
    /// Another Implementation guide this depends on
    #[fhir(name="dependsOn", min="0", max="*", summary=true, modifier=false)]
    pub depends_on: Option<Vec<ImplementationGuideDependsOnBackboneElement>>,
    /// Profiles that apply globally
    #[fhir(name="global", min="0", max="*", summary=true, modifier=false)]
    ...
    #[fhir(name="manifest", min="0", max="1", summary=false, modifier=false)]
...
pub struct ImplementationGuideManifestBackboneElement {
    ...
    #[fhir(name="rendering", min="0", max="1", summary=true, modifier=false)]
    pub rendering: Option<UrlDt>,
    /// Resource in the implementation guide
    #[fhir(name="resource", min="1", max="*", summary=true, modifier=false)]
    pub resource: Option<Vec<ImplementationGuideManifestResourceBackboneElement>>,
    /// HTML page within the parent IG
    #[fhir(name="page", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="other", min="0", max="*", summary=false, modifier=false)]
...
pub struct ImplementationGuideManifestResourceBackboneElement {
    ...
    /// Is this an example
    #[fhir(name="isExample", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="relativePath", min="0", max="1", summary=false, modifier=false)]
...
pub struct ImplementationGuideManifestPageBackboneElement {
    ...
    #[fhir(name="anchor", min="0", max="*", summary=false, modifier=false)]
...
pub struct ImplementationGuideDefinitionBackboneElement {
    ...
    #[fhir(name="grouping", min="0", max="*", summary=false, modifier=false)]
    pub grouping: Option<Vec<ImplementationGuideDefinitionGroupingBackboneElement>>,
    /// Resource in the implementation guide
    #[fhir(name="resource", min="0", max="*", summary=false, modifier=false)]
    pub resource: Option<Vec<ImplementationGuideDefinitionResourceBackboneElement>>,
    /// Page/Section in the Guide
    #[fhir(name="page", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="template", min="0", max="*", summary=false, modifier=false)]
...
pub struct ImplementationGuideDefinitionPageBackboneElement {
    ...
    #[fhir(name="generation", min="1", max="1", summary=false, modifier=false)]
...
pub struct ImplementationGuideDefinitionResourceBackboneElement {
    ...
    #[fhir(name="fhirVersion", min="0", max="*", summary=false, modifier=false)]
    pub fhir_version: Option<Vec<CodeDt>>,
    ...
    #[fhir(name="groupingId", min="0", max="1", summary=false, modifier=false)]
...
pub struct ImplementationGuideDependsOnBackboneElement {
    ...
    #[fhir(name="uri", min="1", max="1", summary=true, modifier=false)]
    pub uri: Option<CanonicalDt>,
    /// NPM Package name for IG this depends on
    #[fhir(name="packageId", min="0", max="1", summary=true, modifier=false)]
    pub package_id: Option<IdDt>,
    /// Version of the IG
    #[fhir(name="version", min="0", max="1", summary=true, modifier=false)]
    pub version: Option<StringDt>,
