...
pub struct CodeSystem {
    ...
    #[fhir(name="caseSensitive", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="hierarchyMeaning", min="0", max="1", summary="true", modifier="false")]
    pub hierarchy_meaning: Option<CodeDt>,
    /// If code system defines a compositional grammar
    #[fhir(name="compositional", min="0", max="1", summary="true", modifier="false")]
    pub compositional: Option<BooleanDt>,
    /// If definitions are not stable
    #[fhir(name="versionNeeded", min="0", max="1", summary="true", modifier="false")]
    ...
    #[fhir(name="supplements", min="0", max="1", summary="true", modifier="false")]
...
pub struct CodeSystemFilterBackboneElement {
    ...
    #[fhir(name="operator", min="1", max="*", summary="true", modifier="false")]
