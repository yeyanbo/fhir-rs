...
pub struct BiologicallyDerivedProductDispense {
    ...
    #[fhir(name="originRelationshipType", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="matchStatus", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="preparedDate", min="0", max="1", summary=true, modifier=false, choice="")]
    pub prepared_date: Option<DateTimeDt>,
    /// When the product was dispatched
    #[fhir(name="whenHandedOver", min="0", max="1", summary=true, modifier=false, choice="")]
    pub when_handed_over: Option<DateTimeDt>,
    /// Where the product was dispatched to
    #[fhir(name="destination", min="0", max="1", summary=true, modifier=false, choice="")]
    pub destination: Option<Reference>,
    /// Additional notes
    #[fhir(name="note", min="0", max="*", summary=true, modifier=false, choice="")]
    pub note: Option<Vec<Annotation>>,
    /// Specific instructions for use
    #[fhir(name="usageInstruction", min="0", max="1", summary=true, modifier=false, choice="")]
