...
pub struct BiologicallyDerivedProductDispense {
    ...
    #[fhir(name="originRelationshipType", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="matchStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="whenHandedOver", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub when_handed_over: Option<DateTimeDt>,
    /// Where the product was dispatched to
    #[fhir(name="destination", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub destination: Option<Reference>,
    /// Additional notes
    #[fhir(name="note", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub note: Option<Vec<Annotation>>,
    /// Specific instructions for use
    #[fhir(name="usageInstruction", min="0", max="1", summary=true, modifier=false, choice=false)]
