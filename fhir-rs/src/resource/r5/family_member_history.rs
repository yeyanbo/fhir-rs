...
pub struct FamilyMemberHistory {
    ...
    #[fhir(name="dataAbsentReason", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="relationship", min="1", max="1", summary=true, modifier=false, choice="")]
    pub relationship: Option<CodeableConcept>,
    /// male | female | other | unknown
    #[fhir(name="sex", min="0", max="1", summary=true, modifier=false, choice="")]
    pub sex: Option<CodeableConcept>,
    /// (approximate) date of birth
    #[fhir(name="born", min="0", max="1", summary=false, modifier=false, choice="")]
    pub born: Option<StringDt>,
    /// (approximate) age
    #[fhir(name="age", min="0", max="1", summary=true, modifier=false, choice="")]
    pub age: Option<StringDt>,
    /// Age is estimated?
    #[fhir(name="estimatedAge", min="0", max="1", summary=true, modifier=false, choice="")]
    pub estimated_age: Option<BooleanDt>,
    /// Dead? How old/when?
    #[fhir(name="deceased", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct FamilyMemberHistoryConditionBackboneElement {
    ...
    #[fhir(name="contributedToDeath", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct FamilyMemberHistoryProcedureBackboneElement {
    ...
    #[fhir(name="performed", min="0", max="1", summary=false, modifier=false, choice="")]
