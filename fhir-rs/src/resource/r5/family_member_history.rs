...
pub struct FamilyMemberHistory {
    ...
    #[fhir(name="dataAbsentReason", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="relationship", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub relationship: Option<CodeableConcept>,
    /// male | female | other | unknown
    #[fhir(name="sex", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub sex: Option<CodeableConcept>,
    /// (approximate) date of birth
    #[fhir(name="born", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub born: Option<StringDt>,
    /// (approximate) age
    #[fhir(name="age", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub age: Option<StringDt>,
    /// Age is estimated?
    #[fhir(name="estimatedAge", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct FamilyMemberHistoryConditionBackboneElement {
    ...
    #[fhir(name="contributedToDeath", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub contributed_to_death: Option<BooleanDt>,
    /// When condition first manifested
    #[fhir(name="onset", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct FamilyMemberHistoryProcedureBackboneElement {
    ...
    #[fhir(name="performed", min="0", max="1", summary=false, modifier=false, choice=false)]
