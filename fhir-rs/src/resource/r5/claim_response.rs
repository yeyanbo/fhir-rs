...
pub struct ClaimResponse {
    ...
    #[fhir(name="payeeType", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="communicationRequest", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ClaimResponseErrorBackboneElement {
    ...
    #[fhir(name="itemSequence", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub item_sequence: Option<PositiveIntDt>,
    /// Detail sequence number
    #[fhir(name="detailSequence", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub detail_sequence: Option<PositiveIntDt>,
    /// Subdetail sequence number
    #[fhir(name="subDetailSequence", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ClaimResponseInsuranceBackboneElement {
    ...
    #[fhir(name="focal", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub focal: Option<BooleanDt>,
    /// Insurance information
    #[fhir(name="coverage", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ClaimResponseItemBackboneElement {
    ...
    #[fhir(name="itemSequence", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub item_sequence: Option<PositiveIntDt>,
    /// Number for tracking
    #[fhir(name="traceNumber", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub trace_number: Option<Vec<Identifier>>,
...
pub struct ClaimResponseItemDetailBackboneElement {
    ...
    #[fhir(name="detailSequence", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub detail_sequence: Option<PositiveIntDt>,
    /// Number for tracking
    #[fhir(name="traceNumber", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub trace_number: Option<Vec<Identifier>>,
...
pub struct ClaimResponseItemDetailSubDetailBackboneElement {
    ...
    #[fhir(name="subDetailSequence", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub sub_detail_sequence: Option<PositiveIntDt>,
    /// Number for tracking
    #[fhir(name="traceNumber", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub trace_number: Option<Vec<Identifier>>,
