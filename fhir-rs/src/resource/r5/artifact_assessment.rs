...
pub struct ArtifactAssessment {
    ...
    #[fhir(name="lastReviewDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub last_review_date: Option<DateDt>,
    /// The artifact assessed, commented upon or rated
    #[fhir(name="artifact", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub artifact: Option<UriDt>,
    /// Comment, classifier, or rating content
    #[fhir(name="content", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="workflowStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="disposition", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ArtifactAssessmentContentBackboneElement {
    ...
    #[fhir(name="informationType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub information_type: Option<CodeDt>,
    /// Brief summary of the content
    #[fhir(name="summary", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="path", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="freeToShare", min="0", max="1", summary=false, modifier=false, choice=false)]
