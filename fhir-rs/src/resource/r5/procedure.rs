...
pub struct Procedure {
    ...
    #[fhir(name="report", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub report: Option<Vec<Reference>>,
    /// Complication following the procedure
    #[fhir(name="complication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub complication: Option<Vec<CodeableReference>>,
    /// Instructions for follow up
    #[fhir(name="followUp", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="focalDevice", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub focal_device: Option<Vec<ProcedureFocalDeviceBackboneElement>>,
    /// Items used during procedure
    #[fhir(name="used", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ProcedureFocalDeviceBackboneElement {
    ...
    #[fhir(name="action", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub action: Option<CodeableConcept>,
    /// Device that was changed
    #[fhir(name="manipulated", min="1", max="1", summary=false, modifier=false, choice=false)]
