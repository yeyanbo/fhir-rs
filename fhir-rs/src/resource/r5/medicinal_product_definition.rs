...
pub struct MedicinalProductDefinition {
    ...
    #[fhir(name="combinedPharmaceuticalDoseForm", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub combined_pharmaceutical_dose_form: Option<CodeableConcept>,
    /// The path by which the product is taken into or makes contact with the body
    #[fhir(name="route", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="indication", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub indication: Option<MarkdownDt>,
    /// The legal status of supply of the medicinal product as classified by the regulator
    #[fhir(name="legalStatusOfSupply", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub legal_status_of_supply: Option<CodeableConcept>,
    /// Whether the Medicinal Product is subject to additional monitoring for regulatory reasons
    #[fhir(name="additionalMonitoringIndicator", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub additional_monitoring_indicator: Option<CodeableConcept>,
    /// Whether the Medicinal Product is subject to special measures for regulatory reasons
    #[fhir(name="specialMeasures", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub special_measures: Option<Vec<CodeableConcept>>,
    /// If authorised for use in children
    #[fhir(name="pediatricUseIndicator", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="marketingStatus", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub marketing_status: Option<Vec<MarketingStatus>>,
    /// Package type for the product
    #[fhir(name="packagedMedicinalProduct", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="comprisedOf", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="impurity", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub impurity: Option<Vec<CodeableReference>>,
    /// Additional documentation about the medicinal product
    #[fhir(name="attachedDocument", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="masterFile", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="clinicalTrial", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="name", min="1", max="*", summary=true, modifier=false, choice=false)]
    pub name: Option<Vec<MedicinalProductDefinitionNameBackboneElement>>,
    /// Reference to another product, e.g. for linking authorised to investigational product
    #[fhir(name="crossReference", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="characteristic", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionCrossReferenceBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Reference to another product, e.g. for linking authorised to investigational product
    #[fhir(name="product", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionOperationBackboneElement {
    ...
    #[fhir(name="effectiveDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub effective_date: Option<Period>,
    /// The organization responsible for the particular process, e.g. the manufacturer or importer
    #[fhir(name="organization", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub organization: Option<Vec<Reference>>,
    /// Specifies whether this process is considered proprietary or confidential
    #[fhir(name="confidentialityIndicator", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionNameBackboneElement {
    ...
    #[fhir(name="productName", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionNameUsageBackboneElement {
    ...
    #[fhir(name="country", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="language", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionNamePartBackboneElement {
    ...
    #[fhir(name="part", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MedicinalProductDefinitionContactBackboneElement {
    ...
    pub type_: Option<CodeableConcept>,
    /// A product specific contact, person (in a role), or an organization
    #[fhir(name="contact", min="1", max="1", summary=true, modifier=false, choice=false)]
