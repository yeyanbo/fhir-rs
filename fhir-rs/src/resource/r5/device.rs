...
pub struct Device {
    ...
    #[fhir(name="displayName", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="udiCarrier", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="availabilityStatus", min="0", max="1", summary=false, modifier=false, choice="")]
    pub availability_status: Option<CodeableConcept>,
    /// An identifier that supports traceability to the event during which material in this product from one or more biological entities was obtained or pooled
    #[fhir(name="biologicalSourceEvent", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="manufactureDate", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="serialNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    pub serial_number: Option<StringDt>,
    /// The name or names of the device as known to the manufacturer and/or patient
    #[fhir(name="name", min="0", max="*", summary=false, modifier=false, choice="")]
    pub name: Option<Vec<DeviceNameBackboneElement>>,
    /// The manufacturer's model number for the device
    #[fhir(name="modelNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="conformsTo", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="cycle", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="gateway", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceUdiCarrierBackboneElement {
    ...
    #[fhir(name="deviceIdentifier", min="1", max="1", summary=true, modifier=false, choice="")]
    pub device_identifier: Option<StringDt>,
    /// UDI Issuing Organization
    #[fhir(name="issuer", min="1", max="1", summary=true, modifier=false, choice="")]
    pub issuer: Option<UriDt>,
    /// Regional UDI authority
    #[fhir(name="jurisdiction", min="0", max="1", summary=false, modifier=false, choice="")]
    pub jurisdiction: Option<UriDt>,
    /// UDI Machine Readable Barcode String
    #[fhir(name="carrierAIDC", min="0", max="1", summary=true, modifier=false, choice="")]
    pub carrier_aidc: Option<Base64BinaryDt>,
    /// UDI Human Readable Barcode String
    #[fhir(name="carrierHRF", min="0", max="1", summary=true, modifier=false, choice="")]
    pub carrier_hrf: Option<StringDt>,
    /// barcode | rfid | manual | card | self-reported | electronic-transmission | unknown
    #[fhir(name="entryType", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceConformsToBackboneElement {
    ...
    #[fhir(name="specification", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceVersionBackboneElement {
    ...
    #[fhir(name="installDate", min="0", max="1", summary=false, modifier=false, choice="")]
