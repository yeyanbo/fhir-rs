...
pub struct MedicationDispense {
    ...
    #[fhir(name="partOf", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub part_of: Option<Vec<Reference>>,
    /// preparation | in-progress | cancelled | on-hold | completed | entered-in-error | stopped | declined | unknown
    #[fhir(name="status", min="1", max="1", summary=true, modifier=true)]
    pub status: Option<CodeDt>,
    /// Why a dispense was not performed
    #[fhir(name="notPerformedReason", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="authorizingPrescription", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="daysSupply", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub days_supply: Option<Quantity>,
    /// When the recording of the dispense started
    #[fhir(name="recorded", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub recorded: Option<DateTimeDt>,
    /// When product was packaged and reviewed
    #[fhir(name="whenPrepared", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub when_prepared: Option<DateTimeDt>,
    /// When product was given out
    #[fhir(name="whenHandedOver", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationDispenseSubstitutionBackboneElement {
    ...
    #[fhir(name="wasSubstituted", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="responsibleParty", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationDispensePerformerBackboneElement {
    ...
    #[fhir(name="actor", min="1", max="1", summary=false, modifier=false, choice=false)]
