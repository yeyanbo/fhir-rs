...
pub struct GenomicStudy {
    ...
    #[fhir(name="startDate", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="referrer", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub referrer: Option<Reference>,
    /// Healthcare professionals who interpreted the genomic study
    #[fhir(name="interpreter", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="analysis", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct GenomicStudyAnalysisBackboneElement {
    ...
    #[fhir(name="methodType", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub method_type: Option<Vec<CodeableConcept>>,
    /// Type of the genomic changes studied in the analysis (e.g., DNA, RNA, or AA change)
    #[fhir(name="changeType", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub change_type: Option<Vec<CodeableConcept>>,
    /// Genome build that is used in this analysis
    #[fhir(name="genomeBuild", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="specimen", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="protocolPerformed", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub protocol_performed: Option<Reference>,
    /// The genomic regions to be studied in the analysis (BED file)
    #[fhir(name="regionsStudied", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub regions_studied: Option<Vec<Reference>>,
    /// Genomic regions actually called in the analysis event (BED file)
    #[fhir(name="regionsCalled", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct GenomicStudyAnalysisInputBackboneElement {
    ...
    #[fhir(name="file", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="generatedBy", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct GenomicStudyAnalysisPerformerBackboneElement {
    ...
    #[fhir(name="actor", min="0", max="1", summary=false, modifier=false, choice=false)]
