...
pub struct GenomicStudy {
    ...
    #[fhir(name="referrer", min="0", max="1", summary=false, modifier=false, choice="")]
    pub referrer: Option<Reference>,
    /// Healthcare professionals who interpreted the genomic study
    #[fhir(name="interpreter", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="analysis", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct GenomicStudyAnalysisBackboneElement {
    ...
    #[fhir(name="protocolPerformed", min="0", max="1", summary=false, modifier=false, choice="")]
    pub protocol_performed: Option<Reference>,
    /// The genomic regions to be studied in the analysis (BED file)
    #[fhir(name="regionsStudied", min="0", max="*", summary=false, modifier=false, choice="")]
    pub regions_studied: Option<Vec<Reference>>,
    /// Genomic regions actually called in the analysis event (BED file)
    #[fhir(name="regionsCalled", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct GenomicStudyAnalysisInputBackboneElement {
    ...
    #[fhir(name="file", min="0", max="1", summary=true, modifier=false, choice="")]
    pub file: Option<Reference>,
    /// Type of input data (e.g., BAM, CRAM, or FASTA)
    #[fhir(name="type", min="0", max="1", summary=false, modifier=false, choice="")]
    pub type_: Option<CodeableConcept>,
    /// The analysis event or other GenomicStudy that generated this input file
    #[fhir(name="generatedBy", min="0", max="1", summary=false, modifier=false, choice="")]
