...
pub struct InventoryItem {
    ...
    #[fhir(name="responsibleOrganization", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="inventoryStatus", min="0", max="*", summary=true, modifier=false, choice="")]
    pub inventory_status: Option<Vec<CodeableConcept>>,
    /// The base unit of measure - the unit in which the product is used or counted
    #[fhir(name="baseUnit", min="0", max="1", summary=true, modifier=false, choice="")]
    pub base_unit: Option<CodeableConcept>,
    /// Net content or amount present in the item
    #[fhir(name="netContent", min="0", max="1", summary=true, modifier=false, choice="")]
    pub net_content: Option<Quantity>,
    /// Association with other items or products
    #[fhir(name="association", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="instance", min="0", max="1", summary=false, modifier=false, choice="")]
    pub instance: Option<InventoryItemInstanceBackboneElement>,
    /// Link to a product resource used in clinical workflows
    #[fhir(name="productReference", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct InventoryItemNameBackboneElement {
    ...
    #[fhir(name="nameType", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct InventoryItemAssociationBackboneElement {
    ...
    #[fhir(name="associationType", min="1", max="1", summary=true, modifier=false, choice="")]
    pub association_type: Option<CodeableConcept>,
    /// The related item or product
    #[fhir(name="relatedItem", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct InventoryItemCharacteristicBackboneElement {
    ...
    #[fhir(name="characteristicType", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct InventoryItemInstanceBackboneElement {
    ...
    #[fhir(name="expiry", min="0", max="1", summary=false, modifier=false, choice="")]
