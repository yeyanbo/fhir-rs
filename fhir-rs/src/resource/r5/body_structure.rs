...
pub struct BodyStructure {
    ...
    /// Kind of Structure
    #[fhir(name="morphology", min="0", max="1", summary=true, modifier=false, choice="")]
    pub morphology: Option<CodeableConcept>,
    /// Included anatomic location(s)
    #[fhir(name="includedStructure", min="1", max="*", summary=false, modifier=false, choice="")]
    pub included_structure: Option<Vec<BodyStructureIncludedStructureBackboneElement>>,
    /// Excluded anatomic locations(s)
    #[fhir(name="excludedStructure", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct BodyStructureIncludedStructureBackboneElement {
    ...
    #[fhir(name="structure", min="1", max="1", summary=true, modifier=false, choice="")]
    pub structure: Option<CodeableConcept>,
    /// Code that represents the included structure laterality
    #[fhir(name="laterality", min="0", max="1", summary=false, modifier=false, choice="")]
    pub laterality: Option<CodeableConcept>,
    /// Landmark relative location
    #[fhir(name="bodyLandmarkOrientation", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="spatialReference", min="0", max="*", summary=false, modifier=false, choice="")]
    pub spatial_reference: Option<Vec<Reference>>,
    /// Code that represents the included structure qualifier
    #[fhir(name="qualifier", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct BodyStructureIncludedStructureBodyLandmarkOrientationBackboneElement {
    ...
    #[fhir(name="landmarkDescription", min="0", max="*", summary=false, modifier=false, choice="")]
    pub landmark_description: Option<Vec<CodeableConcept>>,
    /// Clockface orientation
    #[fhir(name="clockFacePosition", min="0", max="*", summary=false, modifier=false, choice="")]
    pub clock_face_position: Option<Vec<CodeableConcept>>,
    /// Landmark relative location
    #[fhir(name="distanceFromLandmark", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="surfaceOrientation", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct BodyStructureIncludedStructureBodyLandmarkOrientationDistanceFromLandmarkBackboneElement {
    ...
    #[fhir(name="value", min="0", max="*", summary=false, modifier=false, choice="")]
