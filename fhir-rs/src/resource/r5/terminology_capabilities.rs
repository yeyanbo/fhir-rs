...
pub struct TerminologyCapabilities {
    ...
    #[fhir(name="copyright", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="codeSystem", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="codeSearch", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub code_search: Option<CodeDt>,
    /// Information about the [ValueSet/$validate-code](valueset-operation-validate-code.html) operation
    #[fhir(name="validateCode", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub validate_code: Option<TerminologyCapabilitiesValidateCodeBackboneElement>,
    /// Information about the [ConceptMap/$translate](conceptmap-operation-translate.html) operation
    #[fhir(name="translation", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub translation: Option<TerminologyCapabilitiesTranslationBackboneElement>,
    /// Information about the [ConceptMap/$closure](conceptmap-operation-closure.html) operation
    #[fhir(name="closure", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesCodeSystemBackboneElement {
    ...
    #[fhir(name="subsumption", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesCodeSystemVersionBackboneElement {
    ...
    #[fhir(name="isDefault", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub is_default: Option<BooleanDt>,
    /// If compositional grammar is supported
    #[fhir(name="compositional", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="filter", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesCodeSystemVersionFilterBackboneElement {
    ...
    #[fhir(name="op", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesValidateCodeBackboneElement {
    ...
    #[fhir(name="translations", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesTranslationBackboneElement {
    ...
    #[fhir(name="needsMap", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TerminologyCapabilitiesExpansionBackboneElement {
    ...
    #[fhir(name="hierarchical", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub hierarchical: Option<BooleanDt>,
    /// Whether the server supports paging on expansion
    #[fhir(name="paging", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub paging: Option<BooleanDt>,
    /// Allow request for incomplete expansions?
    #[fhir(name="incomplete", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="textFilter", min="0", max="1", summary=false, modifier=false, choice=false)]
