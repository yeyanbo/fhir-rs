...
pub struct AdverseEvent {
    ...
    #[fhir(name="detected", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub detected: Option<DateTimeDt>,
    /// When the event was recorded
    #[fhir(name="recordedDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub recorded_date: Option<DateTimeDt>,
    /// Effect on the subject due to this event
    #[fhir(name="resultingEffect", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="seriousness", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub seriousness: Option<CodeableConcept>,
    /// Type of outcome from the adverse event
    #[fhir(name="outcome", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub outcome: Option<Vec<CodeableConcept>>,
    /// Who recorded the adverse event
    #[fhir(name="recorder", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub recorder: Option<Reference>,
    /// Who was involved in the adverse event or the potential adverse event and what they did
    #[fhir(name="participant", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub participant: Option<Vec<AdverseEventParticipantBackboneElement>>,
    /// Research study that the subject is enrolled in
    #[fhir(name="study", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub study: Option<Vec<Reference>>,
    /// Considered likely or probable or anticipated in the research study
    #[fhir(name="expectedInResearchStudy", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub expected_in_research_study: Option<BooleanDt>,
    /// The suspected agent causing the adverse event
    #[fhir(name="suspectEntity", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="contributingFactor", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub contributing_factor: Option<Vec<AdverseEventContributingFactorBackboneElement>>,
    /// Preventive actions that contributed to avoiding the adverse event
    #[fhir(name="preventiveAction", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="mitigatingAction", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub mitigating_action: Option<Vec<AdverseEventMitigatingActionBackboneElement>>,
    /// Supporting information relevant to the event
    #[fhir(name="supportingInfo", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct AdverseEventSuspectEntityBackboneElement {
    ...
    #[fhir(name="causality", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct AdverseEventSuspectEntityCausalityBackboneElement {
    ...
    #[fhir(name="assessmentMethod", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="entityRelatedness", min="0", max="1", summary=true, modifier=false, choice=false)]
