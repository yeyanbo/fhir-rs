...
pub struct CapabilityStatement {
    ...
    #[fhir(name="instantiates", min="0", max="*", summary=true, modifier=false, choice="")]
    pub instantiates: Option<Vec<CanonicalDt>>,
    /// Canonical URL of another capability statement this adds to
    #[fhir(name="imports", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="fhirVersion", min="1", max="1", summary=true, modifier=false, choice="")]
    pub fhir_version: Option<CodeDt>,
    /// formats supported (xml | json | ttl | mime type)
    #[fhir(name="format", min="1", max="*", summary=true, modifier=false, choice="")]
    pub format: Option<Vec<CodeDt>>,
    /// Patch formats supported
    #[fhir(name="patchFormat", min="0", max="*", summary=true, modifier=false, choice="")]
    pub patch_format: Option<Vec<CodeDt>>,
    /// Languages supported
    #[fhir(name="acceptLanguage", min="0", max="*", summary=true, modifier=false, choice="")]
    pub accept_language: Option<Vec<CodeDt>>,
    /// Implementation guides supported
    #[fhir(name="implementationGuide", min="0", max="*", summary=true, modifier=false, choice="")]
    pub implementation_guide: Option<Vec<CanonicalDt>>,
    /// If the endpoint is a RESTful one
    #[fhir(name="rest", min="0", max="*", summary=true, modifier=false, choice="")]
    pub rest: Option<Vec<CapabilityStatementRestBackboneElement>>,
    /// If messaging is supported
    #[fhir(name="messaging", min="0", max="*", summary=true, modifier=false, choice="")]
    pub messaging: Option<Vec<CapabilityStatementMessagingBackboneElement>>,
    /// Document definition
    #[fhir(name="document", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct CapabilityStatementSoftwareBackboneElement {
    ...
    #[fhir(name="releaseDate", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct CapabilityStatementRestBackboneElement {
    ...
    #[fhir(name="security", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="interaction", min="0", max="*", summary=false, modifier=false, choice="")]
    pub interaction: Option<Vec<CapabilityStatementRestInteractionBackboneElement>>,
    /// Search parameters for searching all resources
    #[fhir(name="searchParam", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct CapabilityStatementRestResourceBackboneElement {
    ...
    #[fhir(name="supportedProfile", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="versioning", min="0", max="1", summary=false, modifier=false, choice="")]
    pub versioning: Option<CodeDt>,
    /// Whether vRead can return past versions
    #[fhir(name="readHistory", min="0", max="1", summary=false, modifier=false, choice="")]
    pub read_history: Option<BooleanDt>,
    /// If update can commit to a new identity
    #[fhir(name="updateCreate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub update_create: Option<BooleanDt>,
    /// If allows/uses conditional create
    #[fhir(name="conditionalCreate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conditional_create: Option<BooleanDt>,
    /// not-supported | modified-since | not-match | full-support
    #[fhir(name="conditionalRead", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conditional_read: Option<CodeDt>,
    /// If allows/uses conditional update
    #[fhir(name="conditionalUpdate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conditional_update: Option<BooleanDt>,
    /// If allows/uses conditional patch
    #[fhir(name="conditionalPatch", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conditional_patch: Option<BooleanDt>,
    /// not-supported | single | multiple - how conditional delete is supported
    #[fhir(name="conditionalDelete", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conditional_delete: Option<CodeDt>,
    /// literal | logical | resolves | enforced | local
    #[fhir(name="referencePolicy", min="0", max="*", summary=false, modifier=false, choice="")]
    pub reference_policy: Option<Vec<CodeDt>>,
    /// _include values supported by the server
    #[fhir(name="searchInclude", min="0", max="*", summary=false, modifier=false, choice="")]
    pub search_include: Option<Vec<StringDt>>,
    /// _revinclude values supported by the server
    #[fhir(name="searchRevInclude", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct CapabilityStatementRestResourceOperationBackboneElement {
    ...
    #[fhir(name="definition", min="1", max="1", summary=true, modifier=false, choice="")]
    pub definition: Option<CanonicalDt>,
...
pub struct CapabilityStatementRestSecurityBackboneElement {
    ...
    #[fhir(name="cors", min="0", max="1", summary=true, modifier=false, choice="")]
    pub cors: Option<BooleanDt>,
    /// OAuth | SMART-on-FHIR | NTLM | Basic | Kerberos | Certificates
    #[fhir(name="service", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct CapabilityStatementMessagingBackboneElement {
    ...
    #[fhir(name="reliableCache", min="0", max="1", summary=false, modifier=false, choice="")]
    pub reliable_cache: Option<UnsignedIntDt>,
    /// Messaging interface behavior details
    #[fhir(name="documentation", min="0", max="1", summary=false, modifier=false, choice="")]
    pub documentation: Option<MarkdownDt>,
    /// Messages supported by this system
    #[fhir(name="supportedMessage", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct CapabilityStatementMessagingEndpointBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// http | ftp | mllp +
    #[fhir(name="protocol", min="1", max="1", summary=false, modifier=false, choice="")]
    pub protocol: Option<Coding>,
    /// Network address or identifier of the end-point
    #[fhir(name="address", min="1", max="1", summary=false, modifier=false, choice="")]
