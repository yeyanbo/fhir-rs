...
pub struct Coverage {
    ...
    #[fhir(name="paymentBy", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    /// Owner of the policy
    #[fhir(name="policyHolder", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub policy_holder: Option<Reference>,
    /// Subscriber to the policy
    #[fhir(name="subscriber", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub subscriber: Option<Reference>,
    /// ID assigned to the subscriber
    #[fhir(name="subscriberId", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub subscriber_id: Option<Vec<Identifier>>,
    /// Plan beneficiary
    #[fhir(name="beneficiary", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub beneficiary: Option<Reference>,
    /// Dependent number
    #[fhir(name="dependent", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="class", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    /// Insurer network
    #[fhir(name="network", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub network: Option<StringDt>,
    /// Patient payments for services/products
    #[fhir(name="costToBeneficiary", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub cost_to_beneficiary: Option<Vec<CoverageCostToBeneficiaryBackboneElement>>,
    /// Reimbursement to insurer
    #[fhir(name="subrogation", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub subrogation: Option<BooleanDt>,
    /// Contract details
    #[fhir(name="contract", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub contract: Option<Vec<Reference>>,
    /// Insurance plan details
    #[fhir(name="insurancePlan", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CoveragePaymentByBackboneElement {
    ...
    #[fhir(name="party", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub party: Option<Reference>,
    /// Party's responsibility
    #[fhir(name="responsibility", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct CoverageCostToBeneficiaryBackboneElement {
    ...
    #[fhir(name="exception", min="0", max="*", summary=false, modifier=false, choice=false)]
