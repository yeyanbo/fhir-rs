...
pub struct Evidence {
    ...
    #[fhir(name="experimental", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="assertion", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub assertion: Option<MarkdownDt>,
    /// Footnotes and/or explanatory notes
    #[fhir(name="note", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub note: Option<Vec<Annotation>>,
    /// Evidence variable such as population, exposure, or outcome
    #[fhir(name="variableDefinition", min="1", max="*", summary=false, modifier=false, choice=false)]
    pub variable_definition: Option<Vec<EvidenceVariableDefinitionBackboneElement>>,
    /// The method to combine studies
    #[fhir(name="synthesisType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub synthesis_type: Option<CodeableConcept>,
    /// The design of the study that produced this evidence
    #[fhir(name="studyDesign", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub study_design: Option<Vec<CodeableConcept>>,
    /// Values and parameters for a single statistic
    #[fhir(name="statistic", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub statistic: Option<Vec<EvidenceStatisticBackboneElement>>,
    /// Certainty or quality of the evidence
    #[fhir(name="certainty", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceCertaintyBackboneElement {
    ...
    #[fhir(name="rating", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub rating: Option<CodeableConcept>,
    /// Individual or group who did the rating
    #[fhir(name="rater", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub rater: Option<StringDt>,
    /// A domain or subdomain of certainty
    #[fhir(name="subcomponent", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceVariableDefinitionBackboneElement {
    ...
    #[fhir(name="variableRole", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub variable_role: Option<CodeableConcept>,
    /// Definition of the actual variable related to the statistic(s)
    #[fhir(name="observed", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub observed: Option<Reference>,
    /// Definition of the intended variable related to the Evidence
    #[fhir(name="intended", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub intended: Option<Reference>,
    /// low | moderate | high | exact
    #[fhir(name="directnessMatch", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceStatisticBackboneElement {
    ...
    #[fhir(name="statisticType", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="numberOfEvents", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub number_of_events: Option<UnsignedIntDt>,
    /// The number of participants affected
    #[fhir(name="numberAffected", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub number_affected: Option<UnsignedIntDt>,
    /// Number of samples in the statistic
    #[fhir(name="sampleSize", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sample_size: Option<EvidenceStatisticSampleSizeBackboneElement>,
    /// An attribute of the Statistic
    #[fhir(name="attributeEstimate", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub attribute_estimate: Option<Vec<EvidenceStatisticAttributeEstimateBackboneElement>>,
    /// An aspect of the statistical model
    #[fhir(name="modelCharacteristic", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceStatisticSampleSizeBackboneElement {
    ...
    #[fhir(name="numberOfStudies", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub number_of_studies: Option<UnsignedIntDt>,
    /// Cumulative number of participants
    #[fhir(name="numberOfParticipants", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub number_of_participants: Option<UnsignedIntDt>,
    /// Number of participants with known results for measured variables
    #[fhir(name="knownDataCount", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceStatisticModelCharacteristicVariableBackboneElement {
    ...
    #[fhir(name="variableDefinition", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub variable_definition: Option<Reference>,
    /// continuous | dichotomous | ordinal | polychotomous
    #[fhir(name="handling", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub handling: Option<CodeDt>,
    /// Description for grouping of ordinal or polychotomous variables
    #[fhir(name="valueCategory", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub value_category: Option<Vec<CodeableConcept>>,
    /// Discrete value for grouping of ordinal or polychotomous variables
    #[fhir(name="valueQuantity", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub value_quantity: Option<Vec<Quantity>>,
    /// Range of values for grouping of ordinal or polychotomous variables
    #[fhir(name="valueRange", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceStatisticAttributeEstimateBackboneElement {
    ...
    #[fhir(name="level", min="0", max="1", summary=false, modifier=false, choice=false)]
