...
pub struct PaymentReconciliation {
    ...
    #[fhir(name="kind", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="issuerType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub issuer_type: Option<CodeableConcept>,
    /// Party generating payment
    #[fhir(name="paymentIssuer", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="outcome", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Type of card
    #[fhir(name="cardBrand", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub card_brand: Option<StringDt>,
    /// Digits for verification
    #[fhir(name="accountNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Processor name
    #[fhir(name="processor", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub processor: Option<StringDt>,
    /// Check number or payment reference
    #[fhir(name="referenceNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub reference_number: Option<StringDt>,
    /// Authorization number
    #[fhir(name="authorization", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub authorization: Option<StringDt>,
    /// Amount offered by the issuer
    #[fhir(name="tenderedAmount", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub tendered_amount: Option<Money>,
    /// Amount returned by the receiver
    #[fhir(name="returnedAmount", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub returned_amount: Option<Money>,
    /// Total amount of Payment
    #[fhir(name="amount", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub amount: Option<Money>,
    /// Business identifier for the payment
    #[fhir(name="paymentIdentifier", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub payment_identifier: Option<Identifier>,
    /// Settlement particulars
    #[fhir(name="allocation", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct PaymentReconciliationAllocationBackboneElement {
    ...
    #[fhir(name="predecessor", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub predecessor: Option<Identifier>,
    /// Subject of the payment
    #[fhir(name="target", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub target: Option<Reference>,
    /// Sub-element of the subject
    #[fhir(name="targetItem", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Applied-to account
    #[fhir(name="account", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub account: Option<Reference>,
    /// Category of payment
    #[fhir(name="type", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub type_: Option<CodeableConcept>,
    /// Submitter of the request
    #[fhir(name="submitter", min="0", max="1", summary=false, modifier=false, choice=false)]
