...
pub struct ImmunizationRecommendation {
    ...
    #[fhir(name="recommendation", min="1", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ImmunizationRecommendationRecommendationBackboneElement {
    ...
    #[fhir(name="vaccineCode", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub vaccine_code: Option<Vec<CodeableConcept>>,
    /// Disease to be immunized against
    #[fhir(name="targetDisease", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub target_disease: Option<Vec<CodeableConcept>>,
    /// Vaccine which is contraindicated to fulfill the recommendation
    #[fhir(name="contraindicatedVaccineCode", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="forecastReason", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub forecast_reason: Option<Vec<CodeableConcept>>,
    /// Dates governing proposed immunization
    #[fhir(name="dateCriterion", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="doseNumber", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="supportingImmunization", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub supporting_immunization: Option<Vec<Reference>>,
    /// Patient observations supporting recommendation
    #[fhir(name="supportingPatientInformation", min="0", max="*", summary=false, modifier=false, choice=false)]
