...
pub struct ChargeItem {
    ...
    #[fhir(name="definitionUri", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub definition_uri: Option<Vec<UriDt>>,
    /// Resource defining the code of this ChargeItem
    #[fhir(name="definitionCanonical", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="performingOrganization", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub performing_organization: Option<Reference>,
    /// Organization requesting the charged service
    #[fhir(name="requestingOrganization", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub requesting_organization: Option<Reference>,
    /// Organization that has ownership of the (potential, future) revenue
    #[fhir(name="costCenter", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="bodysite", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub bodysite: Option<Vec<CodeableConcept>>,
    /// Unit price overriding the associated rules
    #[fhir(name="unitPriceComponent", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub unit_price_component: Option<MonetaryComponent>,
    /// Total price overriding the associated rules
    #[fhir(name="totalPriceComponent", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub total_price_component: Option<MonetaryComponent>,
    /// Reason for overriding the list price/factor
    #[fhir(name="overrideReason", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub override_reason: Option<CodeableConcept>,
    /// Individual who was entering
    #[fhir(name="enterer", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub enterer: Option<Reference>,
    /// Date the charge item was entered
    #[fhir(name="enteredDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="service", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub service: Option<Vec<CodeableReference>>,
    /// Product charged
    #[fhir(name="product", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub product: Option<Vec<CodeableReference>>,
    /// Account to place this charge
    #[fhir(name="account", min="0", max="*", summary=true, modifier=false, choice=false)]
