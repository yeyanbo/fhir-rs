...
pub struct ChargeItem {
    ...
    #[fhir(name="definitionUri", min="0", max="*", summary=false, modifier=false, choice="")]
    pub definition_uri: Option<Vec<UriDt>>,
    /// Resource defining the code of this ChargeItem
    #[fhir(name="definitionCanonical", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="performingOrganization", min="0", max="1", summary=false, modifier=false, choice="")]
    pub performing_organization: Option<Reference>,
    /// Organization requesting the charged service
    #[fhir(name="requestingOrganization", min="0", max="1", summary=false, modifier=false, choice="")]
    pub requesting_organization: Option<Reference>,
    /// Organization that has ownership of the (potential, future) revenue
    #[fhir(name="costCenter", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="unitPriceComponent", min="0", max="1", summary=false, modifier=false, choice="")]
    pub unit_price_component: Option<MonetaryComponent>,
    /// Total price overriding the associated rules
    #[fhir(name="totalPriceComponent", min="0", max="1", summary=false, modifier=false, choice="")]
    pub total_price_component: Option<MonetaryComponent>,
    /// Reason for overriding the list price/factor
    #[fhir(name="overrideReason", min="0", max="1", summary=false, modifier=false, choice="")]
    pub override_reason: Option<CodeableConcept>,
    /// Individual who was entering
    #[fhir(name="enterer", min="0", max="1", summary=true, modifier=false, choice="")]
    pub enterer: Option<Reference>,
    /// Date the charge item was entered
    #[fhir(name="enteredDate", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="service", min="0", max="*", summary=false, modifier=false, choice="")]
    pub service: Option<Vec<CodeableReference>>,
    /// Product charged
    #[fhir(name="product", min="0", max="*", summary=false, modifier=false, choice="")]
    pub product: Option<Vec<CodeableReference>>,
    /// Account to place this charge
    #[fhir(name="account", min="0", max="*", summary=true, modifier=false, choice="")]
