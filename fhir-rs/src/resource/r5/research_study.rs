...
pub struct ResearchStudy {
    ...
    #[fhir(name="label", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub label: Option<Vec<ResearchStudyLabelBackboneElement>>,
    /// Steps followed in executing study
    #[fhir(name="protocol", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="primaryPurposeType", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub primary_purpose_type: Option<CodeableConcept>,
    /// n-a | early-phase-1 | phase-1 | phase-1-phase-2 | phase-2 | phase-2-phase-3 | phase-3 | phase-4
    #[fhir(name="phase", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub phase: Option<CodeableConcept>,
    /// Classifications of the study design characteristics
    #[fhir(name="studyDesign", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub study_design: Option<Vec<CodeableConcept>>,
    /// Drugs, devices, etc. under study
    #[fhir(name="focus", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="keyword", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub keyword: Option<Vec<CodeableConcept>>,
    /// Geographic area for the study
    #[fhir(name="region", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub region: Option<Vec<CodeableConcept>>,
    /// Brief text explaining the study
    #[fhir(name="descriptionSummary", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="site", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="associatedParty", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub associated_party: Option<Vec<ResearchStudyAssociatedPartyBackboneElement>>,
    /// Status of study with time for that status
    #[fhir(name="progressStatus", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub progress_status: Option<Vec<ResearchStudyProgressStatusBackboneElement>>,
    /// accrual-goal-met | closed-due-to-toxicity | closed-due-to-lack-of-study-progress | temporarily-closed-per-study-design
    #[fhir(name="whyStopped", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub why_stopped: Option<CodeableConcept>,
    /// Target or actual group of participants enrolled in study
    #[fhir(name="recruitment", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub recruitment: Option<ResearchStudyRecruitmentBackboneElement>,
    /// Defined path through the study for a subject
    #[fhir(name="comparisonGroup", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub comparison_group: Option<Vec<ResearchStudyComparisonGroupBackboneElement>>,
    /// A goal for the study
    #[fhir(name="objective", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub objective: Option<Vec<ResearchStudyObjectiveBackboneElement>>,
    /// A variable measured during the study
    #[fhir(name="outcomeMeasure", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub outcome_measure: Option<Vec<ResearchStudyOutcomeMeasureBackboneElement>>,
    /// Link to results generated during the study
    #[fhir(name="result", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ResearchStudyComparisonGroupBackboneElement {
    ...
    #[fhir(name="intendedExposure", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub intended_exposure: Option<Vec<Reference>>,
    /// Group of participants who were enrolled in study comparisonGroup
    #[fhir(name="observedGroup", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ResearchStudyProgressStatusBackboneElement {
    ...
    #[fhir(name="state", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ResearchStudyRecruitmentBackboneElement {
    ...
    #[fhir(name="targetNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub target_number: Option<UnsignedIntDt>,
    /// Actual total number of participants enrolled in study
    #[fhir(name="actualNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub actual_number: Option<UnsignedIntDt>,
    /// Inclusion and exclusion criteria
    #[fhir(name="eligibility", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub eligibility: Option<Reference>,
    /// Group of participants who were enrolled in study
    #[fhir(name="actualGroup", min="0", max="1", summary=true, modifier=false, choice=false)]
