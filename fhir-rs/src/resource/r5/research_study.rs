...
pub struct ResearchStudy {
    ...
    #[fhir(name="label", min="0", max="*", summary=false, modifier=false, choice="")]
    pub label: Option<Vec<ResearchStudyLabelBackboneElement>>,
    /// Steps followed in executing study
    #[fhir(name="protocol", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="primaryPurposeType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub primary_purpose_type: Option<CodeableConcept>,
    /// n-a | early-phase-1 | phase-1 | phase-1-phase-2 | phase-2 | phase-2-phase-3 | phase-3 | phase-4
    #[fhir(name="phase", min="0", max="1", summary=true, modifier=false, choice="")]
    pub phase: Option<CodeableConcept>,
    /// Classifications of the study design characteristics
    #[fhir(name="studyDesign", min="0", max="*", summary=true, modifier=false, choice="")]
    pub study_design: Option<Vec<CodeableConcept>>,
    /// Drugs, devices, etc. under study
    #[fhir(name="focus", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="region", min="0", max="*", summary=true, modifier=false, choice="")]
    pub region: Option<Vec<CodeableConcept>>,
    /// Brief text explaining the study
    #[fhir(name="descriptionSummary", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="site", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct ResearchStudyComparisonGroupBackboneElement {
    ...
    #[fhir(name="intendedExposure", min="0", max="*", summary=false, modifier=false, choice="")]
    pub intended_exposure: Option<Vec<Reference>>,
    /// Group of participants who were enrolled in study comparisonGroup
    #[fhir(name="observedGroup", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct ResearchStudyProgressStatusBackboneElement {
    ...
    #[fhir(name="state", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct ResearchStudyRecruitmentBackboneElement {
    ...
    #[fhir(name="targetNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    pub target_number: Option<UnsignedIntDt>,
    /// Actual total number of participants enrolled in study
    #[fhir(name="actualNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    pub actual_number: Option<UnsignedIntDt>,
    /// Inclusion and exclusion criteria
    #[fhir(name="eligibility", min="0", max="1", summary=false, modifier=false, choice="")]
    pub eligibility: Option<Reference>,
    /// Group of participants who were enrolled in study
    #[fhir(name="actualGroup", min="0", max="1", summary=true, modifier=false, choice="")]
