...
pub struct Subscription {
    ...
    #[fhir(name="topic", min="1", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="filterBy", min="0", max="*", summary=true, modifier=false, choice="")]
    pub filter_by: Option<Vec<SubscriptionFilterByBackboneElement>>,
    /// Channel type for notifications
    #[fhir(name="channelType", min="1", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="heartbeatPeriod", min="0", max="1", summary=true, modifier=false, choice="")]
    pub heartbeat_period: Option<UnsignedIntDt>,
    /// Timeout in seconds to attempt notification delivery
    #[fhir(name="timeout", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="content", min="0", max="1", summary=true, modifier=false, choice="")]
    pub content: Option<CodeDt>,
    /// Maximum number of events that can be combined in a single notification
    #[fhir(name="maxCount", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubscriptionFilterByBackboneElement {
    ...
    #[fhir(name="resourceType", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="comparator", min="0", max="1", summary=false, modifier=false, choice="")]
