...
pub struct ActivityDefinition {
    ...
    /// Kind of resource
    #[fhir(name="kind", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="intent", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="product", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="specimenRequirement", min="0", max="*", summary=false, modifier=false, choice="")]
    pub specimen_requirement: Option<Vec<CanonicalDt>>,
    /// What observations are required to perform this action
    #[fhir(name="observationRequirement", min="0", max="*", summary=false, modifier=false, choice="")]
    pub observation_requirement: Option<Vec<CanonicalDt>>,
    /// What observations must be produced by this action
    #[fhir(name="observationResultRequirement", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct ActivityDefinitionDynamicValueBackboneElement {
    ...
    #[fhir(name="path", min="1", max="1", summary=false, modifier=false, choice="")]
    pub path: Option<StringDt>,
    /// An expression that provides the dynamic value for the customization
    #[fhir(name="expression", min="1", max="1", summary=false, modifier=false, choice="")]
