...
pub struct ActivityDefinition {
    ...
    /// Kind of resource
    #[fhir(name="kind", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="intent", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="product", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="specimenRequirement", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub specimen_requirement: Option<Vec<CanonicalDt>>,
    /// What observations are required to perform this action
    #[fhir(name="observationRequirement", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub observation_requirement: Option<Vec<CanonicalDt>>,
    /// What observations must be produced by this action
    #[fhir(name="observationResultRequirement", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ActivityDefinitionDynamicValueBackboneElement {
    ...
    #[fhir(name="path", min="1", max="1", summary=false, modifier=false, choice=false)]
