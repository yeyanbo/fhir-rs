...
pub struct OperationDefinition {
    ...
    #[fhir(name="affectsState", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="system", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="instance", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub instance: Option<BooleanDt>,
    /// Validation information for in parameters
    #[fhir(name="inputProfile", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub input_profile: Option<CanonicalDt>,
    /// Validation information for out parameters
    #[fhir(name="outputProfile", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="overload", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct OperationDefinitionParameterBackboneElement {
    ...
    /// in | out
    #[fhir(name="use", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Minimum Cardinality
    #[fhir(name="min", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub min: Option<IntegerDt>,
    /// Maximum Cardinality (a number or *)
    #[fhir(name="max", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="allowedType", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="targetProfile", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub target_profile: Option<Vec<CanonicalDt>>,
    /// number | date | string | token | reference | composite | quantity | uri | special
    #[fhir(name="searchType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub search_type: Option<CodeDt>,
    /// ValueSet details if this is coded
    #[fhir(name="binding", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub binding: Option<OperationDefinitionParameterBindingBackboneElement>,
    /// References to this parameter
    #[fhir(name="referencedFrom", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub referenced_from: Option<Vec<OperationDefinitionParameterReferencedFromBackboneElement>>,
    /// Parts of a nested Parameter
    #[fhir(name="part", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct OperationDefinitionParameterBindingBackboneElement {
    ...
    #[fhir(name="strength", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub strength: Option<CodeDt>,
    /// Source of value set
    #[fhir(name="valueSet", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct OperationDefinitionOverloadBackboneElement {
    ...
    #[fhir(name="parameterName", min="0", max="*", summary=false, modifier=false, choice=false)]
