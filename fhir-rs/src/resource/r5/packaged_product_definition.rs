...
pub struct PackagedProductDefinition {
    ...
    #[fhir(name="packageFor", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="containedItemQuantity", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="legalStatusOfSupply", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="copackagedIndicator", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="packaging", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct PackagedProductDefinitionPackagingBackboneElement {
    ...
    #[fhir(name="componentPart", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="quantity", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub quantity: Option<IntegerDt>,
    /// Material type of the package item
    #[fhir(name="material", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="alternateMaterial", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub alternate_material: Option<Vec<CodeableConcept>>,
    /// Shelf Life and storage information
    #[fhir(name="shelfLifeStorage", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="containedItem", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="packaging", min="0", max="*", summary=true, modifier=false, choice=false)]
