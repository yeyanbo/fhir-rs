...
pub struct PackagedProductDefinition {
    ...
    #[fhir(name="packageFor", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="containedItemQuantity", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="legalStatusOfSupply", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="copackagedIndicator", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="packaging", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct PackagedProductDefinitionPackagingBackboneElement {
    ...
    #[fhir(name="componentPart", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="material", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="alternateMaterial", min="0", max="*", summary=true, modifier=false, choice="")]
    pub alternate_material: Option<Vec<CodeableConcept>>,
    /// Shelf Life and storage information
    #[fhir(name="shelfLifeStorage", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="containedItem", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="packaging", min="0", max="*", summary=true, modifier=false, choice="")]
