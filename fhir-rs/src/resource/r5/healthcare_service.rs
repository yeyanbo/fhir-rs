...
pub struct HealthcareService {
    ...
    #[fhir(name="providedBy", min="0", max="1", summary=true, modifier=false, choice="")]
    pub provided_by: Option<Reference>,
    /// The service within which this service is offered
    #[fhir(name="offeredIn", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="extraDetails", min="0", max="1", summary=false, modifier=false, choice="")]
    pub extra_details: Option<MarkdownDt>,
    /// Facilitates quick identification of the service
    #[fhir(name="photo", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="coverageArea", min="0", max="*", summary=false, modifier=false, choice="")]
    pub coverage_area: Option<Vec<Reference>>,
    /// Conditions under which service is available/offered
    #[fhir(name="serviceProvisionCode", min="0", max="*", summary=false, modifier=false, choice="")]
    pub service_provision_code: Option<Vec<CodeableConcept>>,
    /// Specific eligibility requirements required to use the service
    #[fhir(name="eligibility", min="0", max="*", summary=false, modifier=false, choice="")]
    pub eligibility: Option<Vec<HealthcareServiceEligibilityBackboneElement>>,
    /// Programs that this service is applicable to
    #[fhir(name="program", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="referralMethod", min="0", max="*", summary=false, modifier=false, choice="")]
    pub referral_method: Option<Vec<CodeableConcept>>,
    /// If an appointment is required for access to this service
    #[fhir(name="appointmentRequired", min="0", max="1", summary=false, modifier=false, choice="")]
