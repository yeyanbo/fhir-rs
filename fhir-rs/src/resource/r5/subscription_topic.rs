...
pub struct SubscriptionTopic {
    ...
    #[fhir(name="derivedFrom", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="resourceTrigger", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub resource_trigger: Option<Vec<SubscriptionTopicResourceTriggerBackboneElement>>,
    /// Event definitions the SubscriptionTopic
    #[fhir(name="eventTrigger", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="canFilterBy", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="notificationShape", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubscriptionTopicEventTriggerBackboneElement {
    ...
    #[fhir(name="event", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub event: Option<CodeableConcept>,
    /// Data Type or Resource (reference to definition) for this trigger definition
    #[fhir(name="resource", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubscriptionTopicCanFilterByBackboneElement {
    ...
    #[fhir(name="filterDefinition", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub filter_definition: Option<UriDt>,
    /// eq | ne | gt | lt | ge | le | sa | eb | ap
    #[fhir(name="comparator", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct SubscriptionTopicResourceTriggerBackboneElement {
    ...
    #[fhir(name="supportedInteraction", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub supported_interaction: Option<Vec<CodeDt>>,
    /// Query based trigger rule
    #[fhir(name="queryCriteria", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub query_criteria: Option<SubscriptionTopicResourceTriggerQueryCriteriaBackboneElement>,
    /// FHIRPath based trigger rule
    #[fhir(name="fhirPathCriteria", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubscriptionTopicResourceTriggerQueryCriteriaBackboneElement {
    ...
    #[fhir(name="previous", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub previous: Option<StringDt>,
    /// test-passes | test-fails
    #[fhir(name="resultForCreate", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub result_for_create: Option<CodeDt>,
    /// Rule applied to current resource state
    #[fhir(name="current", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub current: Option<StringDt>,
    /// test-passes | test-fails
    #[fhir(name="resultForDelete", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub result_for_delete: Option<CodeDt>,
    /// Both must be true flag
    #[fhir(name="requireBoth", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubscriptionTopicNotificationShapeBackboneElement {
    ...
    #[fhir(name="include", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub include: Option<Vec<StringDt>>,
    /// Reverse include directives, rooted in the resource for this shape
    #[fhir(name="revInclude", min="0", max="*", summary=true, modifier=false, choice=false)]
