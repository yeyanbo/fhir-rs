...
pub struct MeasureReport {
    ...
    #[fhir(name="measure", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="reporter", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub reporter: Option<Reference>,
    /// What vendor prepared the data
    #[fhir(name="reportingVendor", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="period", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub period: Option<Period>,
    /// What parameters were provided to the report
    #[fhir(name="inputParameters", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="evaluatedResource", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MeasureReportGroupBackboneElement {
    ...
    #[fhir(name="measureScore", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MeasureReportGroupPopulationBackboneElement {
    ...
    #[fhir(name="subjectResults", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub subject_results: Option<Reference>,
    /// For subject-list reports, a subject result in this population
    #[fhir(name="subjectReport", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub subject_report: Option<Vec<Reference>>,
    /// What individual(s) in the population
    #[fhir(name="subjects", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MeasureReportGroupStratifierBackboneElement {
    ...
    #[fhir(name="stratum", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MeasureReportGroupStratifierStratumBackboneElement {
    ...
    #[fhir(name="measureScore", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub measure_score: Option<Duration>,
}
