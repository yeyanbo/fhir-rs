...
pub struct ConceptMap {
    ...
    #[fhir(name="additionalAttribute", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub additional_attribute: Option<Vec<ConceptMapAdditionalAttributeBackboneElement>>,
    /// The source value set that contains the concepts that are being mapped
    #[fhir(name="sourceScope", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub source_scope: Option<CanonicalDt>,
    /// The target value set which provides context for the mappings
    #[fhir(name="targetScope", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ConceptMapGroupBackboneElement {
    ...
    #[fhir(name="unmapped", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ConceptMapGroupElementBackboneElement {
    ...
    #[fhir(name="valueSet", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub value_set: Option<CanonicalDt>,
    /// No mapping to a target concept for this source concept
    #[fhir(name="noMap", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ConceptMapGroupElementTargetBackboneElement {
    ...
    #[fhir(name="dependsOn", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ConceptMapGroupElementTargetDependsOnBackboneElement {
    ...
    #[fhir(name="attribute", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ConceptMapGroupUnmappedBackboneElement {
    ...
    #[fhir(name="otherMap", min="0", max="1", summary=false, modifier=false, choice=false)]
