...
pub struct Invoice {
    ...
    #[fhir(name="cancelledReason", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="recipient", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="issuer", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="lineItem", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub line_item: Option<Vec<InvoiceLineItemBackboneElement>>,
    /// Components of Invoice total
    #[fhir(name="totalPriceComponent", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub total_price_component: Option<Vec<MonetaryComponent>>,
    /// Net total of this Invoice
    #[fhir(name="totalNet", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub total_net: Option<Money>,
    /// Gross total of this Invoice
    #[fhir(name="totalGross", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub total_gross: Option<Money>,
    /// Payment details
    #[fhir(name="paymentTerms", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct InvoiceLineItemBackboneElement {
    ...
    #[fhir(name="chargeItem", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub charge_item: Option<CodeableConcept>,
    /// Components of total line item price
    #[fhir(name="priceComponent", min="0", max="*", summary=false, modifier=false, choice=false)]
