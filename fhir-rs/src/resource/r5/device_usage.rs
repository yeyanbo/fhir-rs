...
pub struct DeviceUsage {
    ...
    #[fhir(name="dateAsserted", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="usageStatus", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub usage_status: Option<CodeableConcept>,
    /// The reason for asserting the usage status - for example forgot, lost, stolen, broken
    #[fhir(name="usageReason", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub usage_reason: Option<Vec<CodeableConcept>>,
    /// How device is being used
    #[fhir(name="adherence", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub adherence: Option<DeviceUsageAdherenceBackboneElement>,
    /// Who made the statement
    #[fhir(name="informationSource", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub information_source: Option<Reference>,
    /// Code or Reference to device used
    #[fhir(name="device", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct DeviceUsageAdherenceBackboneElement {
    ...
    #[fhir(name="reason", min="1", max="*", summary=false, modifier=false, choice=false)]
