...
pub struct DeviceUsage {
    ...
    #[fhir(name="usageStatus", min="0", max="1", summary=false, modifier=false, choice="")]
    pub usage_status: Option<CodeableConcept>,
    /// The reason for asserting the usage status - for example forgot, lost, stolen, broken
    #[fhir(name="usageReason", min="0", max="*", summary=false, modifier=false, choice="")]
    pub usage_reason: Option<Vec<CodeableConcept>>,
    /// How device is being used
    #[fhir(name="adherence", min="0", max="1", summary=false, modifier=false, choice="")]
    pub adherence: Option<DeviceUsageAdherenceBackboneElement>,
    /// Who made the statement
    #[fhir(name="informationSource", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct DeviceUsageAdherenceBackboneElement {
    ...
    #[fhir(name="reason", min="1", max="*", summary=false, modifier=false, choice="")]
