...
pub struct Slot {
    ...
    #[fhir(name="appointmentType", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub appointment_type: Option<Vec<CodeableConcept>>,
    /// The schedule resource that this slot defines an interval of status information
    #[fhir(name="schedule", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub schedule: Option<Reference>,
    /// busy | free | busy-unavailable | busy-tentative | entered-in-error
    #[fhir(name="status", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub status: Option<CodeDt>,
    /// Date/Time that the slot is to begin
    #[fhir(name="start", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub start: Option<InstantDt>,
    /// Date/Time that the slot is to conclude
    #[fhir(name="end", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub end: Option<InstantDt>,
    /// This slot has already been overbooked, appointments are unlikely to be accepted for this time
    #[fhir(name="overbooked", min="0", max="1", summary=false, modifier=false, choice=false)]
