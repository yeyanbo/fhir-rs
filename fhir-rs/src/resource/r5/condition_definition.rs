...
pub struct ConditionDefinition {
    ...
    #[fhir(name="stage", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub stage: Option<CodeableConcept>,
    /// Whether Severity is appropriate
    #[fhir(name="hasSeverity", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub has_severity: Option<BooleanDt>,
    /// Whether bodySite is appropriate
    #[fhir(name="hasBodySite", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub has_body_site: Option<BooleanDt>,
    /// Whether stage is appropriate
    #[fhir(name="hasStage", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="observation", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub observation: Option<Vec<ConditionDefinitionObservationBackboneElement>>,
    /// Medications particularly relevant for this condition
    #[fhir(name="medication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub medication: Option<Vec<ConditionDefinitionMedicationBackboneElement>>,
    /// Observation that suggets this condition
    #[fhir(name="precondition", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub precondition: Option<Vec<ConditionDefinitionPreconditionBackboneElement>>,
    /// Appropriate team for this condition
    #[fhir(name="team", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub team: Option<Vec<Reference>>,
    /// Questionnaire for this condition
    #[fhir(name="questionnaire", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ConditionDefinitionQuestionnaireBackboneElement {
    ...
    #[fhir(name="purpose", min="1", max="1", summary=false, modifier=false, choice=false)]
