...
pub struct ClinicalImpression {
    ...
    #[fhir(name="previous", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub previous: Option<Reference>,
    /// Relevant impressions of patient state
    #[fhir(name="problem", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="changePattern", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub change_pattern: Option<CodeableConcept>,
    /// Clinical Protocol followed
    #[fhir(name="protocol", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="finding", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub finding: Option<Vec<ClinicalImpressionFindingBackboneElement>>,
    /// Estimate of likely outcome
    #[fhir(name="prognosisCodeableConcept", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub prognosis_codeable_concept: Option<Vec<CodeableConcept>>,
    /// RiskAssessment expressing likely outcome
    #[fhir(name="prognosisReference", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ClinicalImpressionFindingBackboneElement {
    ...
    #[fhir(name="basis", min="0", max="1", summary=false, modifier=false, choice=false)]
