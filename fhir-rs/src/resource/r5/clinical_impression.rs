...
pub struct ClinicalImpression {
    ...
    #[fhir(name="previous", min="0", max="1", summary=false, modifier=false, choice="")]
    pub previous: Option<Reference>,
    /// Relevant impressions of patient state
    #[fhir(name="problem", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="changePattern", min="0", max="1", summary=false, modifier=false, choice="")]
    pub change_pattern: Option<CodeableConcept>,
    /// Clinical Protocol followed
    #[fhir(name="protocol", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="finding", min="0", max="*", summary=false, modifier=false, choice="")]
    pub finding: Option<Vec<ClinicalImpressionFindingBackboneElement>>,
    /// Estimate of likely outcome
    #[fhir(name="prognosisCodeableConcept", min="0", max="*", summary=false, modifier=false, choice="")]
    pub prognosis_codeable_concept: Option<Vec<CodeableConcept>>,
    /// RiskAssessment expressing likely outcome
    #[fhir(name="prognosisReference", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct ClinicalImpressionFindingBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// What was found
    #[fhir(name="item", min="0", max="1", summary=false, modifier=false, choice="")]
    pub item: Option<CodeableReference>,
    /// Which investigations support finding
    #[fhir(name="basis", min="0", max="1", summary=false, modifier=false, choice="")]
