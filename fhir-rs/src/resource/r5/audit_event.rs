...
pub struct AuditEvent {
    ...
    #[fhir(name="action", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub action: Option<CodeDt>,
    /// emergency | alert | critical | error | warning | notice | informational | debug
    #[fhir(name="severity", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub severity: Option<CodeDt>,
    /// When the activity occurred
    #[fhir(name="occurred", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub occurred: Option<DateTimeDt>,
    /// Time when the event was recorded
    #[fhir(name="recorded", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="authorization", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="agent", min="1", max="*", summary=true, modifier=false, choice=false)]
    pub agent: Option<Vec<AuditEventAgentBackboneElement>>,
    /// Audit Event Reporter
    #[fhir(name="source", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub source: Option<AuditEventSourceBackboneElement>,
    /// Data or objects used
    #[fhir(name="entity", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct AuditEventSourceBackboneElement {
    ...
    #[fhir(name="observer", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct AuditEventOutcomeBackboneElement {
    ...
    #[fhir(name="detail", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct AuditEventAgentBackboneElement {
    ...
    #[fhir(name="role", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub role: Option<Vec<CodeableConcept>>,
    /// Identifier of who
    #[fhir(name="who", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub who: Option<Reference>,
    /// Whether user is initiator
    #[fhir(name="requestor", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="policy", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="authorization", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub authorization: Option<Vec<CodeableConcept>>,
}
...
pub struct AuditEventEntityBackboneElement {
    ...
    #[fhir(name="what", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// Query parameters
    #[fhir(name="query", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="agent", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub agent: Option<Vec<AuditEventAgentBackboneElement>>,
}
