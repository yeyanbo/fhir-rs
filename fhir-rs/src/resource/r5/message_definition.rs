...
pub struct MessageDefinition {
    ...
    /// Takes the place of
    #[fhir(name="replaces", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="parent", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="responseRequired", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub response_required: Option<CodeDt>,
    /// Responses to this message
    #[fhir(name="allowedResponse", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub allowed_response: Option<Vec<MessageDefinitionAllowedResponseBackboneElement>>,
    /// Canonical reference to a GraphDefinition
    #[fhir(name="graph", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MessageDefinitionFocusBackboneElement {
    ...
    #[fhir(name="profile", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="max", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MessageDefinitionAllowedResponseBackboneElement {
    ...
    #[fhir(name="message", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub message: Option<CanonicalDt>,
    /// When should this response be used
    #[fhir(name="situation", min="0", max="1", summary=false, modifier=false, choice=false)]
