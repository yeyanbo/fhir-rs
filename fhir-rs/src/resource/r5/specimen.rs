...
pub struct Specimen {
    ...
    #[fhir(name="accessionIdentifier", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="receivedTime", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// grouped | pooled
    #[fhir(name="combined", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="feature", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="processing", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub processing: Option<Vec<SpecimenProcessingBackboneElement>>,
    /// Direct container of specimen (tube/slide, etc.)
    #[fhir(name="container", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct SpecimenContainerBackboneElement {
    ...
    #[fhir(name="device", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub device: Option<Reference>,
    /// Where the container is
    #[fhir(name="location", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub location: Option<Reference>,
    /// Quantity of specimen within container
    #[fhir(name="specimenQuantity", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct SpecimenCollectionBackboneElement {
    ...
    #[fhir(name="collector", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub collector: Option<Reference>,
    /// Collection time
    #[fhir(name="collected", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="procedure", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="fastingStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
