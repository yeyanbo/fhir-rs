...
pub struct Location {
    ...
    #[fhir(name="operationalStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="position", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="hoursOfOperation", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct LocationPositionBackboneElement {
    ...
    #[fhir(name="longitude", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub longitude: Option<DecimalDt>,
    /// Latitude with WGS84 datum
    #[fhir(name="latitude", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub latitude: Option<DecimalDt>,
    /// Altitude with WGS84 datum
    #[fhir(name="altitude", min="0", max="1", summary=false, modifier=false, choice=false)]
