...
pub struct OrganizationAffiliation {
    ...
    #[fhir(name="participatingOrganization", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="network", min="0", max="*", summary=true, modifier=false, choice=false)]
