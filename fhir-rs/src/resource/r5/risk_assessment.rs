...
pub struct RiskAssessment {
    ...
    #[fhir(name="basedOn", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="basis", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub basis: Option<Vec<Reference>>,
    /// Outcome predicted
    #[fhir(name="prediction", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub prediction: Option<Vec<RiskAssessmentPredictionBackboneElement>>,
    /// How to reduce risk
    #[fhir(name="mitigation", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct RiskAssessmentPredictionBackboneElement {
    ...
    #[fhir(name="probability", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub probability: Option<Range>,
    /// Likelihood of specified outcome as a qualitative value
    #[fhir(name="qualitativeRisk", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub qualitative_risk: Option<CodeableConcept>,
    /// Relative likelihood
    #[fhir(name="relativeRisk", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub relative_risk: Option<DecimalDt>,
    /// Timeframe or age range
    #[fhir(name="when", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub when: Option<Range>,
    /// Explanation of prediction
    #[fhir(name="rationale", min="0", max="1", summary=false, modifier=false, choice=false)]
