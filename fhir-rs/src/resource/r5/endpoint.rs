...
pub struct Endpoint {
    ...
    #[fhir(name="connectionType", min="1", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="environmentType", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="address", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub address: Option<UrlDt>,
    /// Usage depends on the channel type
    #[fhir(name="header", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EndpointPayloadBackboneElement {
    ...
    #[fhir(name="mimeType", min="0", max="*", summary=true, modifier=false, choice=false)]
