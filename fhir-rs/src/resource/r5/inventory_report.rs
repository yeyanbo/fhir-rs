...
pub struct InventoryReport {
    ...
    #[fhir(name="operationType", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub operation_type: Option<CodeableConcept>,
    /// The reason for this count - regular count, ad-hoc count, new arrivals, etc
    #[fhir(name="operationTypeReason", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub operation_type_reason: Option<CodeableConcept>,
    /// When the report has been submitted
    #[fhir(name="reportedDateTime", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="reportingPeriod", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub reporting_period: Option<Period>,
    /// An inventory listing section (grouped by any of the attributes)
    #[fhir(name="inventoryListing", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct InventoryReportInventoryListingBackboneElement {
    ...
    #[fhir(name="itemStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub item_status: Option<CodeableConcept>,
    /// The date and time when the items were counted
    #[fhir(name="countingDateTime", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub counting_date_time: Option<DateTimeDt>,
    /// The item or items in this listing
    #[fhir(name="item", min="0", max="*", summary=true, modifier=false, choice=false)]
