...
pub struct Appointment {
    ...
    #[fhir(name="cancellationReason", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="appointmentType", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="replaces", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="previousAppointment", min="0", max="1", summary=false, modifier=false, choice="")]
    pub previous_appointment: Option<Reference>,
    /// The originating appointment in a recurring set of appointments
    #[fhir(name="originatingAppointment", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="minutesDuration", min="0", max="1", summary=false, modifier=false, choice="")]
    pub minutes_duration: Option<PositiveIntDt>,
    /// Potential date/time interval(s) requested to allocate the appointment within
    #[fhir(name="requestedPeriod", min="0", max="*", summary=false, modifier=false, choice="")]
    pub requested_period: Option<Vec<Period>>,
    /// The slots that this appointment is filling
    #[fhir(name="slot", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="cancellationDate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub cancellation_date: Option<DateTimeDt>,
    /// Additional comments
    #[fhir(name="note", min="0", max="*", summary=false, modifier=false, choice="")]
    pub note: Option<Vec<Annotation>>,
    /// Detailed information and instructions for the patient
    #[fhir(name="patientInstruction", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="participant", min="1", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="occurrenceChanged", min="0", max="1", summary=false, modifier=false, choice="")]
    pub occurrence_changed: Option<BooleanDt>,
    /// Details of the recurrence pattern/template used to generate occurrences
    #[fhir(name="recurrenceTemplate", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct AppointmentParticipantBackboneElement {
    ...
    #[fhir(name="required", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct AppointmentRecurrenceTemplateBackboneElement {
    ...
    #[fhir(name="timezone", min="0", max="1", summary=false, modifier=false, choice="")]
    pub timezone: Option<CodeableConcept>,
    /// The frequency of the recurrence
    #[fhir(name="recurrenceType", min="1", max="1", summary=false, modifier=false, choice="")]
    pub recurrence_type: Option<CodeableConcept>,
    /// The date when the recurrence should end
    #[fhir(name="lastOccurrenceDate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub last_occurrence_date: Option<DateDt>,
    /// The number of planned occurrences
    #[fhir(name="occurrenceCount", min="0", max="1", summary=false, modifier=false, choice="")]
    pub occurrence_count: Option<PositiveIntDt>,
    /// Specific dates for a recurring set of appointments (no template)
    #[fhir(name="occurrenceDate", min="0", max="*", summary=false, modifier=false, choice="")]
    pub occurrence_date: Option<Vec<DateDt>>,
    /// Information about weekly recurring appointments
    #[fhir(name="weeklyTemplate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub weekly_template: Option<AppointmentRecurrenceTemplateWeeklyTemplateBackboneElement>,
    /// Information about monthly recurring appointments
    #[fhir(name="monthlyTemplate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub monthly_template: Option<AppointmentRecurrenceTemplateMonthlyTemplateBackboneElement>,
    /// Information about yearly recurring appointments
    #[fhir(name="yearlyTemplate", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="excludingDate", min="0", max="*", summary=false, modifier=false, choice="")]
    pub excluding_date: Option<Vec<DateDt>>,
    /// Any recurrence IDs that should be excluded from the recurrence
    #[fhir(name="excludingRecurrenceId", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct AppointmentRecurrenceTemplateMonthlyTemplateBackboneElement {
    ...
    #[fhir(name="dayOfMonth", min="0", max="1", summary=false, modifier=false, choice="")]
    pub day_of_month: Option<PositiveIntDt>,
    /// Indicates which week of the month the appointment should occur
    #[fhir(name="nthWeekOfMonth", min="0", max="1", summary=false, modifier=false, choice="")]
    pub nth_week_of_month: Option<Coding>,
    /// Indicates which day of the week the appointment should occur
    #[fhir(name="dayOfWeek", min="0", max="1", summary=false, modifier=false, choice="")]
    pub day_of_week: Option<Coding>,
    /// Recurs every nth month
    #[fhir(name="monthInterval", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct AppointmentRecurrenceTemplateWeeklyTemplateBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Recurs on Mondays
    #[fhir(name="monday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub monday: Option<BooleanDt>,
    /// Recurs on Tuesday
    #[fhir(name="tuesday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub tuesday: Option<BooleanDt>,
    /// Recurs on Wednesday
    #[fhir(name="wednesday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub wednesday: Option<BooleanDt>,
    /// Recurs on Thursday
    #[fhir(name="thursday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub thursday: Option<BooleanDt>,
    /// Recurs on Friday
    #[fhir(name="friday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub friday: Option<BooleanDt>,
    /// Recurs on Saturday
    #[fhir(name="saturday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub saturday: Option<BooleanDt>,
    /// Recurs on Sunday
    #[fhir(name="sunday", min="0", max="1", summary=false, modifier=false, choice="")]
    pub sunday: Option<BooleanDt>,
    /// Recurs every nth week
    #[fhir(name="weekInterval", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct AppointmentRecurrenceTemplateYearlyTemplateBackboneElement {
    ...
    #[fhir(name="yearInterval", min="1", max="1", summary=false, modifier=false, choice="")]
