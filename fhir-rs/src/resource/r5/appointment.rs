...
pub struct Appointment {
    ...
    #[fhir(name="cancellationReason", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="appointmentType", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="previousAppointment", min="0", max="1", summary=false, modifier=false)]
    pub previous_appointment: Option<Reference>,
    /// The originating appointment in a recurring set of appointments
    #[fhir(name="originatingAppointment", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="minutesDuration", min="0", max="1", summary=false, modifier=false)]
    pub minutes_duration: Option<PositiveIntDt>,
    /// Potential date/time interval(s) requested to allocate the appointment within
    #[fhir(name="requestedPeriod", min="0", max="*", summary=false, modifier=false)]
    pub requested_period: Option<Vec<Period>>,
    /// The slots that this appointment is filling
    #[fhir(name="slot", min="0", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="cancellationDate", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="participant", min="1", max="*", summary=false, modifier=false)]
    ...
    #[fhir(name="occurrenceChanged", min="0", max="1", summary=false, modifier=false)]
    pub occurrence_changed: Option<BooleanDt>,
    /// Details of the recurrence pattern/template used to generate occurrences
    #[fhir(name="recurrenceTemplate", min="0", max="*", summary=false, modifier=false)]
...
pub struct AppointmentParticipantBackboneElement {
    ...
    #[fhir(name="required", min="0", max="1", summary=true, modifier=false)]
...
pub struct AppointmentRecurrenceTemplateBackboneElement {
    ...
    #[fhir(name="excludingDate", min="0", max="*", summary=false, modifier=false)]
    pub excluding_date: Option<Vec<DateDt>>,
    /// Any recurrence IDs that should be excluded from the recurrence
    #[fhir(name="excludingRecurrenceId", min="0", max="*", summary=false, modifier=false)]
...
pub struct AppointmentRecurrenceTemplateMonthlyTemplateBackboneElement {
    ...
    #[fhir(name="dayOfMonth", min="0", max="1", summary=false, modifier=false)]
    pub day_of_month: Option<PositiveIntDt>,
    /// Indicates which week of the month the appointment should occur
    #[fhir(name="nthWeekOfMonth", min="0", max="1", summary=false, modifier=false)]
    pub nth_week_of_month: Option<Coding>,
    /// Indicates which day of the week the appointment should occur
    #[fhir(name="dayOfWeek", min="0", max="1", summary=false, modifier=false)]
    pub day_of_week: Option<Coding>,
    /// Recurs every nth month
    #[fhir(name="monthInterval", min="1", max="1", summary=false, modifier=false)]
...
pub struct AppointmentRecurrenceTemplateWeeklyTemplateBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Recurs on Mondays
    #[fhir(name="monday", min="0", max="1", summary=false, modifier=false)]
    pub monday: Option<BooleanDt>,
    /// Recurs on Tuesday
    #[fhir(name="tuesday", min="0", max="1", summary=false, modifier=false)]
    pub tuesday: Option<BooleanDt>,
    /// Recurs on Wednesday
    #[fhir(name="wednesday", min="0", max="1", summary=false, modifier=false)]
    pub wednesday: Option<BooleanDt>,
    /// Recurs on Thursday
    #[fhir(name="thursday", min="0", max="1", summary=false, modifier=false)]
    pub thursday: Option<BooleanDt>,
    /// Recurs on Friday
    #[fhir(name="friday", min="0", max="1", summary=false, modifier=false)]
    pub friday: Option<BooleanDt>,
    /// Recurs on Saturday
    #[fhir(name="saturday", min="0", max="1", summary=false, modifier=false)]
    pub saturday: Option<BooleanDt>,
    /// Recurs on Sunday
    #[fhir(name="sunday", min="0", max="1", summary=false, modifier=false)]
    pub sunday: Option<BooleanDt>,
    /// Recurs every nth week
    #[fhir(name="weekInterval", min="0", max="1", summary=false, modifier=false)]
...
pub struct AppointmentRecurrenceTemplateYearlyTemplateBackboneElement {
    ...
    #[fhir(name="yearInterval", min="1", max="1", summary=false, modifier=false)]
