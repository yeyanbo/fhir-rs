...
pub struct Bundle {
    ...
    #[fhir(name="timestamp", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub timestamp: Option<InstantDt>,
    /// If search, the total number of matches
    #[fhir(name="total", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub total: Option<UnsignedIntDt>,
    /// Links related to this Bundle
    #[fhir(name="link", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub link: Option<Vec<BundleLinkBackboneElement>>,
    /// Entry in the bundle - will have a resource or information
    #[fhir(name="entry", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub entry: Option<Vec<BundleEntryBackboneElement>>,
    /// Digital Signature
    #[fhir(name="signature", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub signature: Option<Signature>,
    /// Issues with the Bundle
    #[fhir(name="issues", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct BundleEntryBackboneElement {
    ...
    #[fhir(name="fullUrl", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="search", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub search: Option<BundleEntrySearchBackboneElement>,
    /// Additional execution information (transaction/batch/history)
    #[fhir(name="request", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub request: Option<BundleEntryRequestBackboneElement>,
    /// Results of execution (transaction/batch/history)
    #[fhir(name="response", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct BundleEntrySearchBackboneElement {
    ...
    #[fhir(name="mode", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub mode: Option<CodeDt>,
    /// Search ranking (between 0 and 1)
    #[fhir(name="score", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct BundleEntryRequestBackboneElement {
    ...
    #[fhir(name="method", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="ifNoneMatch", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub if_none_match: Option<StringDt>,
    /// For managing cache currency
    #[fhir(name="ifModifiedSince", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub if_modified_since: Option<InstantDt>,
    /// For managing update contention
    #[fhir(name="ifMatch", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub if_match: Option<StringDt>,
    /// For conditional creates
    #[fhir(name="ifNoneExist", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct BundleEntryResponseBackboneElement {
    ...
    #[fhir(name="etag", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="outcome", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct BundleLinkBackboneElement {
    ...
    #[fhir(name="relation", min="1", max="1", summary=true, modifier=false, choice=false)]
