...
pub struct Consent {
    ...
    #[fhir(name="grantor", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub grantor: Option<Vec<Reference>>,
    /// Who is agreeing to the policy and rules
    #[fhir(name="grantee", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub grantee: Option<Vec<Reference>>,
    /// Consent workflow management
    #[fhir(name="manager", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub manager: Option<Vec<Reference>>,
    /// Consent Enforcer
    #[fhir(name="controller", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub controller: Option<Vec<Reference>>,
    /// Source from which this consent is taken
    #[fhir(name="sourceAttachment", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub source_attachment: Option<Vec<Attachment>>,
    /// Source from which this consent is taken
    #[fhir(name="sourceReference", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub source_reference: Option<Vec<Reference>>,
    /// Regulations establishing base Consent
    #[fhir(name="regulatoryBasis", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub regulatory_basis: Option<Vec<CodeableConcept>>,
    /// Computable version of the backing policy
    #[fhir(name="policyBasis", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub policy_basis: Option<ConsentPolicyBasisBackboneElement>,
    /// Human Readable Policy
    #[fhir(name="policyText", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub policy_text: Option<Vec<Reference>>,
    /// Consent Verified by patient or family
    #[fhir(name="verification", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="provision", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ConsentProvisionBackboneElement {
    ...
    #[fhir(name="action", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub action: Option<Vec<CodeableConcept>>,
    /// Security Labels that define affected resources
    #[fhir(name="securityLabel", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub security_label: Option<Vec<Coding>>,
    /// Context of activities covered by this provision
    #[fhir(name="purpose", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub purpose: Option<Vec<Coding>>,
    /// e.g. Resource Type, Profile, CDA, etc
    #[fhir(name="documentType", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub document_type: Option<Vec<Coding>>,
    /// e.g. Resource Type, Profile, etc
    #[fhir(name="resourceType", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="dataPeriod", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="provision", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub provision: Option<Vec<ConsentProvisionBackboneElement>>,
}
...
pub struct ConsentProvisionDataBackboneElement {
    ...
    #[fhir(name="meaning", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ConsentVerificationBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Has been verified
    #[fhir(name="verified", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub verified: Option<BooleanDt>,
    /// Business case of verification
    #[fhir(name="verificationType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub verification_type: Option<CodeableConcept>,
    /// Person conducting verification
    #[fhir(name="verifiedBy", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub verified_by: Option<Reference>,
    /// Person who verified
    #[fhir(name="verifiedWith", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub verified_with: Option<Reference>,
    /// When consent verified
    #[fhir(name="verificationDate", min="0", max="*", summary=false, modifier=false, choice=false)]
