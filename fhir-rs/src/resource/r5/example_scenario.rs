...
pub struct ExampleScenario {
    ...
    #[fhir(name="instance", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub instance: Option<Vec<ExampleScenarioInstanceBackboneElement>>,
    /// Major process within scenario
    #[fhir(name="process", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ExampleScenarioInstanceBackboneElement {
    ...
    #[fhir(name="key", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub key: Option<StringDt>,
    /// Data structure for example
    #[fhir(name="structureType", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub structure_type: Option<Coding>,
    /// E.g. 4.0.1
    #[fhir(name="structureVersion", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub structure_version: Option<StringDt>,
    /// Rules instance adheres to
    #[fhir(name="structureProfile", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="content", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="containedInstance", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ExampleScenarioInstanceContainedInstanceBackboneElement {
    ...
    #[fhir(name="instanceReference", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub instance_reference: Option<StringDt>,
    /// Key of contained instance version
    #[fhir(name="versionReference", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ExampleScenarioProcessBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Label for procss
    #[fhir(name="title", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub title: Option<StringDt>,
    /// Human-friendly description of the process
    #[fhir(name="description", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub description: Option<MarkdownDt>,
    /// Status before process starts
    #[fhir(name="preConditions", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub pre_conditions: Option<MarkdownDt>,
    /// Status after successful completion
    #[fhir(name="postConditions", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub post_conditions: Option<MarkdownDt>,
    /// Event within of the process
    #[fhir(name="step", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ExampleScenarioProcessStepBackboneElement {
    ...
    #[fhir(name="process", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub process: Option<ExampleScenarioProcessBackboneElement>,
    /// Step is nested workflow
    #[fhir(name="workflow", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="alternative", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub alternative: Option<Vec<ExampleScenarioProcessStepAlternativeBackboneElement>>,
    /// Pause in the flow?
    #[fhir(name="pause", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ExampleScenarioProcessStepOperationBackboneElement {
    ...
    #[fhir(name="initiator", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub initiator: Option<StringDt>,
    /// Who receives the operation
    #[fhir(name="receiver", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub receiver: Option<StringDt>,
    /// Human-friendly description of the operation
    #[fhir(name="description", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub description: Option<MarkdownDt>,
    /// Initiator stays active?
    #[fhir(name="initiatorActive", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub initiator_active: Option<BooleanDt>,
    /// Receiver stays active?
    #[fhir(name="receiverActive", min="0", max="1", summary=false, modifier=false, choice=false)]
