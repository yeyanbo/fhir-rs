...
pub struct DeviceMetric {
    ...
    #[fhir(name="measurementFrequency", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub measurement_frequency: Option<Quantity>,
    /// Describes the calibrations that have been performed or that are required to be performed
    #[fhir(name="calibration", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceMetricCalibrationBackboneElement {
    ...
    #[fhir(name="state", min="0", max="1", summary=false, modifier=false, choice=false)]
