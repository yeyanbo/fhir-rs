...
pub struct RegulatedAuthorization {
    ...
    #[fhir(name="validityPeriod", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="intendedUse", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="holder", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub holder: Option<Reference>,
    /// The regulatory authority or authorizing body granting the authorization
    #[fhir(name="regulator", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="case", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct RegulatedAuthorizationCaseBackboneElement {
    ...
    #[fhir(name="application", min="0", max="*", summary=true, modifier=false, choice=false)]
