...
pub struct TestPlan {
    ...
    #[fhir(name="testTools", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub test_tools: Option<MarkdownDt>,
    /// The required criteria to execute the test plan - e.g. preconditions, previous tests
    #[fhir(name="dependency", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="exitCriteria", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub exit_criteria: Option<MarkdownDt>,
    /// The test cases that constitute this plan
    #[fhir(name="testCase", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TestPlanTestCaseBackboneElement {
    ...
    #[fhir(name="testRun", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub test_run: Option<Vec<TestPlanTestCaseTestRunBackboneElement>>,
    /// The test data used in the test case
    #[fhir(name="testData", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub test_data: Option<Vec<TestPlanTestCaseTestDataBackboneElement>>,
    /// Test assertions or expectations
    #[fhir(name="assertion", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TestPlanTestCaseTestRunBackboneElement {
    ...
    #[fhir(name="narrative", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub narrative: Option<MarkdownDt>,
    /// The test cases in a structured language e.g. gherkin, Postman, or FHIR TestScript
    #[fhir(name="script", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestPlanTestCaseAssertionBackboneElement {
    ...
    #[fhir(name="object", min="0", max="*", summary=false, modifier=false, choice=false)]
