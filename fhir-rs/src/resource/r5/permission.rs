...
pub struct Permission {
    ...
    #[fhir(name="asserter", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub asserter: Option<Reference>,
    /// The date that permission was asserted
    #[fhir(name="date", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub date: Option<Vec<DateTimeDt>>,
    /// The period in which the permission is active
    #[fhir(name="validity", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub validity: Option<Period>,
    /// The asserted justification for using the data
    #[fhir(name="justification", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct PermissionJustificationBackboneElement {
    ...
    #[fhir(name="basis", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub basis: Option<Vec<CodeableConcept>>,
    /// Justifing rational
    #[fhir(name="evidence", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct PermissionRuleBackboneElement {
    ...
    #[fhir(name="activity", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub activity: Option<Vec<PermissionRuleActivityBackboneElement>>,
    /// What limits apply to the use of the data
    #[fhir(name="limit", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct PermissionRuleActivityBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Authorized actor(s)
    #[fhir(name="actor", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct PermissionRuleDataBackboneElement {
    ...
    #[fhir(name="period", min="0", max="*", summary=true, modifier=false, choice=false)]
