...
pub struct Permission {
    ...
    #[fhir(name="asserter", min="0", max="1", summary=true, modifier=false, choice="")]
    pub asserter: Option<Reference>,
    /// The date that permission was asserted
    #[fhir(name="date", min="0", max="*", summary=true, modifier=false, choice="")]
    pub date: Option<Vec<DateTimeDt>>,
    /// The period in which the permission is active
    #[fhir(name="validity", min="0", max="1", summary=true, modifier=false, choice="")]
    pub validity: Option<Period>,
    /// The asserted justification for using the data
    #[fhir(name="justification", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct PermissionJustificationBackboneElement {
    ...
    #[fhir(name="basis", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct PermissionRuleBackboneElement {
    ...
    #[fhir(name="activity", min="0", max="*", summary=true, modifier=false, choice="")]
    pub activity: Option<Vec<PermissionRuleActivityBackboneElement>>,
    /// What limits apply to the use of the data
    #[fhir(name="limit", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct PermissionRuleActivityBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Authorized actor(s)
    #[fhir(name="actor", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct PermissionRuleDataBackboneElement {
    ...
    #[fhir(name="period", min="0", max="*", summary=true, modifier=false, choice="")]
