...
pub struct ClinicalUseDefinition {
    ...
    #[fhir(name="contraindication", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="interaction", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub interaction: Option<ClinicalUseDefinitionInteractionBackboneElement>,
    /// The population group to which this applies
    #[fhir(name="population", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub population: Option<Vec<Reference>>,
    /// Logic used by the clinical use definition
    #[fhir(name="library", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub library: Option<Vec<CanonicalDt>>,
    /// A possible negative outcome from the use of this treatment
    #[fhir(name="undesirableEffect", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="warning", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ClinicalUseDefinitionInteractionBackboneElement {
    ...
    #[fhir(name="interactant", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="effect", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub effect: Option<CodeableReference>,
    /// The incidence of the interaction, e.g. theoretical, observed
    #[fhir(name="incidence", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub incidence: Option<CodeableConcept>,
    /// Actions for managing the interaction
    #[fhir(name="management", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ClinicalUseDefinitionContraindicationBackboneElement {
    ...
    #[fhir(name="diseaseSymptomProcedure", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub disease_symptom_procedure: Option<CodeableReference>,
    /// The status of the disease or symptom for the contraindication
    #[fhir(name="diseaseStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub disease_status: Option<CodeableReference>,
    /// A comorbidity (concurrent condition) or coinfection
    #[fhir(name="comorbidity", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub comorbidity: Option<Vec<CodeableReference>>,
    /// The indication which this is a contraidication for
    #[fhir(name="indication", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="applicability", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="otherTherapy", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ClinicalUseDefinitionContraindicationOtherTherapyBackboneElement {
    ...
    #[fhir(name="relationshipType", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="treatment", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ClinicalUseDefinitionUndesirableEffectBackboneElement {
    ...
    #[fhir(name="symptomConditionEffect", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub symptom_condition_effect: Option<CodeableReference>,
    /// High level classification of the effect
    #[fhir(name="classification", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub classification: Option<CodeableConcept>,
    /// How often the effect is seen
    #[fhir(name="frequencyOfOccurrence", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ClinicalUseDefinitionIndicationBackboneElement {
    ...
    #[fhir(name="intendedEffect", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="undesirableEffect", min="0", max="*", summary=true, modifier=false, choice=false)]
