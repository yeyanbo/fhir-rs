...
pub struct MedicationAdministration {
    ...
    #[fhir(name="occurence", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="isSubPotent", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="dosage", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationAdministrationDosageBackboneElement {
    ...
    #[fhir(name="dose", min="0", max="1", summary=false, modifier=false, choice=false)]
