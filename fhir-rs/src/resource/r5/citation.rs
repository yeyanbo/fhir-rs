...
pub struct Citation {
    ...
    #[fhir(name="summary", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub summary: Option<Vec<CitationSummaryBackboneElement>>,
    /// The assignment to an organizing scheme
    #[fhir(name="classification", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="currentState", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub current_state: Option<Vec<CodeableConcept>>,
    /// An effective date or period for a status of the citation record
    #[fhir(name="statusDate", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="citedArtifact", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationSummaryBackboneElement {
    ...
    #[fhir(name="style", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationStatusDateBackboneElement {
    ...
    #[fhir(name="activity", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub activity: Option<CodeableConcept>,
    /// Either occurred or expected
    #[fhir(name="actual", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactBackboneElement {
    ...
    #[fhir(name="dateAccessed", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub date_accessed: Option<DateTimeDt>,
    /// The defined version of the cited artifact
    #[fhir(name="version", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="title", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub title: Option<Vec<CitationCitedArtifactTitleBackboneElement>>,
    /// Summary of the article or artifact
    #[fhir(name="abstract", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub abstract_: Option<Vec<CitationCitedArtifactAbstractBackboneElement>>,
    /// The component of the article or artifact
    #[fhir(name="part", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="publicationForm", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub publication_form: Option<Vec<CitationCitedArtifactPublicationFormBackboneElement>>,
    /// Used for any URL for the article or artifact cited
    #[fhir(name="webLocation", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="contributorship", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactClassificationBackboneElement {
    ...
    #[fhir(name="classifier", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub classifier: Option<Vec<CodeableConcept>>,
    /// Complex or externally created classification
    #[fhir(name="artifactAssessment", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactPartBackboneElement {
    ...
    #[fhir(name="baseCitation", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactTitleBackboneElement {
    ...
    #[fhir(name="text", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub text: Option<MarkdownDt>,
}
...
pub struct CitationCitedArtifactContributorshipBackboneElement {
    ...
    #[fhir(name="complete", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub complete: Option<BooleanDt>,
    /// An individual entity named as a contributor
    #[fhir(name="entry", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactContributorshipEntryBackboneElement {
    ...
    #[fhir(name="contributor", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub contributor: Option<Reference>,
    /// For citation styles that use initials
    #[fhir(name="forenameInitials", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub forename_initials: Option<StringDt>,
    /// Organizational affiliation
    #[fhir(name="affiliation", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub affiliation: Option<Vec<Reference>>,
    /// The specific contribution
    #[fhir(name="contributionType", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="contributionInstance", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="correspondingContact", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub corresponding_contact: Option<BooleanDt>,
    /// Ranked order of contribution
    #[fhir(name="rankingOrder", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactContributorshipEntryContributionInstanceBackboneElement {
    ...
    #[fhir(name="time", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactRelatesToBackboneElement {
    ...
    #[fhir(name="citation", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub citation: Option<MarkdownDt>,
    /// What document is being referenced
    #[fhir(name="document", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="resourceReference", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactPublicationFormBackboneElement {
    ...
    #[fhir(name="publishedIn", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub published_in: Option<CitationCitedArtifactPublicationFormPublishedInBackboneElement>,
    /// Internet or Print
    #[fhir(name="citedMedium", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub cited_medium: Option<CodeableConcept>,
    /// Volume number of journal or other collection in which the article is published
    #[fhir(name="volume", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub volume: Option<StringDt>,
    /// Issue, part or supplement of journal or other collection in which the article is published
    #[fhir(name="issue", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub issue: Option<StringDt>,
    /// The date the article was added to the database, or the date the article was released
    #[fhir(name="articleDate", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub article_date: Option<DateTimeDt>,
    /// Text representation of the date on which the issue of the cited artifact was published
    #[fhir(name="publicationDateText", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub publication_date_text: Option<StringDt>,
    /// Season in which the cited artifact was published
    #[fhir(name="publicationDateSeason", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub publication_date_season: Option<StringDt>,
    /// The date the article was last revised or updated in the database
    #[fhir(name="lastRevisionDate", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub last_revision_date: Option<DateTimeDt>,
    /// Language(s) in which this form of the article is published
    #[fhir(name="language", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub language: Option<Vec<CodeableConcept>>,
    /// Entry number or identifier for inclusion in a database
    #[fhir(name="accessionNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub accession_number: Option<StringDt>,
    /// Used for full display of pagination
    #[fhir(name="pageString", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub page_string: Option<StringDt>,
    /// Used for isolated representation of first page
    #[fhir(name="firstPage", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub first_page: Option<StringDt>,
    /// Used for isolated representation of last page
    #[fhir(name="lastPage", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub last_page: Option<StringDt>,
    /// Number of pages or screens
    #[fhir(name="pageCount", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CitationCitedArtifactPublicationFormPublishedInBackboneElement {
    ...
    #[fhir(name="publisherLocation", min="0", max="1", summary=false, modifier=false, choice=false)]
