...
pub struct Citation {
    ...
    #[fhir(name="summary", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="currentState", min="0", max="*", summary=false, modifier=false, choice="")]
    pub current_state: Option<Vec<CodeableConcept>>,
    /// An effective date or period for a status of the citation record
    #[fhir(name="statusDate", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="citedArtifact", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationSummaryBackboneElement {
    ...
    #[fhir(name="style", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationStatusDateBackboneElement {
    ...
    #[fhir(name="activity", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactBackboneElement {
    ...
    #[fhir(name="dateAccessed", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="title", min="0", max="*", summary=false, modifier=false, choice="")]
    pub title: Option<Vec<CitationCitedArtifactTitleBackboneElement>>,
    /// Summary of the article or artifact
    #[fhir(name="abstract", min="0", max="*", summary=false, modifier=false, choice="")]
    pub abstract_: Option<Vec<CitationCitedArtifactAbstractBackboneElement>>,
    /// The component of the article or artifact
    #[fhir(name="part", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="publicationForm", min="0", max="*", summary=false, modifier=false, choice="")]
    pub publication_form: Option<Vec<CitationCitedArtifactPublicationFormBackboneElement>>,
    /// Used for any URL for the article or artifact cited
    #[fhir(name="webLocation", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="contributorship", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactClassificationBackboneElement {
    ...
    #[fhir(name="artifactAssessment", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactPartBackboneElement {
    ...
    #[fhir(name="baseCitation", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactContributorshipBackboneElement {
    ...
    #[fhir(name="complete", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactContributorshipEntryBackboneElement {
    ...
    #[fhir(name="contributor", min="1", max="1", summary=false, modifier=false, choice="")]
    pub contributor: Option<Reference>,
    /// For citation styles that use initials
    #[fhir(name="forenameInitials", min="0", max="1", summary=false, modifier=false, choice="")]
    pub forename_initials: Option<StringDt>,
    /// Organizational affiliation
    #[fhir(name="affiliation", min="0", max="*", summary=false, modifier=false, choice="")]
    pub affiliation: Option<Vec<Reference>>,
    /// The specific contribution
    #[fhir(name="contributionType", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="contributionInstance", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="correspondingContact", min="0", max="1", summary=false, modifier=false, choice="")]
    pub corresponding_contact: Option<BooleanDt>,
    /// Ranked order of contribution
    #[fhir(name="rankingOrder", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactRelatesToBackboneElement {
    ...
    #[fhir(name="citation", min="0", max="1", summary=false, modifier=false, choice="")]
    pub citation: Option<MarkdownDt>,
    /// What document is being referenced
    #[fhir(name="document", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="resourceReference", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactPublicationFormBackboneElement {
    ...
    #[fhir(name="accessionNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    pub accession_number: Option<StringDt>,
    /// Used for full display of pagination
    #[fhir(name="pageString", min="0", max="1", summary=false, modifier=false, choice="")]
    pub page_string: Option<StringDt>,
    /// Used for isolated representation of first page
    #[fhir(name="firstPage", min="0", max="1", summary=false, modifier=false, choice="")]
    pub first_page: Option<StringDt>,
    /// Used for isolated representation of last page
    #[fhir(name="lastPage", min="0", max="1", summary=false, modifier=false, choice="")]
    pub last_page: Option<StringDt>,
    /// Number of pages or screens
    #[fhir(name="pageCount", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct CitationCitedArtifactPublicationFormPublishedInBackboneElement {
    ...
    #[fhir(name="publisherLocation", min="0", max="1", summary=false, modifier=false, choice="")]
