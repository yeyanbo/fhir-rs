...
pub struct ResearchSubject {
    ...
    /// Subject status
    #[fhir(name="progress", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="study", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="assignedComparisonGroup", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub assigned_comparison_group: Option<IdDt>,
    /// What path was followed
    #[fhir(name="actualComparisonGroup", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub actual_comparison_group: Option<IdDt>,
    /// Agreement to participate in study
    #[fhir(name="consent", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ResearchSubjectProgressBackboneElement {
    ...
    #[fhir(name="subjectState", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub subject_state: Option<CodeableConcept>,
    /// SignedUp | Screened | Randomized
    #[fhir(name="milestone", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// State change date
    #[fhir(name="endDate", min="0", max="1", summary=false, modifier=false, choice=false)]
