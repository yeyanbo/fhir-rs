...
pub struct PlanDefinition {
    ...
    #[fhir(name="library", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActorBackboneElement {
    ...
    #[fhir(name="option", min="1", max="*", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActorOptionBackboneElement {
    ...
    #[fhir(name="typeCanonical", min="0", max="1", summary=false, modifier=false, choice="")]
    pub type_canonical: Option<CanonicalDt>,
    /// Who or what can participate
    #[fhir(name="typeReference", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActionBackboneElement {
    ...
    #[fhir(name="textEquivalent", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="documentation", min="0", max="*", summary=false, modifier=false, choice="")]
    pub documentation: Option<Vec<RelatedArtifact>>,
    /// What goals this action supports
    #[fhir(name="goalId", min="0", max="*", summary=false, modifier=false, choice="")]
    pub goal_id: Option<Vec<IdDt>>,
    /// Type of individual the action is focused on
    #[fhir(name="subject", min="0", max="1", summary=false, modifier=false, choice="")]
    pub subject: Option<CanonicalDt>,
    /// When the action should be triggered
    #[fhir(name="trigger", min="0", max="*", summary=false, modifier=false, choice="")]
    pub trigger: Option<Vec<TriggerDefinition>>,
    /// Whether or not the action is applicable
    #[fhir(name="condition", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="relatedAction", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="groupingBehavior", min="0", max="1", summary=false, modifier=false, choice="")]
    pub grouping_behavior: Option<CodeDt>,
    /// any | all | all-or-none | exactly-one | at-most-one | one-or-more
    #[fhir(name="selectionBehavior", min="0", max="1", summary=false, modifier=false, choice="")]
    pub selection_behavior: Option<CodeDt>,
    /// must | could | must-unless-documented
    #[fhir(name="requiredBehavior", min="0", max="1", summary=false, modifier=false, choice="")]
    pub required_behavior: Option<CodeDt>,
    /// yes | no
    #[fhir(name="precheckBehavior", min="0", max="1", summary=false, modifier=false, choice="")]
    pub precheck_behavior: Option<CodeDt>,
    /// single | multiple
    #[fhir(name="cardinalityBehavior", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="transform", min="0", max="1", summary=false, modifier=false, choice="")]
    pub transform: Option<CanonicalDt>,
    /// Dynamic aspects of the definition
    #[fhir(name="dynamicValue", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActionOutputBackboneElement {
    ...
    /// What data is provided
    #[fhir(name="relatedData", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActionConditionBackboneElement {
    ...
    #[fhir(name="kind", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActionRelatedActionBackboneElement {
    ...
    #[fhir(name="relationship", min="1", max="1", summary=false, modifier=false, choice="")]
    pub relationship: Option<CodeDt>,
    /// before | before-start | before-end | concurrent | concurrent-with-start | concurrent-with-end | after | after-start | after-end
    #[fhir(name="endRelationship", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionActionParticipantBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// What actor
    #[fhir(name="actorId", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct PlanDefinitionGoalTargetBackboneElement {
    ...
    #[fhir(name="measure", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    /// Reach goal within
    #[fhir(name="due", min="0", max="1", summary=false, modifier=false, choice="")]
