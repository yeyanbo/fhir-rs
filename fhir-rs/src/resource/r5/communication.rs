...
pub struct Communication {
    ...
    /// Reply to
    #[fhir(name="inResponseTo", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="medium", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="about", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    /// When sent
    #[fhir(name="sent", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sent: Option<DateTimeDt>,
    /// When received
    #[fhir(name="received", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="sender", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sender: Option<Reference>,
    /// Indication for message
    #[fhir(name="reason", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub reason: Option<Vec<CodeableReference>>,
    /// Message payload
    #[fhir(name="payload", min="0", max="*", summary=false, modifier=false, choice=false)]
