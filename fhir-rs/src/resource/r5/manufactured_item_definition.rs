...
pub struct ManufacturedItemDefinition {
    ...
    #[fhir(name="manufacturedDoseForm", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct ManufacturedItemDefinitionComponentBackboneElement {
    ...
    #[fhir(name="constituent", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct ManufacturedItemDefinitionComponentConstituentBackboneElement {
    ...
    #[fhir(name="hasIngredient", min="0", max="*", summary=true, modifier=false, choice="")]
