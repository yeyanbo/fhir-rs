...
pub struct ImagingSelection {
    ...
    #[fhir(name="studyUid", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="endpoint", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub endpoint: Option<Vec<Reference>>,
    /// DICOM Series Instance UID
    #[fhir(name="seriesUid", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub series_uid: Option<IdDt>,
    /// DICOM Series Number
    #[fhir(name="seriesNumber", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub series_number: Option<UnsignedIntDt>,
    /// The Frame of Reference UID for the selected images
    #[fhir(name="frameOfReferenceUid", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub frame_of_reference_uid: Option<IdDt>,
    /// Body part examined
    #[fhir(name="bodySite", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="instance", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ImagingSelectionInstanceBackboneElement {
    ...
    #[fhir(name="uid", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub uid: Option<IdDt>,
    /// DICOM Instance Number
    #[fhir(name="number", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub number: Option<UnsignedIntDt>,
    /// DICOM SOP Class UID
    #[fhir(name="sopClass", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sop_class: Option<Coding>,
    /// The selected subset of the SOP Instance
    #[fhir(name="subset", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub subset: Option<Vec<StringDt>>,
    /// A specific 2D region in a DICOM image / frame
    #[fhir(name="imageRegion2D", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="imageRegion3D", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ImagingSelectionInstanceImageRegion2DBackboneElement {
    ...
    #[fhir(name="regionType", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub region_type: Option<CodeDt>,
    /// Specifies the coordinates that define the image region
    #[fhir(name="coordinate", min="1", max="*", summary=false, modifier=false, choice=false)]
