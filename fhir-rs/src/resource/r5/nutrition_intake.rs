...
pub struct NutritionIntake {
    ...
    #[fhir(name="instantiatesCanonical", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub instantiates_canonical: Option<Vec<CanonicalDt>>,
    /// Instantiates external protocol or definition
    #[fhir(name="instantiatesUri", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="statusReason", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="recorded", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="consumedItem", min="1", max="*", summary=false, modifier=false, choice=false)]
    pub consumed_item: Option<Vec<NutritionIntakeConsumedItemBackboneElement>>,
    /// Total nutrient for the whole meal, product, serving
    #[fhir(name="ingredientLabel", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="derivedFrom", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct NutritionIntakeIngredientLabelBackboneElement {
    ...
    #[fhir(name="nutrient", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct NutritionIntakeConsumedItemBackboneElement {
    ...
    #[fhir(name="nutritionProduct", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="notConsumed", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub not_consumed: Option<BooleanDt>,
    /// Reason food or fluid was not consumed
    #[fhir(name="notConsumedReason", min="0", max="1", summary=false, modifier=false, choice=false)]
