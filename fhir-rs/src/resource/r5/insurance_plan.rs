...
pub struct InsurancePlan {
    ...
    /// Product issuer
    #[fhir(name="ownedBy", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub owned_by: Option<Reference>,
    /// Product administrator
    #[fhir(name="administeredBy", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub administered_by: Option<Reference>,
    /// Where product applies
    #[fhir(name="coverageArea", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="network", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub network: Option<Vec<Reference>>,
    /// Coverage details
    #[fhir(name="coverage", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub coverage: Option<Vec<InsurancePlanCoverageBackboneElement>>,
    /// Plan details
    #[fhir(name="plan", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct InsurancePlanPlanBackboneElement {
    ...
    pub network: Option<Vec<Reference>>,
    /// Overall costs
    #[fhir(name="generalCost", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub general_cost: Option<Vec<InsurancePlanPlanGeneralCostBackboneElement>>,
    /// Specific costs
    #[fhir(name="specificCost", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct InsurancePlanPlanGeneralCostBackboneElement {
    ...
    pub type_: Option<CodeableConcept>,
    /// Number of enrollees
    #[fhir(name="groupSize", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub group_size: Option<PositiveIntDt>,
    /// Cost value
    #[fhir(name="cost", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct InsurancePlanPlanSpecificCostBenefitCostBackboneElement {
    ...
    #[fhir(name="qualifiers", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct InsurancePlanCoverageBackboneElement {
    ...
    pub network: Option<Vec<Reference>>,
    /// List of benefits
    #[fhir(name="benefit", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct InsurancePlanCoverageBenefitBackboneElement {
    ...
    /// Benefit limits
    #[fhir(name="limit", min="0", max="*", summary=false, modifier=false, choice=false)]
