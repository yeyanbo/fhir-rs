...
pub struct TestReport {
    ...
    #[fhir(name="testScript", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub test_script: Option<CanonicalDt>,
    /// pass | fail | pending
    #[fhir(name="result", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="tester", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct TestReportSetupActionOperationBackboneElement {
    ...
    #[fhir(name="result", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub result: Option<CodeDt>,
    /// A message associated with the result
    #[fhir(name="message", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestReportParticipantBackboneElement {
    ...
    #[fhir(name="uri", min="1", max="1", summary=false, modifier=false, choice=false)]
