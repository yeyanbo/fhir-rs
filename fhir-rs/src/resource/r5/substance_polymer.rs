...
pub struct SubstancePolymer {
    ...
    #[fhir(name="geometry", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub geometry: Option<CodeableConcept>,
    /// Descrtibes the copolymer sequence type (polymer connectivity)
    #[fhir(name="copolymerConnectivity", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="modification", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub modification: Option<StringDt>,
    /// Todo
    #[fhir(name="monomerSet", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub monomer_set: Option<Vec<SubstancePolymerMonomerSetBackboneElement>>,
    /// Specifies and quantifies the repeated units and their configuration
    #[fhir(name="repeat", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubstancePolymerRepeatBackboneElement {
    ...
    #[fhir(name="averageMolecularFormula", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="repeatUnitAmountType", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub repeat_unit_amount_type: Option<CodeableConcept>,
    /// An SRU - Structural Repeat Unit
    #[fhir(name="repeatUnit", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubstancePolymerRepeatRepeatUnitBackboneElement {
    ...
    #[fhir(name="orientation", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="degreeOfPolymerisation", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub degree_of_polymerisation: Option<Vec<SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisationBackboneElement>>,
    /// A graphical structure for this SRU
    #[fhir(name="structuralRepresentation", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisationBackboneElement {
    ...
    #[fhir(name="average", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubstancePolymerRepeatRepeatUnitStructuralRepresentationBackboneElement {
    ...
    #[fhir(name="attachment", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubstancePolymerMonomerSetBackboneElement {
    ...
    #[fhir(name="ratioType", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub ratio_type: Option<CodeableConcept>,
    /// The starting materials - monomer(s) used in the synthesis of the polymer
    #[fhir(name="startingMaterial", min="0", max="*", summary=true, modifier=false, choice=false)]
