...
pub struct StructureMap {
    ...
    #[fhir(name="url", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="structure", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub structure: Option<Vec<StructureMapStructureBackboneElement>>,
    /// Other maps used by this map (canonical URLs)
    #[fhir(name="import", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub import: Option<Vec<CanonicalDt>>,
    /// Definition of the constant value used in the map rules
    #[fhir(name="const", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub const_: Option<Vec<StructureMapConstBackboneElement>>,
    /// Named sections for reader convenience
    #[fhir(name="group", min="1", max="*", summary=true, modifier=false, choice=false)]
...
pub struct StructureMapGroupBackboneElement {
    ...
    #[fhir(name="extends", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub extends: Option<IdDt>,
    /// types | type-and-types
    #[fhir(name="typeMode", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="input", min="1", max="*", summary=true, modifier=false, choice=false)]
    pub input: Option<Vec<StructureMapGroupInputBackboneElement>>,
    /// Transform Rule from source to target
    #[fhir(name="rule", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct StructureMapGroupRuleBackboneElement {
    ...
    #[fhir(name="source", min="1", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="dependent", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct StructureMapGroupRuleTargetBackboneElement {
    ...
    #[fhir(name="context", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub context: Option<StringDt>,
    /// Field to create in the context
    #[fhir(name="element", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub element: Option<StringDt>,
    /// Named context for field, if desired, and a field is specified
    #[fhir(name="variable", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub variable: Option<IdDt>,
    /// first | share | last | single
    #[fhir(name="listMode", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub list_mode: Option<Vec<CodeDt>>,
    /// Internal rule reference for shared list items
    #[fhir(name="listRuleId", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub list_rule_id: Option<IdDt>,
    /// create | copy +
    #[fhir(name="transform", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct StructureMapGroupRuleDependentBackboneElement {
    ...
    #[fhir(name="parameter", min="1", max="*", summary=true, modifier=false, choice=false)]
    pub parameter: Option<Vec<StructureMapGroupRuleTargetParameterBackboneElement>>,
}
...
pub struct StructureMapGroupRuleSourceBackboneElement {
    ...
    #[fhir(name="context", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="listMode", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="check", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub check: Option<StringDt>,
    /// Message to put in log if source exists (FHIRPath)
    #[fhir(name="logMessage", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct StructureMapStructureBackboneElement {
    ...
    #[fhir(name="alias", min="0", max="1", summary=true, modifier=false, choice=false)]
