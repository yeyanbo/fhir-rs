...
pub struct GraphDefinition {
    ...
    #[fhir(name="node", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct GraphDefinitionNodeBackboneElement {
    ...
    #[fhir(name="nodeId", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct GraphDefinitionLinkBackboneElement {
    ...
    #[fhir(name="min", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="sourceId", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="sliceName", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct GraphDefinitionLinkCompartmentBackboneElement {
    ...
    #[fhir(name="rule", min="1", max="1", summary=false, modifier=false, choice=false)]
