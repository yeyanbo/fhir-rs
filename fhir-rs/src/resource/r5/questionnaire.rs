...
pub struct Questionnaire {
    ...
    #[fhir(name="subjectType", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct QuestionnaireItemBackboneElement {
    ...
    #[fhir(name="linkId", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// all | any
    #[fhir(name="enableBehavior", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub enable_behavior: Option<CodeDt>,
    /// hidden | protected
    #[fhir(name="disabledDisplay", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub disabled_display: Option<CodeDt>,
    /// Whether the item must be included in data results
    #[fhir(name="required", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub required: Option<BooleanDt>,
    /// Whether the item may repeat
    #[fhir(name="repeats", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub repeats: Option<BooleanDt>,
    /// Don't allow human editing
    #[fhir(name="readOnly", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub read_only: Option<BooleanDt>,
    /// No more than these many characters
    #[fhir(name="maxLength", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub max_length: Option<IntegerDt>,
    /// optionsOnly | optionsOrType | optionsOrString
    #[fhir(name="answerConstraint", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub answer_constraint: Option<CodeDt>,
    /// ValueSet containing permitted answers
    #[fhir(name="answerValueSet", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub answer_value_set: Option<CanonicalDt>,
    /// Permitted answer
    #[fhir(name="answerOption", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub answer_option: Option<Vec<QuestionnaireItemAnswerOptionBackboneElement>>,
    /// Initial value(s) when item is first rendered
    #[fhir(name="initial", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct QuestionnaireItemAnswerOptionBackboneElement {
    ...
    #[fhir(name="initialSelected", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct QuestionnaireItemEnableWhenBackboneElement {
    ...
    #[fhir(name="question", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub question: Option<StringDt>,
    /// exists | = | != | > | < | >= | <=
    #[fhir(name="operator", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub operator: Option<CodeDt>,
    /// Value for question comparison based on operator
    #[fhir(name="answer", min="1", max="1", summary=false, modifier=false, choice=false)]
