...
pub struct ChargeItemDefinition {
    ...
    #[fhir(name="applicability", min="0", max="*", summary=false, modifier=false, choice="")]
    pub applicability: Option<Vec<ChargeItemDefinitionApplicabilityBackboneElement>>,
    /// Group of properties which are applicable under the same conditions
    #[fhir(name="propertyGroup", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct ChargeItemDefinitionApplicabilityBackboneElement {
    ...
    #[fhir(name="relatedArtifact", min="0", max="1", summary=false, modifier=false, choice="")]
