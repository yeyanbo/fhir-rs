...
pub struct AppointmentResponse {
    ...
    #[fhir(name="appointment", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub appointment: Option<Reference>,
    /// Indicator for a counter proposal
    #[fhir(name="proposedNewTime", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="end", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub end: Option<InstantDt>,
    /// Role of participant in the appointment
    #[fhir(name="participantType", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="recurring", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub recurring: Option<BooleanDt>,
    /// Original date within a recurring request
    #[fhir(name="occurrenceDate", min="0", max="1", summary=false, modifier=false, choice=false)]
