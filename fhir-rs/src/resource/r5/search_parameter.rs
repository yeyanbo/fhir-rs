...
pub struct SearchParameter {
    ...
    #[fhir(name="base", min="1", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="processingMode", min="0", max="1", summary=false, modifier=false, choice="")]
    pub processing_mode: Option<CodeDt>,
    /// FHIRPath expression that constraints the usage of this SearchParamete
    #[fhir(name="constraint", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="multipleOr", min="0", max="1", summary=false, modifier=false, choice="")]
    pub multiple_or: Option<BooleanDt>,
    /// Allow multiple parameters (and)
    #[fhir(name="multipleAnd", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="chain", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct SearchParameterComponentBackboneElement {
    ...
    #[fhir(name="definition", min="1", max="1", summary=false, modifier=false, choice="")]
