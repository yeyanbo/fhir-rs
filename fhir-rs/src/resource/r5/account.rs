...
pub struct Account {
    ...
    #[fhir(name="billingStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// Transaction window
    #[fhir(name="servicePeriod", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub service_period: Option<Period>,
    /// The party(s) that are responsible for covering the payment of this account, and what order should they be applied to the account
    #[fhir(name="coverage", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="guarantor", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub guarantor: Option<Vec<AccountGuarantorBackboneElement>>,
    /// The list of diagnoses relevant to this account
    #[fhir(name="diagnosis", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub diagnosis: Option<Vec<AccountDiagnosisBackboneElement>>,
    /// The list of procedures relevant to this account
    #[fhir(name="procedure", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub procedure: Option<Vec<AccountProcedureBackboneElement>>,
    /// Other associated accounts related to this account
    #[fhir(name="relatedAccount", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub related_account: Option<Vec<AccountRelatedAccountBackboneElement>>,
    /// The base or default currency
    #[fhir(name="currency", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub currency: Option<CodeableConcept>,
    /// Calculated account balance(s)
    #[fhir(name="balance", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub balance: Option<Vec<AccountBalanceBackboneElement>>,
    /// Time the balance amount was calculated
    #[fhir(name="calculatedAt", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct AccountBalanceBackboneElement {
    ...
    #[fhir(name="aggregate", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Estimated balance
    #[fhir(name="estimate", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub estimate: Option<BooleanDt>,
    /// Calculated amount
    #[fhir(name="amount", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct AccountProcedureBackboneElement {
    ...
    #[fhir(name="sequence", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="dateOfService", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="packageCode", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub package_code: Option<Vec<CodeableConcept>>,
    /// Any devices that were associated with the procedure
    #[fhir(name="device", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct AccountRelatedAccountBackboneElement {
    ...
    #[fhir(name="account", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct AccountGuarantorBackboneElement {
    ...
    #[fhir(name="onHold", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct AccountDiagnosisBackboneElement {
    ...
    #[fhir(name="condition", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub condition: Option<CodeableReference>,
    /// Date of the diagnosis (when coded diagnosis)
    #[fhir(name="dateOfDiagnosis", min="0", max="1", summary=false, modifier=false, choice=false)]
