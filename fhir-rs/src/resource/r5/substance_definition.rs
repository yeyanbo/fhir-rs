...
pub struct SubstanceDefinition {
    ...
    #[fhir(name="grade", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="informationSource", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="supplier", min="0", max="*", summary=true, modifier=false, choice="")]
    pub supplier: Option<Vec<Reference>>,
    /// Moiety, for structural modifications
    #[fhir(name="moiety", min="0", max="*", summary=true, modifier=false, choice="")]
    pub moiety: Option<Vec<SubstanceDefinitionMoietyBackboneElement>>,
    /// General specifications for this substance
    #[fhir(name="characterization", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="referenceInformation", min="0", max="1", summary=true, modifier=false, choice="")]
    pub reference_information: Option<Reference>,
    /// The average mass of a molecule of a compound
    #[fhir(name="molecularWeight", min="0", max="*", summary=true, modifier=false, choice="")]
    pub molecular_weight: Option<Vec<SubstanceDefinitionMolecularWeightBackboneElement>>,
    /// Structural information
    #[fhir(name="structure", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="relationship", min="0", max="*", summary=true, modifier=false, choice="")]
    pub relationship: Option<Vec<SubstanceDefinitionRelationshipBackboneElement>>,
    /// Data items specific to nucleic acids
    #[fhir(name="nucleicAcid", min="0", max="1", summary=true, modifier=false, choice="")]
    pub nucleic_acid: Option<Reference>,
    /// Data items specific to polymers
    #[fhir(name="polymer", min="0", max="1", summary=true, modifier=false, choice="")]
    pub polymer: Option<Reference>,
    /// Data items specific to proteins
    #[fhir(name="protein", min="0", max="1", summary=true, modifier=false, choice="")]
    pub protein: Option<Reference>,
    /// Material or taxonomic/anatomical source
    #[fhir(name="sourceMaterial", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionNameBackboneElement {
    ...
    #[fhir(name="preferred", min="0", max="1", summary=true, modifier=false, choice="")]
    pub preferred: Option<BooleanDt>,
    /// Human language that the name is written in
    #[fhir(name="language", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="domain", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="synonym", min="0", max="*", summary=true, modifier=false, choice="")]
    pub synonym: Option<Vec<SubstanceDefinitionNameBackboneElement>>,
    /// A translation for this name into another human language
    #[fhir(name="translation", min="0", max="*", summary=true, modifier=false, choice="")]
    pub translation: Option<Vec<SubstanceDefinitionNameBackboneElement>>,
    /// Details of the official nature of this name
    #[fhir(name="official", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionNameOfficialBackboneElement {
    ...
    #[fhir(name="authority", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionCharacterizationBackboneElement {
    ...
    #[fhir(name="technique", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="file", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionStructureBackboneElement {
    ...
    #[fhir(name="stereochemistry", min="0", max="1", summary=true, modifier=false, choice="")]
    pub stereochemistry: Option<CodeableConcept>,
    /// Optical activity type
    #[fhir(name="opticalActivity", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="molecularFormula", min="0", max="1", summary=true, modifier=false, choice="")]
    pub molecular_formula: Option<StringDt>,
    /// Specified per moiety according to the Hill system
    #[fhir(name="molecularFormulaByMoiety", min="0", max="1", summary=true, modifier=false, choice="")]
    pub molecular_formula_by_moiety: Option<StringDt>,
    /// The molecular weight or weight range
    #[fhir(name="molecularWeight", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="technique", min="0", max="*", summary=true, modifier=false, choice="")]
    pub technique: Option<Vec<CodeableConcept>>,
    /// Source of information for the structure
    #[fhir(name="sourceDocument", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionSourceMaterialBackboneElement {
    ...
    #[fhir(name="genus", min="0", max="1", summary=true, modifier=false, choice="")]
    pub genus: Option<CodeableConcept>,
    /// The species of an organism e.g. the Latin epithet of the species of the plant/animal
    #[fhir(name="species", min="0", max="1", summary=true, modifier=false, choice="")]
    pub species: Option<CodeableConcept>,
    /// An anatomical origin of the source material within an organism
    #[fhir(name="part", min="0", max="1", summary=true, modifier=false, choice="")]
    pub part: Option<CodeableConcept>,
    /// The country or countries where the material is harvested
    #[fhir(name="countryOfOrigin", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionRelationshipBackboneElement {
    ...
    #[fhir(name="substanceDefinition", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="ratioHighLimitAmount", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceDefinitionMoietyBackboneElement {
    ...
    #[fhir(name="measurementType", min="0", max="1", summary=true, modifier=false, choice="")]
