...
pub struct MedicationRequest {
    ...
    #[fhir(name="priorPrescription", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="statusChanged", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="medication", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="informationSource", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="authoredOn", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="reported", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="recorder", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="courseOfTherapyType", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="renderedDosageInstruction", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub rendered_dosage_instruction: Option<MarkdownDt>,
    /// Period over which the medication is to be taken
    #[fhir(name="effectiveDosePeriod", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub effective_dose_period: Option<Period>,
    /// Specific instructions for how the medication should be taken
    #[fhir(name="dosageInstruction", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub dosage_instruction: Option<Vec<Dosage>>,
    /// Medication supply authorization
    #[fhir(name="dispenseRequest", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub dispense_request: Option<MedicationRequestDispenseRequestBackboneElement>,
    /// Any restrictions on medication substitution
    #[fhir(name="substitution", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub substitution: Option<MedicationRequestSubstitutionBackboneElement>,
    /// A list of events of interest in the lifecycle
    #[fhir(name="eventHistory", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationRequestDispenseRequestBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// First fill details
    #[fhir(name="initialFill", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub initial_fill: Option<MedicationRequestDispenseRequestInitialFillBackboneElement>,
    /// Minimum period of time between dispenses
    #[fhir(name="dispenseInterval", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub dispense_interval: Option<Duration>,
    /// Time period supply is authorized for
    #[fhir(name="validityPeriod", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub validity_period: Option<Period>,
    /// Number of refills authorized
    #[fhir(name="numberOfRepeatsAllowed", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="expectedSupplyDuration", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub expected_supply_duration: Option<Duration>,
    /// Intended performer of dispense
    #[fhir(name="dispenser", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub dispenser: Option<Reference>,
    /// Additional information for the dispenser
    #[fhir(name="dispenserInstruction", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub dispenser_instruction: Option<Vec<Annotation>>,
    /// Type of adherence packaging to use for the dispense
    #[fhir(name="doseAdministrationAid", min="0", max="1", summary=false, modifier=false, choice=false)]
