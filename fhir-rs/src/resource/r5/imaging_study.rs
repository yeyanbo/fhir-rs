...
pub struct ImagingStudy {
    ...
    #[fhir(name="started", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// Referring physician
    #[fhir(name="referrer", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub referrer: Option<Reference>,
    /// Study access endpoint
    #[fhir(name="endpoint", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub endpoint: Option<Vec<Reference>>,
    /// Number of Study Related Series
    #[fhir(name="numberOfSeries", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub number_of_series: Option<UnsignedIntDt>,
    /// Number of Study Related Instances
    #[fhir(name="numberOfInstances", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="series", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ImagingStudySeriesBackboneElement {
    ...
    #[fhir(name="modality", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="laterality", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ImagingStudySeriesInstanceBackboneElement {
    ...
    #[fhir(name="uid", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub uid: Option<IdDt>,
    /// DICOM class type
    #[fhir(name="sopClass", min="1", max="1", summary=false, modifier=false, choice=false)]
