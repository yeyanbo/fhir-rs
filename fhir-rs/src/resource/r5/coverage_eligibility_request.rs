...
pub struct CoverageEligibilityRequestItemBackboneElement {
    ...
    #[fhir(name="supportingInfoSequence", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct CoverageEligibilityRequestItemDiagnosisBackboneElement {
    ...
    #[fhir(name="diagnosis", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CoverageEligibilityRequestInsuranceBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Applicable coverage
    #[fhir(name="focal", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct CoverageEligibilityRequestSupportingInfoBackboneElement {
    ...
    /// Data to be provided
    #[fhir(name="information", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub information: Option<Reference>,
    /// Applies to all items
    #[fhir(name="appliesToAll", min="0", max="1", summary=false, modifier=false, choice=false)]
