...
pub struct Ingredient {
    ...
    #[fhir(name="for", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub for_: Option<Vec<Reference>>,
    /// Purpose of the ingredient within the product, e.g. active, inactive
    #[fhir(name="role", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub role: Option<CodeableConcept>,
    /// Precise action within the drug product, e.g. antioxidant, alkalizing agent
    #[fhir(name="function", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="group", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub group: Option<CodeableConcept>,
    /// If the ingredient is a known or suspected allergen
    #[fhir(name="allergenicIndicator", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="substance", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct IngredientManufacturerBackboneElement {
    ...
    /// An organization that manufactures this ingredient
    #[fhir(name="manufacturer", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct IngredientSubstanceBackboneElement {
    ...
    #[fhir(name="strength", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct IngredientSubstanceStrengthBackboneElement {
    ...
    #[fhir(name="presentation", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="textPresentation", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub text_presentation: Option<StringDt>,
    /// The strength per unitary volume (or mass)
    #[fhir(name="concentration", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="textConcentration", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="measurementPoint", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub measurement_point: Option<StringDt>,
    /// Where the strength range applies
    #[fhir(name="country", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub country: Option<Vec<CodeableConcept>>,
    /// Strength expressed in terms of a reference substance
    #[fhir(name="referenceStrength", min="0", max="*", summary=true, modifier=false, choice=false)]
