...
pub struct NutritionProduct {
    ...
    #[fhir(name="nutrient", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub nutrient: Option<Vec<NutritionProductNutrientBackboneElement>>,
    /// Ingredients contained in this product
    #[fhir(name="ingredient", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="knownAllergen", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct NutritionProductIngredientBackboneElement {
    ...
    #[fhir(name="amount", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct NutritionProductInstanceBackboneElement {
    ...
    #[fhir(name="useBy", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct NutritionProductNutrientBackboneElement {
    ...
    #[fhir(name="amount", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub amount: Option<Vec<Ratio>>,
}
