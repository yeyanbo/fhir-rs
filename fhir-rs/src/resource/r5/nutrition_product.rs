...
pub struct NutritionProduct {
    ...
    #[fhir(name="nutrient", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="knownAllergen", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct NutritionProductIngredientBackboneElement {
    ...
    #[fhir(name="amount", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct NutritionProductInstanceBackboneElement {
    ...
    #[fhir(name="useBy", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct NutritionProductNutrientBackboneElement {
    ...
    #[fhir(name="amount", min="0", max="*", summary=false, modifier=false, choice="")]
    pub amount: Option<Vec<Ratio>>,
}
