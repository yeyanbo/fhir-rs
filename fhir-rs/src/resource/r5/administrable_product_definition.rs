...
pub struct AdministrableProductDefinition {
    ...
    #[fhir(name="formOf", min="0", max="*", summary=true, modifier=false, choice="")]
    pub form_of: Option<Vec<Reference>>,
    /// The dose form of the final product after necessary reconstitution or processing
    #[fhir(name="administrableDoseForm", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="unitOfPresentation", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="producedFrom", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="routeOfAdministration", min="1", max="*", summary=true, modifier=false, choice="")]
...
pub struct AdministrableProductDefinitionRouteOfAdministrationBackboneElement {
    ...
    #[fhir(name="firstDose", min="0", max="1", summary=true, modifier=false, choice="")]
    pub first_dose: Option<Quantity>,
    /// The maximum single dose that can be administered
    #[fhir(name="maxSingleDose", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_single_dose: Option<Quantity>,
    /// The maximum dose quantity to be administered in any one 24-h period
    #[fhir(name="maxDosePerDay", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_dose_per_day: Option<Quantity>,
    /// The maximum dose per treatment period that can be administered
    #[fhir(name="maxDosePerTreatmentPeriod", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_dose_per_treatment_period: Option<Ratio>,
    /// The maximum treatment period during which the product can be administered
    #[fhir(name="maxTreatmentPeriod", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_treatment_period: Option<Duration>,
    /// A species for which this route applies
    #[fhir(name="targetSpecies", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesBackboneElement {
    ...
    #[fhir(name="withdrawalPeriod", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesWithdrawalPeriodBackboneElement {
    ...
    #[fhir(name="tissue", min="1", max="1", summary=true, modifier=false, choice="")]
    pub tissue: Option<CodeableConcept>,
    /// A value for the time
    #[fhir(name="value", min="1", max="1", summary=true, modifier=false, choice="")]
    pub value: Option<Quantity>,
    /// Extra information about the withdrawal period
    #[fhir(name="supportingInformation", min="0", max="1", summary=true, modifier=false, choice="")]
