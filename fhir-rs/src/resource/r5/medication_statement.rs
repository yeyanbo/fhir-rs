...
pub struct MedicationStatement {
    ...
    #[fhir(name="relatedClinicalInformation", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="adherence", min="0", max="1", summary=true, modifier=false, choice=false)]
