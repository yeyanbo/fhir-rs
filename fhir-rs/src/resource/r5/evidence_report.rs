...
pub struct EvidenceReportSectionBackboneElement {
    ...
    #[fhir(name="focusReference", min="0", max="1", summary=false, modifier=false)]
    ...
    #[fhir(name="entryClassifier", min="0", max="*", summary=false, modifier=false)]
    pub entry_classifier: Option<Vec<CodeableConcept>>,
    /// Reference to resources as content
    #[fhir(name="entryReference", min="0", max="*", summary=false, modifier=false)]
    pub entry_reference: Option<Vec<Reference>>,
    /// Quantity as content
    #[fhir(name="entryQuantity", min="0", max="*", summary=false, modifier=false)]
