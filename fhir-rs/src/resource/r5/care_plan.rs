...
pub struct CarePlan {
    ...
    #[fhir(name="created", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="contributor", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="addresses", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="activity", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct CarePlanActivityBackboneElement {
    ...
    #[fhir(name="performedActivity", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="plannedActivityReference", min="0", max="1", summary=false, modifier=false, choice=false)]
