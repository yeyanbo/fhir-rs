...
pub struct MolecularSequence {
    ...
    #[fhir(name="focus", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub focus: Option<Vec<Reference>>,
    /// Specimen used for sequencing
    #[fhir(name="specimen", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub specimen: Option<Reference>,
    /// The method for sequencing
    #[fhir(name="device", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub device: Option<Reference>,
    /// Who should be responsible for test result
    #[fhir(name="performer", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub performer: Option<Reference>,
    /// Sequence that was observed
    #[fhir(name="literal", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub literal: Option<StringDt>,
    /// Embedded file or a link (URL) which contains content to represent the sequence
    #[fhir(name="formatted", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub formatted: Option<Vec<Attachment>>,
    /// A sequence defined relative to another sequence
    #[fhir(name="relative", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct MolecularSequenceRelativeBackboneElement {
    ...
    #[fhir(name="coordinateSystem", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="ordinalPosition", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="sequenceRange", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sequence_range: Option<Range>,
    /// A sequence used as starting sequence
    #[fhir(name="startingSequence", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub starting_sequence: Option<MolecularSequenceRelativeStartingSequenceBackboneElement>,
    /// Changes in sequence from the starting sequence
    #[fhir(name="edit", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct MolecularSequenceRelativeEditBackboneElement {
    ...
    #[fhir(name="replacementSequence", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub replacement_sequence: Option<StringDt>,
    /// Allele in the starting sequence
    #[fhir(name="replacedSequence", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MolecularSequenceRelativeStartingSequenceBackboneElement {
    ...
    #[fhir(name="genomeAssembly", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub genome_assembly: Option<CodeableConcept>,
    /// Chromosome Identifier
    #[fhir(name="chromosome", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="windowStart", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub window_start: Option<IntegerDt>,
    /// End position of the window on the starting sequence
    #[fhir(name="windowEnd", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// watson | crick
    #[fhir(name="strand", min="0", max="1", summary=true, modifier=false, choice=false)]
