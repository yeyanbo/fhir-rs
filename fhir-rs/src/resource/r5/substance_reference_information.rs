...
pub struct SubstanceReferenceInformation {
    ...
    /// Todo
    #[fhir(name="gene", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub gene: Option<Vec<SubstanceReferenceInformationGeneBackboneElement>>,
    /// Todo
    #[fhir(name="geneElement", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubstanceReferenceInformationGeneBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Todo
    #[fhir(name="geneSequenceOrigin", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub gene_sequence_origin: Option<CodeableConcept>,
    /// Todo
    #[fhir(name="gene", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct SubstanceReferenceInformationTargetBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Todo
    #[fhir(name="target", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// Todo
    #[fhir(name="organismType", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    /// Todo
    #[fhir(name="amountType", min="0", max="1", summary=true, modifier=false, choice=false)]
