...
pub struct Condition {
    ...
    #[fhir(name="severity", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="onset", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub onset: Option<StringDt>,
    /// When in resolution/remission
    #[fhir(name="abatement", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="stage", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ConditionStageBackboneElement {
    ...
    #[fhir(name="assessment", min="0", max="*", summary=false, modifier=false, choice=false)]
