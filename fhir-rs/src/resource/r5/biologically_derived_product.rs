...
pub struct BiologicallyDerivedProduct {
    ...
    #[fhir(name="productCategory", min="0", max="1", summary=false, modifier=false, choice="")]
    pub product_category: Option<Coding>,
    /// A code that identifies the kind of this biologically derived product
    #[fhir(name="productCode", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="biologicalSourceEvent", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="processingFacility", min="0", max="*", summary=false, modifier=false, choice="")]
    pub processing_facility: Option<Vec<Reference>>,
    /// A unique identifier for an aliquot of a product
    #[fhir(name="division", min="0", max="1", summary=false, modifier=false, choice="")]
    pub division: Option<StringDt>,
    /// available | unavailable
    #[fhir(name="productStatus", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="storageTempRequirements", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct BiologicallyDerivedProductCollectionBackboneElement {
    ...
    #[fhir(name="collector", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="collected", min="0", max="1", summary=false, modifier=false, choice="")]
