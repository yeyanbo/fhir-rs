...
pub struct ValueSet {
    ...
    #[fhir(name="immutable", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="compose", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub compose: Option<ValueSetComposeBackboneElement>,
    /// Used when the value set is "expanded"
    #[fhir(name="expansion", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetScopeBackboneElement {
    ...
    #[fhir(name="inclusionCriteria", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub inclusion_criteria: Option<StringDt>,
    /// Criteria describing which concepts or codes should be excluded and why
    #[fhir(name="exclusionCriteria", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetExpansionBackboneElement {
    ...
    #[fhir(name="next", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub next: Option<UriDt>,
    /// Time ValueSet expansion happened
    #[fhir(name="timestamp", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="contains", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetExpansionContainsBackboneElement {
    ...
    #[fhir(name="system", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub system: Option<UriDt>,
    /// If user cannot select this entry
    #[fhir(name="abstract", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub abstract_: Option<BooleanDt>,
    /// If concept is inactive in the code system
    #[fhir(name="inactive", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetExpansionContainsPropertyBackboneElement {
    ...
    #[fhir(name="subProperty", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetExpansionPropertyBackboneElement {
    ...
    #[fhir(name="uri", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetComposeBackboneElement {
    ...
    #[fhir(name="lockedDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub locked_date: Option<DateDt>,
    /// Whether inactive codes are in the value set
    #[fhir(name="inactive", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub inactive: Option<BooleanDt>,
    /// Include one or more codes from a code system or other value set(s)
    #[fhir(name="include", min="1", max="*", summary=true, modifier=false, choice=false)]
    pub include: Option<Vec<ValueSetComposeIncludeBackboneElement>>,
    /// Explicitly exclude codes from a code system or other value sets
    #[fhir(name="exclude", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ValueSetComposeIncludeBackboneElement {
    ...
    #[fhir(name="valueSet", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ValueSetComposeIncludeFilterBackboneElement {
    ...
    #[fhir(name="property", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub property: Option<CodeDt>,
    /// = | is-a | descendent-of | is-not-a | regex | in | not-in | generalizes | child-of | descendent-leaf | exists
    #[fhir(name="op", min="1", max="1", summary=true, modifier=false, choice=false)]
