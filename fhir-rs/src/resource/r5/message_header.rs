...
pub struct MessageHeader {
    ...
    #[fhir(name="destination", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub destination: Option<Vec<MessageHeaderDestinationBackboneElement>>,
    /// Real world sender of the message
    #[fhir(name="sender", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="responsible", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MessageHeaderResponseBackboneElement {
    ...
    #[fhir(name="identifier", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MessageHeaderSourceBackboneElement {
    ...
    #[fhir(name="contact", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct MessageHeaderDestinationBackboneElement {
    ...
    #[fhir(name="receiver", min="0", max="1", summary=true, modifier=false, choice=false)]
