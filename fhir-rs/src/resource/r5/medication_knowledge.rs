...
pub struct MedicationKnowledge {
    ...
    #[fhir(name="intendedJurisdiction", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="relatedMedicationKnowledge", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="associatedMedication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub associated_medication: Option<Vec<Reference>>,
    /// Category of the medication or product
    #[fhir(name="productType", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub product_type: Option<Vec<CodeableConcept>>,
    /// Associated documentation about the medication
    #[fhir(name="monograph", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub monograph: Option<Vec<MedicationKnowledgeMonographBackboneElement>>,
    /// The instructions for preparing the medication
    #[fhir(name="preparationInstruction", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub preparation_instruction: Option<MarkdownDt>,
    /// The pricing of the medication
    #[fhir(name="cost", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub cost: Option<Vec<MedicationKnowledgeCostBackboneElement>>,
    /// Program under which a medication is reviewed
    #[fhir(name="monitoringProgram", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="indicationGuideline", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub indication_guideline: Option<Vec<MedicationKnowledgeIndicationGuidelineBackboneElement>>,
    /// Categorization of the medication within a formulary or classification system
    #[fhir(name="medicineClassification", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="clinicalUseIssue", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub clinical_use_issue: Option<Vec<Reference>>,
    /// How the medication should be stored
    #[fhir(name="storageGuideline", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub storage_guideline: Option<Vec<MedicationKnowledgeStorageGuidelineBackboneElement>>,
    /// Regulatory information about a medication
    #[fhir(name="regulatory", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="definitional", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeIndicationGuidelineBackboneElement {
    ...
    #[fhir(name="dosingGuideline", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeIndicationGuidelineDosingGuidelineBackboneElement {
    ...
    #[fhir(name="treatmentIntent", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub treatment_intent: Option<CodeableConcept>,
    /// Dosage for the medication for the specific guidelines
    #[fhir(name="dosage", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="administrationTreatment", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub administration_treatment: Option<CodeableConcept>,
    /// Characteristics of the patient that are relevant to the administration guidelines
    #[fhir(name="patientCharacteristic", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeIndicationGuidelineDosingGuidelineDosageBackboneElement {
    ...
    pub type_: Option<CodeableConcept>,
    /// Dosage for the medication for the specific guidelines
    #[fhir(name="dosage", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeRegulatoryBackboneElement {
    ...
    #[fhir(name="regulatoryAuthority", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub regulatory_authority: Option<Reference>,
    /// Specifies if changes are allowed when dispensing a medication from a regulatory perspective
    #[fhir(name="substitution", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub substitution: Option<Vec<MedicationKnowledgeRegulatorySubstitutionBackboneElement>>,
    /// Specifies the schedule of a medication in jurisdiction
    #[fhir(name="schedule", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub schedule: Option<Vec<CodeableConcept>>,
    /// The maximum number of units of the medication that can be dispensed in a period
    #[fhir(name="maxDispense", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeRegulatoryMaxDispenseBackboneElement {
    ...
    #[fhir(name="quantity", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeRegulatorySubstitutionBackboneElement {
    ...
    #[fhir(name="allowed", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeStorageGuidelineBackboneElement {
    ...
    #[fhir(name="stabilityDuration", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub stability_duration: Option<Duration>,
    /// Setting or value of environment for adequate storage
    #[fhir(name="environmentalSetting", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeDefinitionalBackboneElement {
    ...
    #[fhir(name="definition", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub definition: Option<Vec<Reference>>,
    /// powder | tablets | capsule +
    #[fhir(name="doseForm", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub dose_form: Option<CodeableConcept>,
    /// The intended or approved route of administration
    #[fhir(name="intendedRoute", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="drugCharacteristic", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeDefinitionalIngredientBackboneElement {
    ...
    #[fhir(name="item", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub item: Option<CodeableReference>,
    /// A code that defines the type of ingredient, active, base, etc
    #[fhir(name="type", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub type_: Option<CodeableConcept>,
    /// Quantity of ingredient present
    #[fhir(name="strength", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgePackagingBackboneElement {
    ...
    #[fhir(name="packagedProduct", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationKnowledgeCostBackboneElement {
    ...
    #[fhir(name="effectiveDate", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="cost", min="1", max="1", summary=false, modifier=false, choice=false)]
