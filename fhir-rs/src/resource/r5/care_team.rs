...
pub struct CareTeam {
    ...
    #[fhir(name="managingOrganization", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct CareTeamParticipantBackboneElement {
    ...
    /// Who is involved
    #[fhir(name="member", min="0", max="1", summary=true, modifier=false, choice=false)]
