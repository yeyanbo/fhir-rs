...
pub struct AllergyIntolerance {
    ...
    #[fhir(name="criticality", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="recordedDate", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="lastOccurrence", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct AllergyIntoleranceReactionBackboneElement {
    ...
    #[fhir(name="substance", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub substance: Option<CodeableConcept>,
    /// Clinical symptoms/signs associated with the Event
    #[fhir(name="manifestation", min="1", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="exposureRoute", min="0", max="1", summary=false, modifier=false, choice=false)]
