...
pub struct SubstanceSourceMaterial {
    ...
    #[fhir(name="sourceMaterialClass", min="0", max="1", summary=true, modifier=false, choice="")]
    pub source_material_class: Option<CodeableConcept>,
    /// The type of the source material shall be specified based on a controlled vocabulary. For vaccines, this subclause refers to the class of infectious agent
    #[fhir(name="sourceMaterialType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub source_material_type: Option<CodeableConcept>,
    /// The state of the source material when extracted
    #[fhir(name="sourceMaterialState", min="0", max="1", summary=true, modifier=false, choice="")]
    pub source_material_state: Option<CodeableConcept>,
    /// The unique identifier associated with the source material parent organism shall be specified
    #[fhir(name="organismId", min="0", max="1", summary=true, modifier=false, choice="")]
    pub organism_id: Option<Identifier>,
    /// The organism accepted Scientific name shall be provided based on the organism taxonomy
    #[fhir(name="organismName", min="0", max="1", summary=true, modifier=false, choice="")]
    pub organism_name: Option<StringDt>,
    /// The parent of the herbal drug Ginkgo biloba, Leaf is the substance ID of the substance (fresh) of Ginkgo biloba L. or Ginkgo biloba L. (Whole plant)
    #[fhir(name="parentSubstanceId", min="0", max="*", summary=true, modifier=false, choice="")]
    pub parent_substance_id: Option<Vec<Identifier>>,
    /// The parent substance of the Herbal Drug, or Herbal preparation
    #[fhir(name="parentSubstanceName", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="geographicalLocation", min="0", max="*", summary=true, modifier=false, choice="")]
    pub geographical_location: Option<Vec<StringDt>>,
    /// Stage of life for animals, plants, insects and microorganisms. This information shall be provided only when the substance is significantly different in these stages (e.g. foetal bovine serum)
    #[fhir(name="developmentStage", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="fractionDescription", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    /// To do
    #[fhir(name="partDescription", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialPartDescriptionBackboneElement {
    ...
    #[fhir(name="partLocation", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialFractionDescriptionBackboneElement {
    ...
    #[fhir(name="fraction", min="0", max="1", summary=true, modifier=false, choice="")]
    pub fraction: Option<StringDt>,
    /// The specific type of the material constituting the component. For Herbal preparations the particulars of the extracts (liquid/dry) is described in Specified Substance Group 1
    #[fhir(name="materialType", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialOrganismBackboneElement {
    ...
    #[fhir(name="intraspecificType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub intraspecific_type: Option<CodeableConcept>,
    /// The intraspecific description of an organism shall be specified based on a controlled vocabulary. For Influenza Vaccine, the intraspecific description shall contain the syntax of the antigen in line with the WHO convention
    #[fhir(name="intraspecificDescription", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="hybrid", min="0", max="1", summary=true, modifier=false, choice="")]
    pub hybrid: Option<SubstanceSourceMaterialOrganismHybridBackboneElement>,
    /// 4.9.13.7.1 Kingdom (Conditional)
    #[fhir(name="organismGeneral", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialOrganismHybridBackboneElement {
    ...
    #[fhir(name="maternalOrganismId", min="0", max="1", summary=true, modifier=false, choice="")]
    pub maternal_organism_id: Option<StringDt>,
    /// The name of the maternal species constituting the hybrid organism shall be specified. For plants, the parents aren’t always known, and it is unlikely that it will be known which is maternal and which is paternal
    #[fhir(name="maternalOrganismName", min="0", max="1", summary=true, modifier=false, choice="")]
    pub maternal_organism_name: Option<StringDt>,
    /// The identifier of the paternal species constituting the hybrid organism shall be specified based on a controlled vocabulary
    #[fhir(name="paternalOrganismId", min="0", max="1", summary=true, modifier=false, choice="")]
    pub paternal_organism_id: Option<StringDt>,
    /// The name of the paternal species constituting the hybrid organism shall be specified
    #[fhir(name="paternalOrganismName", min="0", max="1", summary=true, modifier=false, choice="")]
    pub paternal_organism_name: Option<StringDt>,
    /// The hybrid type of an organism shall be specified
    #[fhir(name="hybridType", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialOrganismAuthorBackboneElement {
    ...
    #[fhir(name="authorType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub author_type: Option<CodeableConcept>,
    /// The author of an organism species shall be specified. The author year of an organism shall also be specified when applicable; refers to the year in which the first author(s) published the infraspecific plant/animal name (of any rank)
    #[fhir(name="authorDescription", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SubstanceSourceMaterialOrganismOrganismGeneralBackboneElement {
    ...
    #[fhir(name="kingdom", min="0", max="1", summary=true, modifier=false, choice="")]
    pub kingdom: Option<CodeableConcept>,
    /// The phylum of an organism shall be specified
    #[fhir(name="phylum", min="0", max="1", summary=true, modifier=false, choice="")]
