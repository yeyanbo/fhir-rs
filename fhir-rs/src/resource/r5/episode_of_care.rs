...
pub struct EpisodeOfCare {
    ...
    #[fhir(name="statusHistory", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="referralRequest", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub referral_request: Option<Vec<Reference>>,
    /// Care manager/care coordinator for the patient
    #[fhir(name="careManager", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EpisodeOfCareDiagnosisBackboneElement {
    ...
    #[fhir(name="use", min="0", max="1", summary=true, modifier=false, choice=false)]
