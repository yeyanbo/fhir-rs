...
pub struct SubstanceProtein {
    ...
    #[fhir(name="disulfideLinkage", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct SubstanceProteinSubunitBackboneElement {
    ...
    #[fhir(name="nTerminalModificationId", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub n_terminal_modification_id: Option<Identifier>,
    /// The name of the fragment modified at the N-terminal of the SubstanceProtein shall be specified
    #[fhir(name="nTerminalModification", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub n_terminal_modification: Option<StringDt>,
    /// Unique identifier for molecular fragment modification based on the ISO 11238 Substance ID
    #[fhir(name="cTerminalModificationId", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub c_terminal_modification_id: Option<Identifier>,
    /// The modification at the C-terminal shall be specified
    #[fhir(name="cTerminalModification", min="0", max="1", summary=true, modifier=false, choice=false)]
