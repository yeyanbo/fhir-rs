...
pub struct SubscriptionStatus {
    ...
    #[fhir(name="eventsSinceSubscriptionStart", min="0", max="1", summary=true, modifier=false, choice="")]
    pub events_since_subscription_start: Option<Integer64Dt>,
    /// Detailed information about any events relevant to this notification
    #[fhir(name="notificationEvent", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="subscription", min="1", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="error", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct SubscriptionStatusNotificationEventBackboneElement {
    ...
    #[fhir(name="eventNumber", min="1", max="1", summary=false, modifier=false, choice="")]
    pub event_number: Option<Integer64Dt>,
    /// The instant this event occurred
    #[fhir(name="timestamp", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="additionalContext", min="0", max="*", summary=false, modifier=false, choice="")]
