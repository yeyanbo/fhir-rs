...
pub struct DocumentReference {
    ...
    #[fhir(name="docStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub doc_status: Option<CodeDt>,
    /// Imaging modality used
    #[fhir(name="modality", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="facilityType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub facility_type: Option<CodeableConcept>,
    /// Additional details about where the content was created (e.g. clinical specialty)
    #[fhir(name="practiceSetting", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="attester", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub attester: Option<Vec<DocumentReferenceAttesterBackboneElement>>,
    /// Organization which maintains the document
    #[fhir(name="custodian", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub custodian: Option<Reference>,
    /// Relationships to other documents
    #[fhir(name="relatesTo", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    /// Document referenced
    #[fhir(name="content", min="1", max="*", summary=true, modifier=false, choice=false)]
...
pub struct DocumentReferenceRelatesToBackboneElement {
    ...
    #[fhir(name="target", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct DocumentReferenceAttesterBackboneElement {
    ...
    #[fhir(name="mode", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DocumentReferenceContentBackboneElement {
    ...
    #[fhir(name="attachment", min="1", max="1", summary=true, modifier=false, choice=false)]
