...
pub struct DeviceDefinition {
    ...
    #[fhir(name="udiDeviceIdentifier", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="regulatoryIdentifier", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub regulatory_identifier: Option<Vec<DeviceDefinitionRegulatoryIdentifierBackboneElement>>,
    /// The part number or catalog number of the device
    #[fhir(name="partNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub part_number: Option<StringDt>,
    /// Name of device manufacturer
    #[fhir(name="manufacturer", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub manufacturer: Option<Reference>,
    /// The name or names of the device as given by the manufacturer
    #[fhir(name="deviceName", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="modelNumber", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub model_number: Option<StringDt>,
    /// What kind of device or device system this is
    #[fhir(name="classification", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub classification: Option<Vec<DeviceDefinitionClassificationBackboneElement>>,
    /// Identifies the standards, specifications, or formal guidances for the capabilities supported by the device
    #[fhir(name="conformsTo", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub conforms_to: Option<Vec<DeviceDefinitionConformsToBackboneElement>>,
    /// A device, part of the current one
    #[fhir(name="hasPart", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub has_part: Option<Vec<DeviceDefinitionHasPartBackboneElement>>,
    /// Information about the packaging of the device, i.e. how the device is packaged
    #[fhir(name="packaging", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub packaging: Option<Vec<DeviceDefinitionPackagingBackboneElement>>,
    /// The version of the device or software
    #[fhir(name="version", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub version: Option<Vec<DeviceDefinitionVersionBackboneElement>>,
    /// Safety characteristics of the device
    #[fhir(name="safety", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub safety: Option<Vec<CodeableConcept>>,
    /// Shelf Life and storage information
    #[fhir(name="shelfLifeStorage", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub shelf_life_storage: Option<Vec<ProductShelfLife>>,
    /// Language code for the human-readable text strings produced by the device (all supported)
    #[fhir(name="languageCode", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="owner", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub owner: Option<Reference>,
    /// Details for human/organization for support
    #[fhir(name="contact", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="material", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="productionIdentifierInUDI", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub production_identifier_in_udi: Option<Vec<CodeDt>>,
    /// Information aimed at providing directions for the usage of this model of device
    #[fhir(name="guideline", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub guideline: Option<DeviceDefinitionGuidelineBackboneElement>,
    /// Tracking of latest field safety corrective action
    #[fhir(name="correctiveAction", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub corrective_action: Option<DeviceDefinitionCorrectiveActionBackboneElement>,
    /// Billing code or reference associated with the device
    #[fhir(name="chargeItem", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionUdiDeviceIdentifierBackboneElement {
    ...
    #[fhir(name="deviceIdentifier", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub device_identifier: Option<StringDt>,
    /// The organization that assigns the identifier algorithm
    #[fhir(name="issuer", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub issuer: Option<UriDt>,
    /// The jurisdiction to which the deviceIdentifier applies
    #[fhir(name="jurisdiction", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub jurisdiction: Option<UriDt>,
    /// Indicates whether and when the device is available on the market
    #[fhir(name="marketDistribution", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionUdiDeviceIdentifierMarketDistributionBackboneElement {
    ...
    #[fhir(name="marketPeriod", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub market_period: Option<Period>,
    /// National state or territory where the device is commercialized
    #[fhir(name="subJurisdiction", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionClassificationBackboneElement {
    ...
    #[fhir(name="justification", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionHasPartBackboneElement {
    ...
    #[fhir(name="reference", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub reference: Option<Reference>,
    /// Number of occurrences of the part
    #[fhir(name="count", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionChargeItemBackboneElement {
    ...
    #[fhir(name="chargeItemCode", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub charge_item_code: Option<CodeableReference>,
    /// Coefficient applicable to the billing code
    #[fhir(name="count", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub count: Option<Quantity>,
    /// A specific time period in which this charge item applies
    #[fhir(name="effectivePeriod", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionConformsToBackboneElement {
    ...
    #[fhir(name="source", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionPackagingBackboneElement {
    ...
    #[fhir(name="distributor", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionPackagingDistributorBackboneElement {
    ...
    #[fhir(name="organizationReference", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionLinkBackboneElement {
    ...
    #[fhir(name="relation", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub relation: Option<Coding>,
    /// A reference to the linked device
    #[fhir(name="relatedDevice", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionMaterialBackboneElement {
    ...
    #[fhir(name="substance", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub substance: Option<CodeableConcept>,
    /// Indicates an alternative material of the device
    #[fhir(name="alternate", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub alternate: Option<BooleanDt>,
    /// Whether the substance is a known or suspected allergen
    #[fhir(name="allergenicIndicator", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionVersionBackboneElement {
    ...
    #[fhir(name="component", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionGuidelineBackboneElement {
    ...
    #[fhir(name="usageInstruction", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="indication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub indication: Option<Vec<CodeableConcept>>,
    /// A specific situation when a device should not be used because it may cause harm
    #[fhir(name="contraindication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub contraindication: Option<Vec<CodeableConcept>>,
    /// Specific hazard alert information that a user needs to know before using the device
    #[fhir(name="warning", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub warning: Option<Vec<CodeableConcept>>,
    /// A description of the general purpose or medical use of the device or its function
    #[fhir(name="intendedUse", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct DeviceDefinitionCorrectiveActionBackboneElement {
    ...
    #[fhir(name="recall", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="period", min="1", max="1", summary=false, modifier=false, choice=false)]
