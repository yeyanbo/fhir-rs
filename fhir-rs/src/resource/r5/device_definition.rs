...
pub struct DeviceDefinition {
    ...
    #[fhir(name="udiDeviceIdentifier", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="regulatoryIdentifier", min="0", max="*", summary=false, modifier=false, choice="")]
    pub regulatory_identifier: Option<Vec<DeviceDefinitionRegulatoryIdentifierBackboneElement>>,
    /// The part number or catalog number of the device
    #[fhir(name="partNumber", min="0", max="1", summary=false, modifier=false, choice="")]
    pub part_number: Option<StringDt>,
    /// Name of device manufacturer
    #[fhir(name="manufacturer", min="0", max="1", summary=true, modifier=false, choice="")]
    pub manufacturer: Option<Reference>,
    /// The name or names of the device as given by the manufacturer
    #[fhir(name="deviceName", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="modelNumber", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="conformsTo", min="0", max="*", summary=true, modifier=false, choice="")]
    pub conforms_to: Option<Vec<DeviceDefinitionConformsToBackboneElement>>,
    /// A device, part of the current one
    #[fhir(name="hasPart", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="safety", min="0", max="*", summary=true, modifier=false, choice="")]
    pub safety: Option<Vec<CodeableConcept>>,
    /// Shelf Life and storage information
    #[fhir(name="shelfLifeStorage", min="0", max="*", summary=false, modifier=false, choice="")]
    pub shelf_life_storage: Option<Vec<ProductShelfLife>>,
    /// Language code for the human-readable text strings produced by the device (all supported)
    #[fhir(name="languageCode", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="owner", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="material", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="productionIdentifierInUDI", min="0", max="*", summary=false, modifier=false, choice="")]
    pub production_identifier_in_udi: Option<Vec<CodeDt>>,
    /// Information aimed at providing directions for the usage of this model of device
    #[fhir(name="guideline", min="0", max="1", summary=false, modifier=false, choice="")]
    pub guideline: Option<DeviceDefinitionGuidelineBackboneElement>,
    /// Tracking of latest field safety corrective action
    #[fhir(name="correctiveAction", min="0", max="1", summary=false, modifier=false, choice="")]
    pub corrective_action: Option<DeviceDefinitionCorrectiveActionBackboneElement>,
    /// Billing code or reference associated with the device
    #[fhir(name="chargeItem", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionUdiDeviceIdentifierBackboneElement {
    ...
    #[fhir(name="deviceIdentifier", min="1", max="1", summary=false, modifier=false, choice="")]
    pub device_identifier: Option<StringDt>,
    /// The organization that assigns the identifier algorithm
    #[fhir(name="issuer", min="1", max="1", summary=false, modifier=false, choice="")]
    pub issuer: Option<UriDt>,
    /// The jurisdiction to which the deviceIdentifier applies
    #[fhir(name="jurisdiction", min="1", max="1", summary=false, modifier=false, choice="")]
    pub jurisdiction: Option<UriDt>,
    /// Indicates whether and when the device is available on the market
    #[fhir(name="marketDistribution", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionUdiDeviceIdentifierMarketDistributionBackboneElement {
    ...
    #[fhir(name="marketPeriod", min="1", max="1", summary=false, modifier=false, choice="")]
    pub market_period: Option<Period>,
    /// National state or territory where the device is commercialized
    #[fhir(name="subJurisdiction", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionClassificationBackboneElement {
    ...
    #[fhir(name="justification", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionChargeItemBackboneElement {
    ...
    #[fhir(name="chargeItemCode", min="1", max="1", summary=false, modifier=false, choice="")]
    pub charge_item_code: Option<CodeableReference>,
    /// Coefficient applicable to the billing code
    #[fhir(name="count", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionConformsToBackboneElement {
    ...
    #[fhir(name="specification", min="1", max="1", summary=true, modifier=false, choice="")]
    pub specification: Option<CodeableConcept>,
    /// The specific form or variant of the standard, specification or formal guidance
    #[fhir(name="version", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct DeviceDefinitionPackagingBackboneElement {
    ...
    #[fhir(name="distributor", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionPackagingDistributorBackboneElement {
    ...
    #[fhir(name="organizationReference", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionLinkBackboneElement {
    ...
    #[fhir(name="relation", min="1", max="1", summary=false, modifier=false, choice="")]
    pub relation: Option<Coding>,
    /// A reference to the linked device
    #[fhir(name="relatedDevice", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionMaterialBackboneElement {
    ...
    #[fhir(name="substance", min="1", max="1", summary=false, modifier=false, choice="")]
    pub substance: Option<CodeableConcept>,
    /// Indicates an alternative material of the device
    #[fhir(name="alternate", min="0", max="1", summary=false, modifier=false, choice="")]
    pub alternate: Option<BooleanDt>,
    /// Whether the substance is a known or suspected allergen
    #[fhir(name="allergenicIndicator", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionVersionBackboneElement {
    ...
    #[fhir(name="component", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionGuidelineBackboneElement {
    ...
    #[fhir(name="usageInstruction", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="contraindication", min="0", max="*", summary=false, modifier=false, choice="")]
    pub contraindication: Option<Vec<CodeableConcept>>,
    /// Specific hazard alert information that a user needs to know before using the device
    #[fhir(name="warning", min="0", max="*", summary=false, modifier=false, choice="")]
    pub warning: Option<Vec<CodeableConcept>>,
    /// A description of the general purpose or medical use of the device or its function
    #[fhir(name="intendedUse", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct DeviceDefinitionCorrectiveActionBackboneElement {
    ...
    #[fhir(name="recall", min="1", max="1", summary=false, modifier=false, choice="")]
