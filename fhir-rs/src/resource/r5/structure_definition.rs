...
pub struct StructureDefinition {
    ...
    #[fhir(name="fhirVersion", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub fhir_version: Option<CodeDt>,
    /// External specification that the content is mapped to
    #[fhir(name="mapping", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="abstract", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub abstract_: Option<BooleanDt>,
    /// If an extension, where it can be used in instances
    #[fhir(name="context", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub context: Option<Vec<StructureDefinitionContextBackboneElement>>,
    /// FHIRPath invariants - when the extension can be used
    #[fhir(name="contextInvariant", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="baseDefinition", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub base_definition: Option<CanonicalDt>,
    /// specialization | constraint - How relates to base definition
    #[fhir(name="derivation", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub derivation: Option<CodeDt>,
    /// Snapshot view of the structure
    #[fhir(name="snapshot", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub snapshot: Option<StructureDefinitionSnapshotBackboneElement>,
    /// Differential view of the structure
    #[fhir(name="differential", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct StructureDefinitionSnapshotBackboneElement {
    ...
    #[fhir(name="element", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct StructureDefinitionContextBackboneElement {
    ...
    #[fhir(name="expression", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct StructureDefinitionMappingBackboneElement {
    ...
    #[fhir(name="identity", min="1", max="1", summary=false, modifier=false, choice=false)]
