...
pub struct Group {
    ...
    #[fhir(name="membership", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="member", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct GroupMemberBackboneElement {
    ...
    #[fhir(name="entity", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct GroupCharacteristicBackboneElement {
    ...
    #[fhir(name="exclude", min="1", max="1", summary=true, modifier=false, choice=false)]
