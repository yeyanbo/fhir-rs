...
pub struct GuidanceResponse {
    ...
    #[fhir(name="requestIdentifier", min="0", max="1", summary=true, modifier=false, choice="")]
    pub request_identifier: Option<Identifier>,
    /// Business identifier
    #[fhir(name="identifier", min="0", max="*", summary=true, modifier=false, choice="")]
    pub identifier: Option<Vec<Identifier>>,
    /// What guidance was requested
    #[fhir(name="module", min="1", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="occurrenceDateTime", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="evaluationMessage", min="0", max="1", summary=false, modifier=false, choice="")]
    pub evaluation_message: Option<Reference>,
    /// The output parameters of the evaluation, if any
    #[fhir(name="outputParameters", min="0", max="1", summary=false, modifier=false, choice="")]
