...
pub struct GuidanceResponse {
    ...
    #[fhir(name="requestIdentifier", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="module", min="1", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="occurrenceDateTime", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="evaluationMessage", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub evaluation_message: Option<Reference>,
    /// The output parameters of the evaluation, if any
    #[fhir(name="outputParameters", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="dataRequirement", min="0", max="*", summary=false, modifier=false, choice=false)]
