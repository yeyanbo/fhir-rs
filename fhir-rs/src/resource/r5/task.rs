...
pub struct Task {
    ...
    #[fhir(name="businessStatus", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="requestedPeriod", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub requested_period: Option<Period>,
    /// Start and end time of execution
    #[fhir(name="executionPeriod", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="requestedPerformer", min="0", max="*", summary=false, modifier=false, choice=false)]
