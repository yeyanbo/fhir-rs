...
pub struct PractitionerRole {
    ...
    #[fhir(name="active", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="practitioner", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="healthcareService", min="0", max="*", summary=false, modifier=false, choice=false)]
