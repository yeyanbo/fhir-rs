...
pub struct Binary {
    ...
    #[fhir(name="contentType", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub content_type: Option<CodeDt>,
    /// Identifies another resource to use as proxy when enforcing access control
    #[fhir(name="securityContext", min="0", max="1", summary=true, modifier=false, choice=false)]
