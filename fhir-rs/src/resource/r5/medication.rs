...
pub struct Medication {
    ...
    #[fhir(name="marketingAuthorizationHolder", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="totalVolume", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="batch", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct MedicationIngredientBackboneElement {
    ...
    #[fhir(name="item", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub item: Option<CodeableReference>,
    /// Active ingredient indicator
    #[fhir(name="isActive", min="0", max="1", summary=false, modifier=false, choice=false)]
