...
pub struct Encounter {
    ...
    #[fhir(name="episodeOfCare", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="partOf", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub part_of: Option<Reference>,
    /// The organization (facility) responsible for this encounter
    #[fhir(name="serviceProvider", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="appointment", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="dietPreference", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub diet_preference: Option<Vec<CodeableConcept>>,
    /// Wheelchair, translator, stretcher, etc
    #[fhir(name="specialArrangement", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub special_arrangement: Option<Vec<CodeableConcept>>,
    /// Special courtesies (VIP, board member)
    #[fhir(name="specialCourtesy", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub special_courtesy: Option<Vec<CodeableConcept>>,
    /// Details about the admission to a healthcare service
    #[fhir(name="admission", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EncounterLocationBackboneElement {
    ...
    #[fhir(name="status", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub status: Option<CodeDt>,
...
pub struct EncounterAdmissionBackboneElement {
    ...
    #[fhir(name="preAdmissionIdentifier", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="admitSource", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub admit_source: Option<CodeableConcept>,
    /// Indicates that the patient is being re-admitted
    #[fhir(name="reAdmission", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="dischargeDisposition", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EncounterDiagnosisBackboneElement {
    ...
    #[fhir(name="use", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EncounterReasonBackboneElement {
    ...
    #[fhir(name="use", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub use_: Option<Vec<CodeableConcept>>,
    /// Reason the encounter takes place (core or reference)
    #[fhir(name="value", min="0", max="*", summary=true, modifier=false, choice=false)]
