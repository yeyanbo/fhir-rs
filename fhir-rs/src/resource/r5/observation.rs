...
pub struct Observation {
    ...
    #[fhir(name="instantiates", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub instantiates: Option<Reference>,
    /// Fulfills plan, proposal or order
    #[fhir(name="basedOn", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub based_on: Option<Vec<Reference>>,
    /// Triggering observation(s)
    #[fhir(name="triggeredBy", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="dataAbsentReason", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub data_absent_reason: Option<CodeableConcept>,
    /// High, low, normal, etc
    #[fhir(name="interpretation", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="bodyStructure", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub body_structure: Option<Reference>,
    /// How it was done
    #[fhir(name="method", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub method: Option<CodeableConcept>,
    /// Specimen used for this observation
    #[fhir(name="specimen", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="referenceRange", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub reference_range: Option<Vec<ObservationReferenceRangeBackboneElement>>,
    /// Related resource that belongs to the Observation group
    #[fhir(name="hasMember", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    /// Component results
    #[fhir(name="component", min="0", max="*", summary=true, modifier=false, choice=false)]
...
pub struct ObservationTriggeredByBackboneElement {
    ...
    #[fhir(name="observation", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ObservationReferenceRangeBackboneElement {
    ...
    #[fhir(name="low", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub low: Option<Quantity>,
    /// High Range, if relevant
    #[fhir(name="high", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub high: Option<Quantity>,
    /// Normal value, if relevant
    #[fhir(name="normalValue", min="0", max="1", summary=false, modifier=false, choice=false)]
