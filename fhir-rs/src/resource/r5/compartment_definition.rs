...
pub struct CompartmentDefinition {
    ...
    #[fhir(name="search", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct CompartmentDefinitionResourceBackboneElement {
    ...
    #[fhir(name="param", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="startParam", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub start_param: Option<UriDt>,
    /// Search Param for interpreting $everything.end
    #[fhir(name="endParam", min="0", max="1", summary=false, modifier=false, choice=false)]
