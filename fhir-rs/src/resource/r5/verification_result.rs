...
pub struct VerificationResult {
    ...
    #[fhir(name="targetLocation", min="0", max="*", summary=true, modifier=false)]
    pub target_location: Option<Vec<StringDt>>,
    /// none | initial | periodic
    #[fhir(name="need", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="validationType", min="0", max="1", summary=true, modifier=false)]
    pub validation_type: Option<CodeableConcept>,
    /// The primary process by which the target is validated (edit check; value set; primary source; multiple sources; standalone; in context)
    #[fhir(name="validationProcess", min="0", max="*", summary=true, modifier=false)]
    pub validation_process: Option<Vec<CodeableConcept>>,
    /// Frequency of revalidation
    #[fhir(name="frequency", min="0", max="1", summary=false, modifier=false)]
    pub frequency: Option<Timing>,
    /// The date/time validation was last completed (including failed validations)
    #[fhir(name="lastPerformed", min="0", max="1", summary=false, modifier=false)]
    pub last_performed: Option<DateTimeDt>,
    /// The date when target is next validated, if appropriate
    #[fhir(name="nextScheduled", min="0", max="1", summary=false, modifier=false)]
    pub next_scheduled: Option<DateDt>,
    /// fatal | warn | rec-only | none
    #[fhir(name="failureAction", min="0", max="1", summary=true, modifier=false)]
    pub failure_action: Option<CodeableConcept>,
    /// Information about the primary source(s) involved in validation
    #[fhir(name="primarySource", min="0", max="*", summary=false, modifier=false)]
    pub primary_source: Option<Vec<VerificationResultPrimarySourceBackboneElement>>,
    /// Information about the entity attesting to information
    #[fhir(name="attestation", min="0", max="1", summary=false, modifier=false)]
    pub attestation: Option<VerificationResultAttestationBackboneElement>,
    /// Information about the entity validating information
    #[fhir(name="validator", min="0", max="*", summary=false, modifier=false)]
...
pub struct VerificationResultAttestationBackboneElement {
    ...
    #[fhir(name="communicationMethod", min="0", max="1", summary=true, modifier=false)]
    ...
    #[fhir(name="sourceIdentityCertificate", min="0", max="1", summary=false, modifier=false)]
    pub source_identity_certificate: Option<StringDt>,
    /// A digital identity certificate associated with the proxy entity submitting attested information on behalf of the attestation source
    #[fhir(name="proxyIdentityCertificate", min="0", max="1", summary=false, modifier=false)]
    pub proxy_identity_certificate: Option<StringDt>,
    /// Proxy signature (digital or image)
    #[fhir(name="proxySignature", min="0", max="1", summary=false, modifier=false)]
    pub proxy_signature: Option<Signature>,
    /// Attester signature (digital or image)
    #[fhir(name="sourceSignature", min="0", max="1", summary=false, modifier=false)]
...
pub struct VerificationResultPrimarySourceBackboneElement {
    ...
    #[fhir(name="who", min="0", max="1", summary=false, modifier=false)]
    pub who: Option<Reference>,
    /// Type of primary source (License Board; Primary Education; Continuing Education; Postal Service; Relationship owner; Registration Authority; legal source; issuing source; authoritative source)
    #[fhir(name="type", min="0", max="*", summary=true, modifier=false)]
    pub type_: Option<Vec<CodeableConcept>>,
    /// Method for exchanging information with the primary source
    #[fhir(name="communicationMethod", min="0", max="*", summary=true, modifier=false)]
    pub communication_method: Option<Vec<CodeableConcept>>,
    /// successful | failed | unknown
    #[fhir(name="validationStatus", min="0", max="1", summary=false, modifier=false)]
    pub validation_status: Option<CodeableConcept>,
    /// When the target was validated against the primary source
    #[fhir(name="validationDate", min="0", max="1", summary=false, modifier=false)]
    pub validation_date: Option<DateTimeDt>,
    /// yes | no | undetermined
    #[fhir(name="canPushUpdates", min="0", max="1", summary=true, modifier=false)]
    pub can_push_updates: Option<CodeableConcept>,
    /// specific | any | source
    #[fhir(name="pushTypeAvailable", min="0", max="*", summary=false, modifier=false)]
...
pub struct VerificationResultValidatorBackboneElement {
    ...
    #[fhir(name="identityCertificate", min="0", max="1", summary=false, modifier=false)]
    pub identity_certificate: Option<StringDt>,
    /// Validator signature (digital or image)
    #[fhir(name="attestationSignature", min="0", max="1", summary=false, modifier=false)]
