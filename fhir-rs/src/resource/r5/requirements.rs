...
pub struct Requirements {
    ...
    #[fhir(name="reference", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="statement", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct RequirementsStatementBackboneElement {
    ...
    #[fhir(name="conformance", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub conformance: Option<Vec<CodeDt>>,
    /// Set to true if requirements statement is conditional
    #[fhir(name="conditionality", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub conditionality: Option<BooleanDt>,
    /// The actual requirement
    #[fhir(name="requirement", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub requirement: Option<MarkdownDt>,
    /// Another statement this clarifies/restricts ([url#]key)
    #[fhir(name="derivedFrom", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="satisfiedBy", min="0", max="*", summary=false, modifier=false, choice=false)]
