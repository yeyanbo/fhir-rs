...
pub struct DetectedIssue {
    ...
    /// When identified
    #[fhir(name="identified", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub identified: Option<Period>,
    /// The provider or device that identified the issue
    #[fhir(name="author", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub author: Option<Reference>,
    /// Problem resource
    #[fhir(name="implicated", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub implicated: Option<Vec<Reference>>,
    /// Supporting evidence
    #[fhir(name="evidence", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="mitigation", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct DetectedIssueMitigationBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// What mitigation?
    #[fhir(name="action", min="1", max="1", summary=false, modifier=false, choice=false)]
