...
pub struct ServiceRequest {
    ...
    #[fhir(name="requisition", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="orderDetail", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct ServiceRequestOrderDetailBackboneElement {
    ...
    #[fhir(name="parameterFocus", min="0", max="1", summary=false, modifier=false, choice="")]
