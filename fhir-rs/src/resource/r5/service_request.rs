...
pub struct ServiceRequest {
    ...
    #[fhir(name="requisition", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="orderDetail", min="0", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="bodyStructure", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct ServiceRequestOrderDetailBackboneElement {
    ...
    #[fhir(name="parameterFocus", min="0", max="1", summary=false, modifier=false, choice=false)]
