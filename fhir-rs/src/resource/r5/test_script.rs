...
pub struct TestScript {
    ...
    #[fhir(name="origin", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub origin: Option<Vec<TestScriptOriginBackboneElement>>,
    /// An abstract server representing a destination or receiver in a message exchange
    #[fhir(name="destination", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub destination: Option<Vec<TestScriptDestinationBackboneElement>>,
    /// Required capability that is assumed to function correctly on the FHIR server being tested
    #[fhir(name="metadata", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub metadata: Option<TestScriptMetadataBackboneElement>,
    /// Indication of the artifact(s) that are tested by this test case
    #[fhir(name="scope", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub scope: Option<Vec<TestScriptScopeBackboneElement>>,
    /// Fixture in the test script - by reference (uri)
    #[fhir(name="fixture", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub fixture: Option<Vec<TestScriptFixtureBackboneElement>>,
    /// Reference of the validation profile
    #[fhir(name="profile", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub profile: Option<Vec<CanonicalDt>>,
    /// Placeholder for evaluated elements
    #[fhir(name="variable", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub variable: Option<Vec<TestScriptVariableBackboneElement>>,
    /// A series of required setup operations before tests are executed
    #[fhir(name="setup", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub setup: Option<TestScriptSetupBackboneElement>,
    /// A test in this script
    #[fhir(name="test", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub test: Option<Vec<TestScriptTestBackboneElement>>,
    /// A series of required clean up steps
    #[fhir(name="teardown", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptMetadataBackboneElement {
    ...
    #[fhir(name="link", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub link: Option<Vec<TestScriptMetadataLinkBackboneElement>>,
    /// Capabilities  that are assumed to function correctly on the FHIR server being tested
    #[fhir(name="capability", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptMetadataCapabilityBackboneElement {
    ...
    #[fhir(name="required", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub required: Option<BooleanDt>,
    /// Are the capabilities validated?
    #[fhir(name="validated", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="capabilities", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptMetadataLinkBackboneElement {
    ...
    #[fhir(name="url", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub url: Option<UriDt>,
    /// Short description
    #[fhir(name="description", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub description: Option<StringDt>,
...
pub struct TestScriptSetupBackboneElement {
    ...
    #[fhir(name="action", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptSetupActionBackboneElement {
    ...
    #[fhir(name="operation", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub operation: Option<TestScriptSetupActionOperationBackboneElement>,
    /// The assertion to perform
    #[fhir(name="assert", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptSetupActionOperationBackboneElement {
    ...
    #[fhir(name="label", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub label: Option<StringDt>,
    /// Tracking/reporting operation description
    #[fhir(name="description", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub description: Option<StringDt>,
    /// Mime type to accept in the payload of the response, with charset etc
    #[fhir(name="accept", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub accept: Option<CodeDt>,
    /// Mime type of the request payload contents, with charset etc
    #[fhir(name="contentType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub content_type: Option<CodeDt>,
    /// Server responding to the request
    #[fhir(name="destination", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub destination: Option<IntegerDt>,
    /// Whether or not to send the request url in encoded format
    #[fhir(name="encodeRequestUrl", min="1", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="origin", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub origin: Option<IntegerDt>,
    /// Explicitly defined path parameters
    #[fhir(name="params", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub params: Option<StringDt>,
    /// Each operation can have one or more header elements
    #[fhir(name="requestHeader", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub request_header: Option<Vec<TestScriptSetupActionOperationRequestHeaderBackboneElement>>,
    /// Fixture Id of mapped request
    #[fhir(name="requestId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub request_id: Option<IdDt>,
    /// Fixture Id of mapped response
    #[fhir(name="responseId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub response_id: Option<IdDt>,
    /// Fixture Id of body for PUT and POST requests
    #[fhir(name="sourceId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub source_id: Option<IdDt>,
    /// Id of fixture used for extracting the [id],  [type], and [vid] for GET requests
    #[fhir(name="targetId", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptSetupActionOperationRequestHeaderBackboneElement {
    ...
    #[fhir(name="field", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptSetupActionAssertBackboneElement {
    ...
    pub description: Option<StringDt>,
    /// response | request
    #[fhir(name="direction", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub direction: Option<CodeDt>,
    /// Id of the source fixture to be evaluated
    #[fhir(name="compareToSourceId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub compare_to_source_id: Option<StringDt>,
    /// The FHIRPath expression to evaluate against the source fixture
    #[fhir(name="compareToSourceExpression", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub compare_to_source_expression: Option<StringDt>,
    /// XPath or JSONPath expression to evaluate against the source fixture
    #[fhir(name="compareToSourcePath", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub compare_to_source_path: Option<StringDt>,
    /// Mime type to compare against the 'Content-Type' header
    #[fhir(name="contentType", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub content_type: Option<CodeDt>,
    /// fail | pass | skip | stop
    #[fhir(name="defaultManualCompletion", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// HTTP header field name
    #[fhir(name="headerField", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub header_field: Option<StringDt>,
    /// Fixture Id of minimum content resource
    #[fhir(name="minimumId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub minimum_id: Option<StringDt>,
    /// Perform validation on navigation links?
    #[fhir(name="navigationLinks", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="operator", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// delete | get | options | patch | post | put | head
    #[fhir(name="requestMethod", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub request_method: Option<CodeDt>,
    /// Request URL comparison value
    #[fhir(name="requestURL", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="responseCode", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub response_code: Option<StringDt>,
    /// Fixture Id of source expression or headerField
    #[fhir(name="sourceId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub source_id: Option<IdDt>,
    /// If this assert fails, will the current test execution stop?
    #[fhir(name="stopTestOnFail", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub stop_test_on_fail: Option<BooleanDt>,
    /// Profile Id of validation profile reference
    #[fhir(name="validateProfileId", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub validate_profile_id: Option<IdDt>,
    /// The value to compare to
    #[fhir(name="value", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub value: Option<StringDt>,
    /// Will this assert produce a warning only on error?
    #[fhir(name="warningOnly", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub warning_only: Option<BooleanDt>,
    /// Links or references to the testing requirements
    #[fhir(name="requirement", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptSetupActionAssertRequirementBackboneElement {
    ...
    #[fhir(name="link", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptTeardownActionBackboneElement {
    ...
    #[fhir(name="operation", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub operation: Option<TestScriptSetupActionOperationBackboneElement>,
}
...
pub struct TestScriptDestinationBackboneElement {
    ...
    #[fhir(name="index", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub index: Option<IntegerDt>,
    /// FHIR-Server | FHIR-SDC-FormManager | FHIR-SDC-FormReceiver | FHIR-SDC-FormProcessor
    #[fhir(name="profile", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptVariableBackboneElement {
    ...
    #[fhir(name="defaultValue", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="hint", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptFixtureBackboneElement {
    ...
    #[fhir(name="autocreate", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub autocreate: Option<BooleanDt>,
    /// Whether or not to implicitly delete the fixture during teardown
    #[fhir(name="autodelete", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct TestScriptScopeBackboneElement {
    ...
    #[fhir(name="artifact", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub artifact: Option<CanonicalDt>,
    /// required | optional | strict
    #[fhir(name="conformance", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub conformance: Option<CodeableConcept>,
    /// unit | integration | production
    #[fhir(name="phase", min="0", max="1", summary=false, modifier=false, choice=false)]
