...
pub struct TestScript {
    ...
    #[fhir(name="origin", min="0", max="*", summary=false, modifier=false, choice="")]
    pub origin: Option<Vec<TestScriptOriginBackboneElement>>,
    /// An abstract server representing a destination or receiver in a message exchange
    #[fhir(name="destination", min="0", max="*", summary=false, modifier=false, choice="")]
    pub destination: Option<Vec<TestScriptDestinationBackboneElement>>,
    /// Required capability that is assumed to function correctly on the FHIR server being tested
    #[fhir(name="metadata", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="fixture", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct TestScriptMetadataBackboneElement {
    ...
    #[fhir(name="capability", min="1", max="*", summary=false, modifier=false, choice="")]
...
pub struct TestScriptMetadataCapabilityBackboneElement {
    ...
    #[fhir(name="required", min="1", max="1", summary=false, modifier=false, choice="")]
    pub required: Option<BooleanDt>,
    /// Are the capabilities validated?
    #[fhir(name="validated", min="1", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="capabilities", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptSetupActionOperationBackboneElement {
    ...
    #[fhir(name="accept", min="0", max="1", summary=false, modifier=false, choice="")]
    pub accept: Option<CodeDt>,
    /// Mime type of the request payload contents, with charset etc
    #[fhir(name="contentType", min="0", max="1", summary=false, modifier=false, choice="")]
    pub content_type: Option<CodeDt>,
    /// Server responding to the request
    #[fhir(name="destination", min="0", max="1", summary=false, modifier=false, choice="")]
    pub destination: Option<IntegerDt>,
    /// Whether or not to send the request url in encoded format
    #[fhir(name="encodeRequestUrl", min="1", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="requestHeader", min="0", max="*", summary=false, modifier=false, choice="")]
    pub request_header: Option<Vec<TestScriptSetupActionOperationRequestHeaderBackboneElement>>,
    /// Fixture Id of mapped request
    #[fhir(name="requestId", min="0", max="1", summary=false, modifier=false, choice="")]
    pub request_id: Option<IdDt>,
    /// Fixture Id of mapped response
    #[fhir(name="responseId", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="targetId", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptSetupActionOperationRequestHeaderBackboneElement {
    ...
    #[fhir(name="field", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptSetupActionAssertBackboneElement {
    ...
    pub description: Option<StringDt>,
    /// response | request
    #[fhir(name="direction", min="0", max="1", summary=false, modifier=false, choice="")]
    pub direction: Option<CodeDt>,
    /// Id of the source fixture to be evaluated
    #[fhir(name="compareToSourceId", min="0", max="1", summary=false, modifier=false, choice="")]
    pub compare_to_source_id: Option<StringDt>,
    /// The FHIRPath expression to evaluate against the source fixture
    #[fhir(name="compareToSourceExpression", min="0", max="1", summary=false, modifier=false, choice="")]
    pub compare_to_source_expression: Option<StringDt>,
    /// XPath or JSONPath expression to evaluate against the source fixture
    #[fhir(name="compareToSourcePath", min="0", max="1", summary=false, modifier=false, choice="")]
    pub compare_to_source_path: Option<StringDt>,
    /// Mime type to compare against the 'Content-Type' header
    #[fhir(name="contentType", min="0", max="1", summary=false, modifier=false, choice="")]
    pub content_type: Option<CodeDt>,
    /// fail | pass | skip | stop
    #[fhir(name="defaultManualCompletion", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    /// HTTP header field name
    #[fhir(name="headerField", min="0", max="1", summary=false, modifier=false, choice="")]
    pub header_field: Option<StringDt>,
    /// Fixture Id of minimum content resource
    #[fhir(name="minimumId", min="0", max="1", summary=false, modifier=false, choice="")]
    pub minimum_id: Option<StringDt>,
    /// Perform validation on navigation links?
    #[fhir(name="navigationLinks", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="operator", min="0", max="1", summary=false, modifier=false, choice="")]
    pub operator: Option<CodeDt>,
    /// XPath or JSONPath expression
    #[fhir(name="path", min="0", max="1", summary=false, modifier=false, choice="")]
    pub path: Option<StringDt>,
    /// delete | get | options | patch | post | put | head
    #[fhir(name="requestMethod", min="0", max="1", summary=false, modifier=false, choice="")]
    pub request_method: Option<CodeDt>,
    /// Request URL comparison value
    #[fhir(name="requestURL", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="responseCode", min="0", max="1", summary=false, modifier=false, choice="")]
    pub response_code: Option<StringDt>,
    /// Fixture Id of source expression or headerField
    #[fhir(name="sourceId", min="0", max="1", summary=false, modifier=false, choice="")]
    pub source_id: Option<IdDt>,
    /// If this assert fails, will the current test execution stop?
    #[fhir(name="stopTestOnFail", min="1", max="1", summary=false, modifier=false, choice="")]
    pub stop_test_on_fail: Option<BooleanDt>,
    /// Profile Id of validation profile reference
    #[fhir(name="validateProfileId", min="0", max="1", summary=false, modifier=false, choice="")]
    pub validate_profile_id: Option<IdDt>,
    /// The value to compare to
    #[fhir(name="value", min="0", max="1", summary=false, modifier=false, choice="")]
    pub value: Option<StringDt>,
    /// Will this assert produce a warning only on error?
    #[fhir(name="warningOnly", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptDestinationBackboneElement {
    ...
    #[fhir(name="index", min="1", max="1", summary=false, modifier=false, choice="")]
    pub index: Option<IntegerDt>,
    /// FHIR-Server | FHIR-SDC-FormManager | FHIR-SDC-FormReceiver | FHIR-SDC-FormProcessor
    #[fhir(name="profile", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptVariableBackboneElement {
    ...
    #[fhir(name="defaultValue", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="hint", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptFixtureBackboneElement {
    ...
    #[fhir(name="autocreate", min="1", max="1", summary=false, modifier=false, choice="")]
    pub autocreate: Option<BooleanDt>,
    /// Whether or not to implicitly delete the fixture during teardown
    #[fhir(name="autodelete", min="1", max="1", summary=false, modifier=false, choice="")]
...
pub struct TestScriptScopeBackboneElement {
    ...
    #[fhir(name="artifact", min="1", max="1", summary=false, modifier=false, choice="")]
    pub artifact: Option<CanonicalDt>,
    /// required | optional | strict
    #[fhir(name="conformance", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conformance: Option<CodeableConcept>,
    /// unit | integration | production
    #[fhir(name="phase", min="0", max="1", summary=false, modifier=false, choice="")]
