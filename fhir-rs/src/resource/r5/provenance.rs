...
pub struct Provenance {
    ...
    #[fhir(name="target", min="1", max="*", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="activity", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Signature on target
    #[fhir(name="signature", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ProvenanceAgentBackboneElement {
    ...
    #[fhir(name="onBehalfOf", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ProvenanceEntityBackboneElement {
    ...
    /// Identity of entity
    #[fhir(name="what", min="1", max="1", summary=true, modifier=false, choice=false)]
