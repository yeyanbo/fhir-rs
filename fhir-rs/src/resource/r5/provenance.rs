...
pub struct Provenance {
    ...
    #[fhir(name="target", min="1", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="activity", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    /// Signature on target
    #[fhir(name="signature", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct ProvenanceEntityBackboneElement {
    ...
    /// Identity of entity
    #[fhir(name="what", min="1", max="1", summary=true, modifier=false, choice="")]
