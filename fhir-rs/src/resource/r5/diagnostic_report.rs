...
pub struct DiagnosticReport {
    ...
    #[fhir(name="resultsInterpreter", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="study", min="0", max="*", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="media", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="composition", min="0", max="1", summary=false, modifier=false, choice="")]
    pub composition: Option<Reference>,
    /// Clinical conclusion (interpretation) of test results
    #[fhir(name="conclusion", min="0", max="1", summary=false, modifier=false, choice="")]
    pub conclusion: Option<MarkdownDt>,
    /// Codes for the clinical conclusion of test results
    #[fhir(name="conclusionCode", min="0", max="*", summary=false, modifier=false, choice="")]
    pub conclusion_code: Option<Vec<CodeableConcept>>,
    /// Entire report as issued
    #[fhir(name="presentedForm", min="0", max="*", summary=false, modifier=false, choice="")]
...
pub struct DiagnosticReportMediaBackboneElement {
    ...
    #[fhir(name="link", min="1", max="1", summary=true, modifier=false, choice="")]
