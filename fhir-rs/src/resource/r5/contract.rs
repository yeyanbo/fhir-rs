...
pub struct Contract {
    ...
    /// Negotiation status
    #[fhir(name="legalState", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub legal_state: Option<CodeableConcept>,
    /// Source Contract Definition
    #[fhir(name="instantiatesCanonical", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub instantiates_canonical: Option<Reference>,
    /// External Contract Definition
    #[fhir(name="instantiatesUri", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub instantiates_uri: Option<UriDt>,
    /// Content derived from the basal information
    #[fhir(name="contentDerivative", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Effective time
    #[fhir(name="applies", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub applies: Option<Period>,
    /// Contract cessation cause
    #[fhir(name="expirationType", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="authority", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub authority: Option<Vec<Reference>>,
    /// A sphere of control governed by an authoritative jurisdiction, organization, or person
    #[fhir(name="domain", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub domain: Option<Vec<Reference>>,
    /// Specific Location
    #[fhir(name="site", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="alias", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub alias: Option<Vec<StringDt>>,
    /// Source of Contract
    #[fhir(name="author", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub author: Option<Reference>,
    /// Range of Legal Concerns
    #[fhir(name="scope", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub scope: Option<CodeableConcept>,
    /// Focus of contract interest
    #[fhir(name="topic", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub topic: Option<Reference>,
    /// Legal instrument category
    #[fhir(name="type", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub type_: Option<CodeableConcept>,
    /// Subtype within the context of type
    #[fhir(name="subType", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub sub_type: Option<Vec<CodeableConcept>>,
    /// Contract precursor content
    #[fhir(name="contentDefinition", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Contract Signatory
    #[fhir(name="signer", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub signer: Option<Vec<ContractSignerBackboneElement>>,
    /// Contract Friendly Language
    #[fhir(name="friendly", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub friendly: Option<Vec<ContractFriendlyBackboneElement>>,
    /// Contract Legal Language
    #[fhir(name="legal", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub legal: Option<Vec<ContractLegalBackboneElement>>,
    /// Computable Contract Language
    #[fhir(name="rule", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub rule: Option<Vec<ContractRuleBackboneElement>>,
    /// Binding Contract
    #[fhir(name="legallyBinding", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermBackboneElement {
    ...
    #[fhir(name="securityLabel", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub security_label: Option<Vec<ContractTermSecurityLabelBackboneElement>>,
    /// Context of the Contract term
    #[fhir(name="offer", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub offer: Option<ContractTermOfferBackboneElement>,
    /// Contract Term Asset List
    #[fhir(name="asset", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermSecurityLabelBackboneElement {
    ...
    #[fhir(name="number", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub number: Option<Vec<UnsignedIntDt>>,
    /// Confidentiality Protection
    #[fhir(name="classification", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub classification: Option<Coding>,
    /// Applicable Policy
    #[fhir(name="category", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub category: Option<Vec<Coding>>,
    /// Handling Instructions
    #[fhir(name="control", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermActionBackboneElement {
    ...
    #[fhir(name="subject", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub subject: Option<Vec<ContractTermActionSubjectBackboneElement>>,
    /// Purpose for the Contract Term Action
    #[fhir(name="intent", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub intent: Option<CodeableConcept>,
    /// Pointer to specific item
    #[fhir(name="linkId", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    /// Pointer to specific item
    #[fhir(name="contextLinkId", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub context_link_id: Option<Vec<StringDt>>,
    /// When action happens
    #[fhir(name="occurrence", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub occurrence: Option<Timing>,
    /// Who asked for action
    #[fhir(name="requester", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub requester: Option<Vec<Reference>>,
    /// Pointer to specific item
    #[fhir(name="requesterLinkId", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="performerRole", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub performer_role: Option<CodeableConcept>,
    /// Actor that wil execute (or not) the action
    #[fhir(name="performer", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub performer: Option<Reference>,
    /// Pointer to specific item
    #[fhir(name="performerLinkId", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub performer_link_id: Option<Vec<StringDt>>,
    /// Why is action (not) needed?
    #[fhir(name="reason", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub reason: Option<Vec<CodeableReference>>,
    /// Pointer to specific item
    #[fhir(name="reasonLinkId", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub reason_link_id: Option<Vec<StringDt>>,
    /// Comments about the action
    #[fhir(name="note", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub note: Option<Vec<Annotation>>,
    /// Action restriction numbers
    #[fhir(name="securityLabelNumber", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermActionSubjectBackboneElement {
    ...
    pub modifier_extension: Option<Vec<Extension>>,
    /// Entity of the action
    #[fhir(name="reference", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermAssetBackboneElement {
    ...
    /// Associated entities
    #[fhir(name="typeReference", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub type_reference: Option<Vec<Reference>>,
    /// Asset sub-category
    #[fhir(name="subtype", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="context", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="periodType", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub period_type: Option<Vec<CodeableConcept>>,
    /// Time period of the asset
    #[fhir(name="period", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub period: Option<Vec<Period>>,
    /// Time period
    #[fhir(name="usePeriod", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    pub link_id: Option<Vec<StringDt>>,
    /// Response to assets
    #[fhir(name="answer", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub answer: Option<Vec<ContractTermOfferAnswerBackboneElement>>,
    /// Asset restriction numbers
    #[fhir(name="securityLabelNumber", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub security_label_number: Option<Vec<UnsignedIntDt>>,
    /// Contract Valued Item List
    #[fhir(name="valuedItem", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermAssetContextBackboneElement {
    ...
    #[fhir(name="code", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermAssetValuedItemBackboneElement {
    ...
    #[fhir(name="entity", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub entity: Option<Reference>,
    /// Contract Valued Item Number
    #[fhir(name="identifier", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub identifier: Option<Identifier>,
    /// Contract Valued Item Effective Tiem
    #[fhir(name="effectiveTime", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="points", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="recipient", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermOfferBackboneElement {
    ...
    pub identifier: Option<Vec<Identifier>>,
    /// Offer Recipient
    #[fhir(name="party", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="decisionMode", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractTermOfferPartyBackboneElement {
    ...
    #[fhir(name="role", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub role: Option<CodeableConcept>,
}
...
pub struct ContractSignerBackboneElement {
    ...
    #[fhir(name="party", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub party: Option<Reference>,
    /// Contract Documentation Signature
    #[fhir(name="signature", min="1", max="*", summary=false, modifier=false, choice=false)]
...
pub struct ContractRuleBackboneElement {
    ...
    #[fhir(name="content", min="1", max="1", summary=false, modifier=false, choice=false)]
...
pub struct ContractContentDefinitionBackboneElement {
    ...
    pub sub_type: Option<CodeableConcept>,
    /// Publisher Entity
    #[fhir(name="publisher", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub publisher: Option<Reference>,
    /// When published
    #[fhir(name="publicationDate", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub publication_date: Option<DateTimeDt>,
    /// amended | appended | cancelled | disputed | entered-in-error | executable +
    #[fhir(name="publicationStatus", min="1", max="1", summary=false, modifier=false, choice=false)]
