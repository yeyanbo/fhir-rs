...
pub struct VisionPrescription {
    ...
    #[fhir(name="dateWritten", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub date_written: Option<DateTimeDt>,
    /// Who authorized the vision prescription
    #[fhir(name="prescriber", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub prescriber: Option<Reference>,
    /// Vision lens authorization
    #[fhir(name="lensSpecification", min="1", max="*", summary=true, modifier=false, choice=false)]
...
pub struct VisionPrescriptionLensSpecificationBackboneElement {
    ...
    /// right | left
    #[fhir(name="eye", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub eye: Option<CodeDt>,
    /// Power of the lens
    #[fhir(name="sphere", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub sphere: Option<DecimalDt>,
    /// Lens power for astigmatism
    #[fhir(name="cylinder", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub cylinder: Option<DecimalDt>,
    /// Lens meridian which contain no power for astigmatism
    #[fhir(name="axis", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub axis: Option<IntegerDt>,
    /// Eye alignment compensation
    #[fhir(name="prism", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub prism: Option<Vec<VisionPrescriptionLensSpecificationPrismBackboneElement>>,
    /// Added power for multifocal levels
    #[fhir(name="add", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub add: Option<DecimalDt>,
    /// Contact lens power
    #[fhir(name="power", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub power: Option<DecimalDt>,
    /// Contact lens back curvature
    #[fhir(name="backCurve", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub back_curve: Option<DecimalDt>,
    /// Contact lens diameter
    #[fhir(name="diameter", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    /// Color required
    #[fhir(name="color", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub color: Option<StringDt>,
    /// Brand required
    #[fhir(name="brand", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct VisionPrescriptionLensSpecificationPrismBackboneElement {
    ...
    /// up | down | in | out
    #[fhir(name="base", min="1", max="1", summary=false, modifier=false, choice=false)]
