...
pub struct ImmunizationEvaluation {
    ...
    #[fhir(name="targetDisease", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub target_disease: Option<CodeableConcept>,
    /// Immunization being evaluated
    #[fhir(name="immunizationEvent", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub immunization_event: Option<Reference>,
    /// Status of the dose relative to published recommendations
    #[fhir(name="doseStatus", min="1", max="1", summary=true, modifier=false, choice=false)]
    pub dose_status: Option<CodeableConcept>,
    /// Reason why the doese is considered valid, invalid or some other status
    #[fhir(name="doseStatusReason", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="doseNumber", min="0", max="1", summary=false, modifier=false, choice=false)]
