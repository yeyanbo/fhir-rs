...
pub struct Patient {
    ...
    #[fhir(name="gender", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub gender: Option<CodeDt>,
    /// The date of birth for the individual
    #[fhir(name="birthDate", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="address", min="0", max="*", summary=true, modifier=false, choice=false)]
    pub address: Option<Vec<Address>>,
    /// Marital (civil) status of a patient
    #[fhir(name="maritalStatus", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub marital_status: Option<CodeableConcept>,
    /// Whether patient is part of a multiple birth
    #[fhir(name="multipleBirth", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub multiple_birth: Option<IntegerDt>,
    /// Image of the patient
    #[fhir(name="photo", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="communication", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub communication: Option<Vec<PatientCommunicationBackboneElement>>,
    /// Patient's nominated primary care provider
    #[fhir(name="generalPractitioner", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub general_practitioner: Option<Vec<Reference>>,
    /// Organization that is the custodian of the patient record
    #[fhir(name="managingOrganization", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct PatientLinkBackboneElement {
    ...
    #[fhir(name="other", min="1", max="1", summary=true, modifier=false, choice=false)]
...
pub struct PatientContactBackboneElement {
    ...
    #[fhir(name="relationship", min="0", max="*", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="telecom", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub telecom: Option<Vec<ContactPoint>>,
    /// Address for the contact person
    #[fhir(name="address", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub address: Option<Address>,
    /// male | female | other | unknown
    #[fhir(name="gender", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub gender: Option<CodeDt>,
    /// Organization that is associated with the contact
    #[fhir(name="organization", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct PatientCommunicationBackboneElement {
    ...
    #[fhir(name="language", min="1", max="1", summary=false, modifier=false, choice=false)]
    pub language: Option<CodeableConcept>,
    /// Language preference indicator
    #[fhir(name="preferred", min="0", max="1", summary=false, modifier=false, choice=false)]
