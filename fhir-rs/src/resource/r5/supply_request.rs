...
pub struct SupplyRequest {
    ...
    #[fhir(name="deliverFor", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="deliverFrom", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub deliver_from: Option<Reference>,
    /// The destination of the supply
    #[fhir(name="deliverTo", min="0", max="1", summary=false, modifier=false, choice=false)]
