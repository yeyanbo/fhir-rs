...
pub struct EvidenceVariable {
    ...
    #[fhir(name="shortTitle", min="0", max="1", summary=true, modifier=false, choice=false)]
...
pub struct EvidenceVariableCharacteristicBackboneElement {
    ...
    #[fhir(name="definitionReference", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub definition_reference: Option<Reference>,
    /// Defines the characteristic (without using type and value) by a Canonical
    #[fhir(name="definitionCanonical", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub definition_canonical: Option<CanonicalDt>,
    /// Defines the characteristic (without using type and value) by a CodeableConcept
    #[fhir(name="definitionCodeableConcept", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="definitionExpression", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub definition_expression: Option<Expression>,
    /// Defines the characteristic (without using type and value) by an id
    #[fhir(name="definitionId", min="0", max="1", summary=true, modifier=false, choice=false)]
    pub definition_id: Option<IdDt>,
    /// Defines the characteristic using type and value
    #[fhir(name="definitionByTypeAndValue", min="0", max="1", summary=true, modifier=false, choice=false)]
    ...
    #[fhir(name="definitionByCombination", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub definition_by_combination: Option<EvidenceVariableCharacteristicDefinitionByCombinationBackboneElement>,
    /// Number of occurrences meeting the characteristic
    #[fhir(name="instances", min="0", max="1", summary=false, modifier=false, choice=false)]
    ...
    #[fhir(name="timeFromEvent", min="0", max="*", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceVariableCharacteristicDefinitionByCombinationBackboneElement {
    ...
    #[fhir(name="threshold", min="0", max="1", summary=false, modifier=false, choice=false)]
    pub threshold: Option<PositiveIntDt>,
    /// A defining factor of the characteristic
    #[fhir(name="characteristic", min="1", max="*", summary=false, modifier=false, choice=false)]
    pub characteristic: Option<Vec<EvidenceVariableCharacteristicBackboneElement>>,
}
...
pub struct EvidenceVariableCharacteristicDefinitionByTypeAndValueBackboneElement {
    ...
    #[fhir(name="method", min="0", max="*", summary=false, modifier=false, choice=false)]
    pub method: Option<Vec<CodeableConcept>>,
    /// Device used for determining characteristic
    #[fhir(name="device", min="0", max="1", summary=false, modifier=false, choice=false)]
...
pub struct EvidenceVariableCharacteristicTimeFromEventBackboneElement {
    ...
    #[fhir(name="event", min="0", max="1", summary=false, modifier=false, choice=false)]
