...
pub struct Coding {
    ...
    #[fhir(name="display", min="0", max="1", summary=true, modifier=false, choice="")]
    pub display: Option<StringDt>,
    /// If this coding was chosen directly by the user
    #[fhir(name="userSelected", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct Address {
    ...
    #[fhir(name="line", min="0", max="*", summary=true, modifier=false, choice="")]
    pub line: Option<Vec<StringDt>>,
    /// Name of city, town etc.
    #[fhir(name="city", min="0", max="1", summary=true, modifier=false, choice="")]
    pub city: Option<StringDt>,
    /// District name (aka county)
    #[fhir(name="district", min="0", max="1", summary=true, modifier=false, choice="")]
    pub district: Option<StringDt>,
    /// Sub-unit of country (abbreviations ok)
    #[fhir(name="state", min="0", max="1", summary=true, modifier=false, choice="")]
    pub state: Option<StringDt>,
    /// Postal code for area
    #[fhir(name="postalCode", min="0", max="1", summary=true, modifier=false, choice="")]
    pub postal_code: Option<StringDt>,
    /// Country (e.g. may be ISO 3166 2 or 3 letter code)
    #[fhir(name="country", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct Annotation {
    ...
    #[fhir(name="time", min="0", max="1", summary=true, modifier=false, choice="")]
    pub time: Option<DateTimeDt>,
    /// The annotation  - text content (as markdown)
    #[fhir(name="text", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct Attachment {
    ...
    #[fhir(name="contentType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub content_type: Option<CodeDt>,
    /// Human language of the content (BCP-47)
    #[fhir(name="language", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="size", min="0", max="1", summary=true, modifier=false, choice="")]
    pub size: Option<Integer64Dt>,
    /// Hash of the data (sha-1, base64ed)
    #[fhir(name="hash", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="height", min="0", max="1", summary=false, modifier=false, choice="")]
    pub height: Option<PositiveIntDt>,
    /// Width of the image in pixels (photo/video)
    #[fhir(name="width", min="0", max="1", summary=false, modifier=false, choice="")]
    pub width: Option<PositiveIntDt>,
    /// Number of frames if > 1 (photo)
    #[fhir(name="frames", min="0", max="1", summary=false, modifier=false, choice="")]
    ...
    #[fhir(name="pages", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct Availability {
    ...
    #[fhir(name="availableTime", min="0", max="*", summary=true, modifier=false, choice="")]
    pub available_time: Option<Vec<AvailabilityAvailableTimeElement>>,
    /// Not available during this time due to provided reason
    #[fhir(name="notAvailableTime", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct AvailabilityAvailableTimeElement {
    ...
    #[fhir(name="daysOfWeek", min="0", max="*", summary=true, modifier=false, choice="")]
    pub days_of_week: Option<Vec<CodeDt>>,
    /// Always available? i.e. 24 hour service
    #[fhir(name="allDay", min="0", max="1", summary=true, modifier=false, choice="")]
    pub all_day: Option<BooleanDt>,
    /// Opening time of day (ignored if allDay = true)
    #[fhir(name="availableStartTime", min="0", max="1", summary=true, modifier=false, choice="")]
    pub available_start_time: Option<TimeDt>,
    /// Closing time of day (ignored if allDay = true)
    #[fhir(name="availableEndTime", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct AvailabilityNotAvailableTimeElement {
    ...
    #[fhir(name="during", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct CodeableConcept {
    ...
    #[fhir(name="coding", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct CodeableReference {
    ...
    #[fhir(name="concept", min="0", max="1", summary=true, modifier=false, choice="")]
    pub concept: Option<CodeableConcept>,
    /// Reference to a resource (by instance)
    #[fhir(name="reference", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ContactPoint {
    ...
    #[fhir(name="rank", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct DataRequirement {
    ...
    #[fhir(name="mustSupport", min="0", max="*", summary=true, modifier=false, choice="")]
    pub must_support: Option<Vec<StringDt>>,
    /// What codes are expected
    #[fhir(name="codeFilter", min="0", max="*", summary=true, modifier=false, choice="")]
    pub code_filter: Option<Vec<DataRequirementCodeFilterElement>>,
    /// What dates/date ranges are expected
    #[fhir(name="dateFilter", min="0", max="*", summary=true, modifier=false, choice="")]
    pub date_filter: Option<Vec<DataRequirementDateFilterElement>>,
    /// What values are expected
    #[fhir(name="valueFilter", min="0", max="*", summary=true, modifier=false, choice="")]
    pub value_filter: Option<Vec<DataRequirementValueFilterElement>>,
    /// Number of results
    #[fhir(name="limit", min="0", max="1", summary=true, modifier=false, choice="")]
    pub limit: Option<PositiveIntDt>,
    /// Order of the results
    #[fhir(name="sort", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct DataRequirementSortElement {
    ...
    #[fhir(name="path", min="1", max="1", summary=true, modifier=false, choice="")]
    pub path: Option<StringDt>,
    /// ascending | descending
    #[fhir(name="direction", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct DataRequirementCodeFilterElement {
    ...
    #[fhir(name="path", min="0", max="1", summary=true, modifier=false, choice="")]
    pub path: Option<StringDt>,
    /// A coded (token) parameter to search on
    #[fhir(name="searchParam", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct DataRequirementValueFilterElement {
    ...
    #[fhir(name="comparator", min="0", max="1", summary=true, modifier=false, choice="")]
    pub comparator: Option<CodeDt>,
...
pub struct Dosage {
    ...
    #[fhir(name="additionalInstruction", min="0", max="*", summary=true, modifier=false, choice="")]
    pub additional_instruction: Option<Vec<CodeableConcept>>,
    /// Patient or consumer oriented instructions
    #[fhir(name="patientInstruction", min="0", max="1", summary=true, modifier=false, choice="")]
    pub patient_instruction: Option<StringDt>,
    /// When medication should be administered
    #[fhir(name="timing", min="0", max="1", summary=true, modifier=false, choice="")]
    pub timing: Option<Timing>,
    /// Take "as needed"
    #[fhir(name="asNeeded", min="0", max="1", summary=true, modifier=false, choice="")]
    pub as_needed: Option<BooleanDt>,
    /// Take "as needed" (for x)
    #[fhir(name="asNeededFor", min="0", max="*", summary=true, modifier=false, choice="")]
    pub as_needed_for: Option<Vec<CodeableConcept>>,
    /// Body site to administer to
    #[fhir(name="site", min="0", max="1", summary=true, modifier=false, choice="")]
    pub site: Option<CodeableConcept>,
    /// How drug should enter body
    #[fhir(name="route", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="doseAndRate", min="0", max="*", summary=true, modifier=false, choice="")]
    pub dose_and_rate: Option<Vec<DosageDoseAndRateElement>>,
    /// Upper limit on medication per unit of time
    #[fhir(name="maxDosePerPeriod", min="0", max="*", summary=true, modifier=false, choice="")]
    pub max_dose_per_period: Option<Vec<Ratio>>,
    /// Upper limit on medication per administration
    #[fhir(name="maxDosePerAdministration", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_dose_per_administration: Option<Quantity>,
    /// Upper limit on medication per lifetime of the patient
    #[fhir(name="maxDosePerLifetime", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct DosageDoseAndRateElement {
    ...
    #[fhir(name="dose", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinition {
    ...
    #[fhir(name="representation", min="0", max="*", summary=true, modifier=false, choice="")]
    pub representation: Option<Vec<CodeDt>>,
    /// Name for this particular element (in a set of slices)
    #[fhir(name="sliceName", min="0", max="1", summary=true, modifier=false, choice="")]
    pub slice_name: Option<StringDt>,
    /// If this slice definition constrains an inherited slice definition (or not)
    #[fhir(name="sliceIsConstraining", min="0", max="1", summary=true, modifier=false, choice="")]
    pub slice_is_constraining: Option<BooleanDt>,
    /// Name for element to display with or prompt for element
    #[fhir(name="label", min="0", max="1", summary=true, modifier=false, choice="")]
    pub label: Option<StringDt>,
    /// Corresponding codes in terminologies
    #[fhir(name="code", min="0", max="*", summary=true, modifier=false, choice="")]
    pub code: Option<Vec<Coding>>,
    /// This element is sliced - slices follow
    #[fhir(name="slicing", min="0", max="1", summary=true, modifier=false, choice="")]
    pub slicing: Option<ElementDefinitionSlicingElement>,
    /// Concise definition for space-constrained presentation
    #[fhir(name="short", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="requirements", min="0", max="1", summary=true, modifier=false, choice="")]
    pub requirements: Option<MarkdownDt>,
    /// Other names
    #[fhir(name="alias", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="contentReference", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="meaningWhenMissing", min="0", max="1", summary=true, modifier=false, choice="")]
    pub meaning_when_missing: Option<MarkdownDt>,
    /// What the order of the elements means
    #[fhir(name="orderMeaning", min="0", max="1", summary=true, modifier=false, choice="")]
    pub order_meaning: Option<StringDt>,
    /// Value must be exactly this
    #[fhir(name="fixed", min="0", max="1", summary=true, modifier=false, choice="")]
    pub fixed: Option<Meta>,
    /// Value must have at least these property values
    #[fhir(name="pattern", min="0", max="1", summary=true, modifier=false, choice="Uri|CodeableConcept")]
    pub pattern: Option<AnyType>,
    /// Example value (as defined for type)
    #[fhir(name="example", min="0", max="*", summary=true, modifier=false, choice="")]
    pub example: Option<Vec<ElementDefinitionExampleElement>>,
    /// Minimum Allowed Value (for some types)
    #[fhir(name="minValue", min="0", max="1", summary=true, modifier=false, choice="")]
    pub min_value: Option<Quantity>,
    /// Maximum Allowed Value (for some types)
    #[fhir(name="maxValue", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_value: Option<Quantity>,
    /// Max length for string type data
    #[fhir(name="maxLength", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="constraint", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="mustHaveValue", min="0", max="1", summary=true, modifier=false, choice="")]
    pub must_have_value: Option<BooleanDt>,
    /// Extensions that are allowed to replace a primitive value
    #[fhir(name="valueAlternatives", min="0", max="*", summary=true, modifier=false, choice="")]
    pub value_alternatives: Option<Vec<CanonicalDt>>,
    /// If the element must be supported (discouraged - see obligations)
    #[fhir(name="mustSupport", min="0", max="1", summary=true, modifier=false, choice="")]
    pub must_support: Option<BooleanDt>,
    /// If this modifies the meaning of other elements
    #[fhir(name="isModifier", min="0", max="1", summary=true, modifier=false, choice="")]
    pub is_modifier: Option<BooleanDt>,
    /// Reason that this element is marked as a modifier
    #[fhir(name="isModifierReason", min="0", max="1", summary=true, modifier=false, choice="")]
    pub is_modifier_reason: Option<StringDt>,
    /// Include when _summary = true?
    #[fhir(name="isSummary", min="0", max="1", summary=true, modifier=false, choice="")]
    pub is_summary: Option<BooleanDt>,
    /// ValueSet details if this is coded
    #[fhir(name="binding", min="0", max="1", summary=true, modifier=false, choice="")]
    pub binding: Option<ElementDefinitionBindingElement>,
    /// Map element to another set of definitions
    #[fhir(name="mapping", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionBaseElement {
    ...
    #[fhir(name="max", min="1", max="1", summary=true, modifier=false, choice="")]
    pub max: Option<StringDt>,
}
...
pub struct ElementDefinitionSlicingElement {
    ...
    #[fhir(name="discriminator", min="0", max="*", summary=true, modifier=false, choice="")]
    pub discriminator: Option<Vec<ElementDefinitionSlicingDiscriminatorElement>>,
    /// Text description of how slicing works (or not)
    #[fhir(name="description", min="0", max="1", summary=true, modifier=false, choice="")]
    pub description: Option<StringDt>,
    /// If elements must be in same order as slices
    #[fhir(name="ordered", min="0", max="1", summary=true, modifier=false, choice="")]
    pub ordered: Option<BooleanDt>,
    /// closed | open | openAtEnd
    #[fhir(name="rules", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionMappingElement {
    ...
    #[fhir(name="identity", min="1", max="1", summary=true, modifier=false, choice="")]
    pub identity: Option<IdDt>,
    /// Computable language of mapping
    #[fhir(name="language", min="0", max="1", summary=true, modifier=false, choice="")]
    pub language: Option<CodeDt>,
    /// Details of the mapping
    #[fhir(name="map", min="1", max="1", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionTypeElement {
    ...
    #[fhir(name="targetProfile", min="0", max="*", summary=true, modifier=false, choice="")]
    pub target_profile: Option<Vec<CanonicalDt>>,
    /// contained | referenced | bundled - how aggregated
    #[fhir(name="aggregation", min="0", max="*", summary=true, modifier=false, choice="")]
    pub aggregation: Option<Vec<CodeDt>>,
    /// either | independent | specific
    #[fhir(name="versioning", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionBindingElement {
    ...
    #[fhir(name="additional", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionBindingAdditionalElement {
    ...
    #[fhir(name="purpose", min="1", max="1", summary=true, modifier=false, choice="")]
    pub purpose: Option<CodeDt>,
    /// The value set for the additional binding
    #[fhir(name="valueSet", min="1", max="1", summary=true, modifier=false, choice="")]
    pub value_set: Option<CanonicalDt>,
    ...
    #[fhir(name="shortDoco", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="any", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ElementDefinitionExampleElement {
    ...
    #[fhir(name="label", min="1", max="1", summary=true, modifier=false, choice="")]
    pub label: Option<StringDt>,
    /// Value of Example (one of allowed types)
    #[fhir(name="value", min="1", max="1", summary=true, modifier=false, choice="Uri|String")]
...
pub struct ElementDefinitionConstraintElement {
    ...
    #[fhir(name="key", min="1", max="1", summary=true, modifier=false, choice="")]
    pub key: Option<IdDt>,
    /// Why this constraint is necessary or appropriate
    #[fhir(name="requirements", min="0", max="1", summary=true, modifier=false, choice="")]
    pub requirements: Option<MarkdownDt>,
    /// error | warning
    #[fhir(name="severity", min="1", max="1", summary=true, modifier=false, choice="")]
    pub severity: Option<CodeDt>,
    /// Suppress warning or hint in profile
    #[fhir(name="suppress", min="0", max="1", summary=true, modifier=false, choice="")]
    pub suppress: Option<BooleanDt>,
    /// Human description of constraint
    #[fhir(name="human", min="1", max="1", summary=true, modifier=false, choice="")]
    pub human: Option<StringDt>,
    /// FHIRPath expression of constraint
    #[fhir(name="expression", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ExtendedContactDetail {
    ...
    #[fhir(name="address", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct HumanName {
    ...
    #[fhir(name="family", min="0", max="1", summary=true, modifier=false, choice="")]
    pub family: Option<StringDt>,
    /// Given names (not always 'first'). Includes middle names
    #[fhir(name="given", min="0", max="*", summary=true, modifier=false, choice="")]
    pub given: Option<Vec<StringDt>>,
    /// Parts that come before the name
    #[fhir(name="prefix", min="0", max="*", summary=true, modifier=false, choice="")]
    pub prefix: Option<Vec<StringDt>>,
    /// Parts that come after the name
    #[fhir(name="suffix", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct Identifier {
    ...
    #[fhir(name="assigner", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct MarketingStatus {
    ...
    #[fhir(name="dateRange", min="0", max="1", summary=true, modifier=false, choice="")]
    pub date_range: Option<Period>,
    /// The date when the Medicinal Product is placed on the market by the Marketing Authorization Holder (or where applicable, the manufacturer/distributor) in a country and/or jurisdiction shall be provided A complete date consisting of day, month and year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the release of the Medicinal Product into the distribution chain
    #[fhir(name="restoreDate", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct Meta {
    ...
    #[fhir(name="versionId", min="0", max="1", summary=true, modifier=false, choice="")]
    pub version_id: Option<IdDt>,
    /// When the resource version last changed
    #[fhir(name="lastUpdated", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="security", min="0", max="*", summary=true, modifier=false, choice="")]
    pub security: Option<Vec<Coding>>,
    /// Tags applied to this resource
    #[fhir(name="tag", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct MonetaryComponent {
    ...
    #[fhir(name="factor", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct Money {
    ...
    #[fhir(name="currency", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ParameterDefinition {
    ...
    #[fhir(name="profile", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct ProductShelfLife {
    ...
    #[fhir(name="specialPrecautionsForStorage", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct Ratio {
    ...
    pub extension: Option<Vec<Extension>>,
    /// Numerator value
    #[fhir(name="numerator", min="0", max="1", summary=true, modifier=false, choice="")]
    pub numerator: Option<Quantity>,
    /// Denominator value
    #[fhir(name="denominator", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct RatioRange {
    ...
    pub extension: Option<Vec<Extension>>,
    /// Low Numerator limit
    #[fhir(name="lowNumerator", min="0", max="1", summary=true, modifier=false, choice="")]
    pub low_numerator: Option<Quantity>,
    /// High Numerator limit
    #[fhir(name="highNumerator", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct RelatedArtifact {
    ...
    #[fhir(name="classifier", min="0", max="*", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="citation", min="0", max="1", summary=true, modifier=false, choice="")]
    pub citation: Option<MarkdownDt>,
    /// What document is being referenced
    #[fhir(name="document", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="resourceReference", min="0", max="1", summary=true, modifier=false, choice="")]
    pub resource_reference: Option<Reference>,
    /// draft | active | retired | unknown
    #[fhir(name="publicationStatus", min="0", max="1", summary=true, modifier=false, choice="")]
    pub publication_status: Option<CodeDt>,
    /// Date of publication of the artifact being referred to
    #[fhir(name="publicationDate", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct SampledData {
    ...
    #[fhir(name="origin", min="1", max="1", summary=true, modifier=false, choice="")]
    pub origin: Option<Quantity>,
    /// Number of intervalUnits between samples
    #[fhir(name="interval", min="0", max="1", summary=true, modifier=false, choice="")]
    pub interval: Option<DecimalDt>,
    /// The measurement unit of the interval between samples
    #[fhir(name="intervalUnit", min="1", max="1", summary=true, modifier=false, choice="")]
    pub interval_unit: Option<CodeDt>,
    /// Multiply data by this before adding to origin
    #[fhir(name="factor", min="0", max="1", summary=true, modifier=false, choice="")]
    pub factor: Option<DecimalDt>,
    /// Lower limit of detection
    #[fhir(name="lowerLimit", min="0", max="1", summary=true, modifier=false, choice="")]
    pub lower_limit: Option<DecimalDt>,
    /// Upper limit of detection
    #[fhir(name="upperLimit", min="0", max="1", summary=true, modifier=false, choice="")]
    pub upper_limit: Option<DecimalDt>,
    /// Number of sample points at each time point
    #[fhir(name="dimensions", min="1", max="1", summary=true, modifier=false, choice="")]
    pub dimensions: Option<PositiveIntDt>,
    /// Defines the codes used in the data
    #[fhir(name="codeMap", min="0", max="1", summary=false, modifier=false, choice="")]
    pub code_map: Option<CanonicalDt>,
    /// Offsets, typically in time, at which data values were taken
    #[fhir(name="offsets", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct Signature {
    ...
    #[fhir(name="when", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="targetFormat", min="0", max="1", summary=false, modifier=false, choice="")]
    pub target_format: Option<CodeDt>,
    /// The technical format of the signature
    #[fhir(name="sigFormat", min="0", max="1", summary=false, modifier=false, choice="")]
...
pub struct Timing {
    ...
    #[fhir(name="repeat", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct TimingRepeatElement {
    ...
    #[fhir(name="bounds", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="countMax", min="0", max="1", summary=true, modifier=false, choice="")]
    pub count_max: Option<PositiveIntDt>,
    /// How long when it happens
    #[fhir(name="duration", min="0", max="1", summary=true, modifier=false, choice="")]
    pub duration: Option<DecimalDt>,
    /// How long when it happens (Max)
    #[fhir(name="durationMax", min="0", max="1", summary=true, modifier=false, choice="")]
    pub duration_max: Option<DecimalDt>,
    /// s | min | h | d | wk | mo | a - unit of time (UCUM)
    #[fhir(name="durationUnit", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="frequency", min="0", max="1", summary=true, modifier=false, choice="")]
    pub frequency: Option<PositiveIntDt>,
    /// Event occurs up to frequencyMax times per period
    #[fhir(name="frequencyMax", min="0", max="1", summary=true, modifier=false, choice="")]
    ...
    #[fhir(name="periodMax", min="0", max="1", summary=true, modifier=false, choice="")]
    pub period_max: Option<DecimalDt>,
    /// s | min | h | d | wk | mo | a - unit of time (UCUM)
    #[fhir(name="periodUnit", min="0", max="1", summary=true, modifier=false, choice="")]
    pub period_unit: Option<CodeDt>,
    /// mon | tue | wed | thu | fri | sat | sun
    #[fhir(name="dayOfWeek", min="0", max="*", summary=true, modifier=false, choice="")]
    pub day_of_week: Option<Vec<CodeDt>>,
    /// Time of day for action
    #[fhir(name="timeOfDay", min="0", max="*", summary=true, modifier=false, choice="")]
    pub time_of_day: Option<Vec<TimeDt>>,
    /// Code for time period of occurrence
    #[fhir(name="when", min="0", max="*", summary=true, modifier=false, choice="")]
    pub when: Option<Vec<CodeDt>>,
    /// Minutes from event (before or after)
    #[fhir(name="offset", min="0", max="1", summary=true, modifier=false, choice="")]
...
pub struct TriggerDefinition {
    ...
    pub code: Option<CodeableConcept>,
    /// What event
    #[fhir(name="subscriptionTopic", min="0", max="1", summary=true, modifier=false, choice="")]
    pub subscription_topic: Option<CanonicalDt>,
    /// Timing of the event
    #[fhir(name="timing", min="0", max="1", summary=true, modifier=false, choice="")]
    pub timing: Option<DateTimeDt>,
    /// Triggering data of the event (multiple = 'and')
    #[fhir(name="data", min="0", max="*", summary=true, modifier=false, choice="")]
...
pub struct VirtualServiceDetail {
    ...
    pub extension: Option<Vec<Extension>>,
    /// Channel Type
    #[fhir(name="channelType", min="0", max="1", summary=true, modifier=false, choice="")]
    pub channel_type: Option<Coding>,
    /// Contact address/number
    #[fhir(name="address", min="0", max="1", summary=true, modifier=false, choice="")]
    pub address: Option<ExtendedContactDetail>,
    /// Address to see alternative connection details
    #[fhir(name="additionalInfo", min="0", max="*", summary=true, modifier=false, choice="")]
    pub additional_info: Option<Vec<UrlDt>>,
    /// Maximum number of participants supported by the virtual service
    #[fhir(name="maxParticipants", min="0", max="1", summary=true, modifier=false, choice="")]
    pub max_participants: Option<PositiveIntDt>,
    /// Session Key required by the virtual service
    #[fhir(name="sessionKey", min="0", max="1", summary=true, modifier=false, choice="")]
